...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class VoterListStorage
    {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node> ListNodes(Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListNodesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag> ListBags(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListBagsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag>(parameters, blockhash, token);
            return result;
        }
    }
