...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaSchedulerStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaScheduler", "ValidatorGroups"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaScheduler", "AvailabilityCores"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>)));
        ...
        ///  upper bound at 10k.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>> ValidatorGroups(string blockhash, CancellationToken token)
        {
            string parameters = ParaSchedulerStorage.ValidatorGroupsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///    * The number of validators divided by `configuration.max_validators_per_core`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>> AvailabilityCores(string blockhash, CancellationToken token)
        {
            string parameters = ParaSchedulerStorage.AvailabilityCoresParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  a block. Runtime APIs should be used to determine scheduled cores for the upcoming block.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.BTreeMapT4> ClaimQueue(string blockhash, CancellationToken token)
        {
            string parameters = ParaSchedulerStorage.ClaimQueueParams();
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Types.Base.BTreeMapT4>(parameters, blockhash, token);
            return result;
        }
    }
