...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class BeefyStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Beefy", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Beefy", "NextAuthorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45)));
        ...
        ///  The current authorities set
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45> Authorities(string blockhash, CancellationToken token)
        {
            string parameters = BeefyStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Authorities set scheduled to be used with the next session
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45> NextAuthorities(string blockhash, CancellationToken token)
        {
    ...
    public sealed class BeefyCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.EquivocationProof equivocation_proof, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.EquivocationProof equivocation_proof, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
