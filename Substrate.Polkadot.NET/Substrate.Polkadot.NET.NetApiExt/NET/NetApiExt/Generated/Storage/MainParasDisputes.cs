...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParasDisputesStorage
    {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState> Disputes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key, string blockhash, CancellationToken token)
        {
            string parameters = ParasDisputesStorage.DisputesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState>(parameters, blockhash, token);
            return result;
        }
