...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaSessionInfoStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaSessionInfo", "AssignmentKeysUnsafe"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.assignment_app.Public>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaSessionInfo", "Sessions"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.SessionInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaSessionInfo", "SessionExecutorParams"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams)));
        }
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.assignment_app.Public>> AssignmentKeysUnsafe(string blockhash, CancellationToken token)
        {
            string parameters = ParaSessionInfoStorage.AssignmentKeysUnsafeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.assignment_app.Public>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.SessionInfo> Sessions(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParaSessionInfoStorage.SessionsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.SessionInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The validator account keys of the validators actively participating in parachain consensus.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> AccountKeys(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Executor parameter set for a given session index
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams> SessionExecutorParams(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = ParaSessionInfoStorage.SessionExecutorParamsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams>(parameters, blockhash, token);
            return result;
        }
    }
