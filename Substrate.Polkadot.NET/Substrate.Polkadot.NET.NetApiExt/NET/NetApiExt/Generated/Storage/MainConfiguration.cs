...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ConfigurationCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAsyncBackingParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.async_backing.AsyncBackingParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetExecutorParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetApprovalVotingParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.ApprovalVotingParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetSchedulerParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.vstaging.SchedulerParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
