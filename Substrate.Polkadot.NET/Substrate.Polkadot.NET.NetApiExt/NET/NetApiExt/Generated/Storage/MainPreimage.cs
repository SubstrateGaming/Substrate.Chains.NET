...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class PreimageStorage
    {
        ...
        public PreimageStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Preimage", "StatusFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256), typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_preimage.EnumOldRequestStatus)));
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_preimage.EnumOldRequestStatus> StatusFor(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = PreimageStorage.StatusForParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_preimage.EnumOldRequestStatus>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The request status of a given hash.
        /// </summary>
        public static string RequestStatusForParams(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus> RequestStatusFor(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
            string parameters = PreimageStorage.RequestStatusForParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus>(parameters, blockhash, token);
            return result;
        }
        ...
        /// >> PreimageFor
        /// </summary>
        public async Task<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15> PreimageFor(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = PreimageStorage.PreimageForParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class PreimageCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method EnsureUpdated(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256> hashes)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
