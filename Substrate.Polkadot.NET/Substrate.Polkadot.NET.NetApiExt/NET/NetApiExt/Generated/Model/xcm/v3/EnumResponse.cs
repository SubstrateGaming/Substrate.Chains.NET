...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.xcm.v3
{
    ...
    public sealed class EnumResponse : BaseEnumRust<Response>
    {
        ...
        public EnumResponse()
        {
				...
				AddTypeDecoder<Substrate.Polkadot.NET.NetApiExt.Generated.Model.xcm.v3.multiasset.MultiAssets>(Response.Assets);
				...
				AddTypeDecoder<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8>(Response.PalletsInfo);
