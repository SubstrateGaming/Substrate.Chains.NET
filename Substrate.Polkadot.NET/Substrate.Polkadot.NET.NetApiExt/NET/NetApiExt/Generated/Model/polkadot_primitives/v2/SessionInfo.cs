...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    ...
    public sealed class SessionInfo : BaseType
    {
        ...
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> _activeValidatorIndices;
        ...
        /// >> validators
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1 _validators;
        ...
        /// >> assignment_keys
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> _assignmentKeys;
        
        /// <summary>
        /// >> validator_groups
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2 _validatorGroups;
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> ActiveValidatorIndices
        {
            get
            {
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1 Validators
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> AssignmentKeys
        {
            get
            {
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2 ValidatorGroups
        {
            get
            {
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>();
            ...
            Validators = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1();
            ...
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2();
