...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7
{
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> upward_messages
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3 UpwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4 HorizontalMessages { get; set; }
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.ValidationCode> NewValidationCode { get; set; }
        /// <summary>
        /// >> head_data
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HeadData HeadData { get; set; }
        /// <summary>
        ...
        {
            var start = p;
            UpwardMessages = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3();
            UpwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT4();
