...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6
{
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> upward_messages
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 UpwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 HorizontalMessages { get; set; }
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        ...
        {
            var start = p;
            UpwardMessages = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            UpwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
