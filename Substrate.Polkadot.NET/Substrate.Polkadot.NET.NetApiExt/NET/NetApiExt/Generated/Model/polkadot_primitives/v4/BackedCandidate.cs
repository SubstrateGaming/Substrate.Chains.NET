...
namespace Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    ...
    /// <summary>
    /// >> 327 - Composite[polkadot_primitives.v4.BackedCandidate]
    /// </summary>
    ...
    public sealed class BackedCandidate : BaseType
    {
        ...
        /// >> candidate
        /// </summary>
        private Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CommittedCandidateReceipt _candidate;
        
        /// <summary>
        /// >> validity_votes
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumValidityAttestation> _validityVotes;
        ...
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CommittedCandidateReceipt Candidate
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumValidityAttestation> ValidityVotes
        {
            get
            {
        ...
        {
            var start = p;
            Candidate = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CommittedCandidateReceipt();
            Candidate.Decode(byteArray, ref p);
            ValidityVotes = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.EnumValidityAttestation>();
