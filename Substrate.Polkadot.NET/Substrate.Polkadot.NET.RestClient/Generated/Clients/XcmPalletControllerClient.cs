...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmPalletControllerClient : BaseClient, IXcmPalletControllerClient
   {
      ...
      {
         return await SendRequestAsync<EnumQueryStatus>(_httpClient, "xcmpallet/queries", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.XcmPalletStorage.QueriesParams(key));
      }
      public async Task<bool> SubscribeQueries(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmPallet.Queries", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.XcmPalletStorage.QueriesParams(key));
      }
      public async Task<U32> GetAssetTraps(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "xcmpallet/assettraps", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.XcmPalletStorage.AssetTrapsParams(key));
      }
      public async Task<bool> SubscribeAssetTraps(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmPallet.AssetTraps", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.XcmPalletStorage.AssetTrapsParams(key));
      }
