...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ConvictionVotingControllerClient : BaseClient, IConvictionVotingControllerClient
   {
      ...
      public async Task<EnumVoting> GetVotingFor(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16> key)
      {
         return await SendRequestAsync<EnumVoting>(_httpClient, "convictionvoting/votingfor", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ConvictionVotingStorage.VotingForParams(key));
      }
      public async Task<bool> SubscribeVotingFor(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16> key)
      {
      ...
      {
         return await _subscriptionClient.SubscribeAsync("ConvictionVoting.ClassLocksFor", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ConvictionVotingStorage.ClassLocksForParams(key));
      }
   }
}
