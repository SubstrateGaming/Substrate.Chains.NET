...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class BabeControllerClient : BaseClient, IBabeControllerClient
   {
      ...
      {
         return await _subscriptionClient.SubscribeAsync("Babe.UnderConstruction", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
