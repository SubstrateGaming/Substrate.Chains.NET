...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CrowdloanControllerClient : BaseClient, ICrowdloanControllerClient
   {
      ...
      {
         return await SendRequestAsync<FundInfo>(_httpClient, "crowdloan/funds", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CrowdloanStorage.FundsParams(key));
      }
      public async Task<bool> SubscribeFunds(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Crowdloan.Funds", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CrowdloanStorage.FundsParams(key));
      }
