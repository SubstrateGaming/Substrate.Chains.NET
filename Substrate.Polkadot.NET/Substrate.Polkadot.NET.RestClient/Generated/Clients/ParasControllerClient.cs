...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ParasControllerClient : BaseClient, IParasControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "paras/mostrecentcontext", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasStorage.MostRecentContextParams(key));
      }
      public async Task<bool> SubscribeMostRecentContext(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Paras.MostRecentContext", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasStorage.MostRecentContextParams(key));
      }
