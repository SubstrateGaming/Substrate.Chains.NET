...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class BountiesControllerClient : BaseClient, IBountiesControllerClient
   {
      ...
      {
         return await SendRequestAsync<Bounty>(_httpClient, "bounties/bounties", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.BountiesStorage.BountiesParams(key));
      }
