...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class IndicesControllerClient : BaseClient, IIndicesControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<AccountId32, U128, Bool>>(_httpClient, "indices/accounts", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.IndicesStorage.AccountsParams(key));
      }
      public async Task<bool> SubscribeAccounts(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Indices.Accounts", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.IndicesStorage.AccountsParams(key));
      }
   }
}
