...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class IdentityControllerClient : BaseClient, IIdentityControllerClient
   {
      ...
      {
         return await _subscriptionClient.SubscribeAsync("Identity.IdentityOf", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.IdentityStorage.IdentityOfParams(key));
      }
      public async Task<BaseTuple<AccountId32, EnumData>> GetSuperOf(AccountId32 key)
      {
         return await SendRequestAsync<BaseTuple<AccountId32, EnumData>>(_httpClient, "identity/superof", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.IdentityStorage.SuperOfParams(key));
      }
      ...
      public async Task<BaseTuple<U128, BoundedVecT20>> GetSubsOf(AccountId32 key)
      {
         return await SendRequestAsync<BaseTuple<U128, BoundedVecT20>>(_httpClient, "identity/subsof", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.IdentityStorage.SubsOfParams(key));
      }
