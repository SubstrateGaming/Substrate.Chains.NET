...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ImOnlineControllerClient : BaseClient, IImOnlineControllerClient
   {
      ...
      {
         return await SendRequestAsync<WrapperOpaque>(_httpClient, "imonline/receivedheartbeats", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ImOnlineStorage.ReceivedHeartbeatsParams(key));
      }
