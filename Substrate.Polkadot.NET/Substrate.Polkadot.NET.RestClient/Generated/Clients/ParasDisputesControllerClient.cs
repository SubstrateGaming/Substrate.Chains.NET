...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ParasDisputesControllerClient : BaseClient, IParasDisputesControllerClient
   {
      ...
      public async Task<DisputeState> GetDisputes(BaseTuple<U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key)
      {
         return await SendRequestAsync<DisputeState>(_httpClient, "parasdisputes/disputes", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasDisputesStorage.DisputesParams(key));
      }
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "parasdisputes/included", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasDisputesStorage.IncludedParams(key));
      }
      public async Task<bool> SubscribeIncluded(BaseTuple<U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key)
      {
         return await _subscriptionClient.SubscribeAsync("ParasDisputes.Included", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasDisputesStorage.IncludedParams(key));
      }
