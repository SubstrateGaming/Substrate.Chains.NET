...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class StakingControllerClient : BaseClient, IStakingControllerClient
   {
      ...
      {
         return await SendRequestAsync<AccountId32>(_httpClient, "staking/bonded", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.BondedParams(key));
      }
      public async Task<bool> SubscribeBonded(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Bonded", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.BondedParams(key));
      }
      ...
      {
         return await SendRequestAsync<StakingLedger>(_httpClient, "staking/ledger", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.LedgerParams(key));
      }
      public async Task<bool> SubscribeLedger(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Ledger", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.LedgerParams(key));
      }
      public async Task<EnumRewardDestination> GetPayee(AccountId32 key)
      {
         return await SendRequestAsync<EnumRewardDestination>(_httpClient, "staking/payee", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.PayeeParams(key));
      }
      public async Task<bool> SubscribePayee(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Payee", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.PayeeParams(key));
      }
      public async Task<ValidatorPrefs> GetValidators(AccountId32 key)
      {
         return await SendRequestAsync<ValidatorPrefs>(_httpClient, "staking/validators", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ValidatorsParams(key));
      }
      public async Task<bool> SubscribeValidators(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Validators", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ValidatorsParams(key));
      }
      ...
      {
         return await SendRequestAsync<Nominations>(_httpClient, "staking/nominators", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.NominatorsParams(key));
      }
      public async Task<bool> SubscribeNominators(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.Nominators", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.NominatorsParams(key));
      }
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "staking/erasstartsessionindex", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasStartSessionIndexParams(key));
      }
      public async Task<bool> SubscribeErasStartSessionIndex(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasStartSessionIndex", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasStartSessionIndexParams(key));
      }
      public async Task<Exposure> GetErasStakers(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<Exposure>(_httpClient, "staking/erasstakers", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasStakersParams(key));
      }
      ...
      {
         return await SendRequestAsync<ValidatorPrefs>(_httpClient, "staking/erasvalidatorprefs", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasValidatorPrefsParams(key));
      }
      public async Task<bool> SubscribeErasValidatorPrefs(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasValidatorPrefs", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasValidatorPrefsParams(key));
      }
      public async Task<U128> GetErasValidatorReward(U32 key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/erasvalidatorreward", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasValidatorRewardParams(key));
      }
      public async Task<bool> SubscribeErasValidatorReward(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasValidatorReward", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasValidatorRewardParams(key));
      }
      public async Task<EraRewardPoints> GetErasRewardPoints(U32 key)
      {
         return await SendRequestAsync<EraRewardPoints>(_httpClient, "staking/erasrewardpoints", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasRewardPointsParams(key));
      }
      public async Task<bool> SubscribeErasRewardPoints(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasRewardPoints", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasRewardPointsParams(key));
      }
      public async Task<U128> GetErasTotalStake(U32 key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/erastotalstake", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasTotalStakeParams(key));
      }
      public async Task<bool> SubscribeErasTotalStake(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ErasTotalStake", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ErasTotalStakeParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<UnappliedSlash>>(_httpClient, "staking/unappliedslashes", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.UnappliedSlashesParams(key));
      }
      public async Task<bool> SubscribeUnappliedSlashes(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.UnappliedSlashes", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.UnappliedSlashesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Perbill, U128>>(_httpClient, "staking/validatorslashinera", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ValidatorSlashInEraParams(key));
      }
      public async Task<bool> SubscribeValidatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.ValidatorSlashInEra", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.ValidatorSlashInEraParams(key));
      }
      public async Task<U128> GetNominatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await SendRequestAsync<U128>(_httpClient, "staking/nominatorslashinera", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.NominatorSlashInEraParams(key));
      }
      public async Task<bool> SubscribeNominatorSlashInEra(BaseTuple<U32, AccountId32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.NominatorSlashInEra", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.NominatorSlashInEraParams(key));
      }
      public async Task<SlashingSpans> GetSlashingSpans(AccountId32 key)
      {
         return await SendRequestAsync<SlashingSpans>(_httpClient, "staking/slashingspans", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.SlashingSpansParams(key));
      }
      public async Task<bool> SubscribeSlashingSpans(AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.SlashingSpans", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.SlashingSpansParams(key));
      }
      public async Task<SpanRecord> GetSpanSlash(BaseTuple<AccountId32, U32> key)
      {
         return await SendRequestAsync<SpanRecord>(_httpClient, "staking/spanslash", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.SpanSlashParams(key));
      }
      public async Task<bool> SubscribeSpanSlash(BaseTuple<AccountId32, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("Staking.SpanSlash", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.StakingStorage.SpanSlashParams(key));
      }
