...
namespace Substrate.Polkadot.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CouncilControllerClient : BaseClient, ICouncilControllerClient
   {
      ...
      public async Task<BoundedVecT20> GetProposals()
      {
         return await SendRequestAsync<BoundedVecT20>(_httpClient, "council/proposals");
      }
      ...
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "council/proposalof", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.ProposalOf", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "council/voting", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.Voting", Substrate.Polkadot.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
