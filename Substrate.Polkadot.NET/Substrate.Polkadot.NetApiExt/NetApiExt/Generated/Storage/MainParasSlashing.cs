...
namespace Substrate.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParasSlashingStorage
    {
        ...
        /// </summary>
        public static string UnappliedSlashesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key)
        {
        ...
        ///  Validators pending dispute slashes.
        /// </summary>
        public async Task<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.PendingSlashes> UnappliedSlashes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key, string blockhash, CancellationToken token)
        {
            string parameters = ParasSlashingStorage.UnappliedSlashesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.PendingSlashes>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ParasSlashingCalls
    {
        ...
        /// </summary>
        public static Method ReportDisputeLostUnsigned(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.DisputeProof dispute_proof, Substrate.Polkadot.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
