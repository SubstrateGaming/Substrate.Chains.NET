...
namespace Substrate.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class ConfigurationStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Configuration", "ActiveConfig"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Configuration", "PendingConfigs"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration>>)));
        ...
        ///  The active configuration for the current session.
        /// </summary>
        public async Task<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration> ActiveConfig(string blockhash, CancellationToken token)
        {
            string parameters = ConfigurationStorage.ActiveConfigParams();
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  2 items: for the next session and for the `scheduled_session`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration>>> PendingConfigs(string blockhash, CancellationToken token)
        {
            string parameters = ConfigurationStorage.PendingConfigsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration>>>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ConfigurationCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAsyncBackingParams(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.async_backing.AsyncBackingParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetExecutorParams(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetOnDemandFeeVariability(Substrate.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetOnDemandTargetQueueUtilization(Substrate.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetApprovalVotingParams(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ApprovalVotingParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetSchedulerParams(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.vstaging.SchedulerParams @new)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(@new.Encode());
