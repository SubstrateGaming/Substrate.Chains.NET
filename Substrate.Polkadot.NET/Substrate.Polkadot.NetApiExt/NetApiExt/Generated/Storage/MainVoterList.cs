...
namespace Substrate.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class VoterListStorage
    {
        ...
        public VoterListStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Node)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListBags"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U64), typeof(Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Bag)));
        }
        ...
        /// </summary>
        public static string ListNodesParams(Substrate.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Node> ListNodes(Substrate.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListNodesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Node>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Bag> ListBags(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
            string parameters = VoterListStorage.ListBagsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Polkadot.NetApiExt.Generated.Model.pallet_bags_list.list.Bag>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class VoterListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(Substrate.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dislocated)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PutInFrontOf(Substrate.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PutInFrontOfOther(Substrate.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress heavier, Substrate.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
