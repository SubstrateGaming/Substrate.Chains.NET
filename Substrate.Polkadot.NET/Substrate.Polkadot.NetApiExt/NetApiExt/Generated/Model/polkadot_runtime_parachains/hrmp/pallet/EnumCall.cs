...
namespace Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.hrmp.pallet
{
    ...
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.hrmp_init_open_channel);
				AddTypeDecoder<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id>(Call.hrmp_accept_open_channel);
				AddTypeDecoder<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HrmpChannelId>(Call.hrmp_close_channel);
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.force_clean_hrmp);
				...
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HrmpChannelId, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.hrmp_cancel_open_request);
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>(Call.force_open_hrmp_channel);
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id>>(Call.establish_system_channel);
				AddTypeDecoder<BaseTuple<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id>>(Call.poke_channel_deposits);
				AddTypeDecoder<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id>(Call.establish_channel_with_system);
        }
    }
}
