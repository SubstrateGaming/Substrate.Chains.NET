...
namespace Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.assigner_on_demand.types
{
    ...
    public sealed class CoreAffinityCount : BaseType
    {
        ...
        /// >> core_index
        /// </summary>
        public Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.CoreIndex CoreIndex { get; set; }
        /// <summary>
        /// >> count
        /// </summary>
        ...
        {
            var start = p;
            CoreIndex = new Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.CoreIndex();
