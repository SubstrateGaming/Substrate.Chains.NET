...
namespace Substrate.Polkadot.NET.RestService.Generated.Controller
{
    ...
    public sealed class VestingController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Vesting")]
        [ProducesResponseType(typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT18), 200)]
        ...
        [ProducesResponseType(typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_vesting.EnumReleases), 200)]
        [StorageKeyBuilder(typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Storage.VestingStorage), "StorageVersionParams")]
