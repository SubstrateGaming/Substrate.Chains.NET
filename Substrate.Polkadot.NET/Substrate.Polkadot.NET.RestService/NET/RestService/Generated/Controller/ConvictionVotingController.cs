...
namespace Substrate.Polkadot.NET.RestService.Generated.Controller
{
    ...
    public sealed class ConvictionVotingController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("VotingFor")]
        [ProducesResponseType(typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_conviction_voting.vote.EnumVoting), 200)]
        [StorageKeyBuilder(typeof(Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ConvictionVotingStorage), "VotingForParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U16>))]
