...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface INominationPoolsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28 GetMetadata(string key);
    ...
    public sealed class NominationPoolsStorage : INominationPoolsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28> _metadataTypedStorage;
        ...
        public NominationPoolsStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.MetadataTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28>("NominationPools.Metadata", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28> MetadataTypedStorage
        {
            get
            {
        ...
        ///  Metadata for the pool.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28 GetMetadata(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (MetadataTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT28 result))
            {
                return result;
            }
            else
