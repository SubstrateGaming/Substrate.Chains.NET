...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IDemocracyStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo GetReferendumInfoOf(string key);
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting GetVotingOf(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded, Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold> GetNextExternal();
    ...
    public sealed class DemocracyStorage : IDemocracyStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo> _referendumInfoOfTypedStorage;
        
        /// <summary>
        /// _votingOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting> _votingOfTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded, Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold>> _nextExternalTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo> ReferendumInfoOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting> VotingOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded, Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold>> NextExternalTypedStorage
        {
            get
            {
        ...
        ///  TWOX-NOTE: SAFE as indexes are not under an attacker���s control.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo GetReferendumInfoOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferendumInfoOfTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo result))
            {
                return result;
            }
            else
        ...
        ///  TWOX-NOTE: SAFE as `AccountId`s are crypto hashes anyway.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting GetVotingOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingOfTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting result))
            {
                return result;
            }
            else
        ...
        ///  - `PublicProps` is empty.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Polkadot.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded, Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold> GetNextExternal()
        {
