...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IParaInclusionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments GetPendingAvailabilityCommitments(string key);
    }
    ...
    public sealed class ParaInclusionStorage : IParaInclusionStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments> _pendingAvailabilityCommitmentsTypedStorage;
        ...
        public ParaInclusionStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.PendingAvailabilityCommitmentsTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments>("ParaInclusion.PendingAvailabilityCommitments", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments> PendingAvailabilityCommitmentsTypedStorage
        {
            get
            {
        ...
        ///  The commitments of candidates pending availability, by `ParaId`.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments GetPendingAvailabilityCommitments(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PendingAvailabilityCommitmentsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.CandidateCommitments result))
            {
                return result;
            }
            else
