...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IReferendaStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetTrackQueue(string key);
    ...
    public sealed class ReferendaStorage : IReferendaStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24> _trackQueueTypedStorage;
        ...
        public ReferendaStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.TrackQueueTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24>("Referenda.TrackQueue", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 result))
            {
                return result;
            }
            else
