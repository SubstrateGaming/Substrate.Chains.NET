...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IParaSessionInfoStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> GetAssignmentKeysUnsafe();
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo GetSessions(string key);
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams GetSessionExecutorParams(string key);
    }
    ...
    public sealed class ParaSessionInfoStorage : IParaSessionInfoStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public>> _assignmentKeysUnsafeTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo> _sessionsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams> _sessionExecutorParamsTypedStorage;
        ...
        {
            this.AssignmentKeysUnsafeTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public>>("ParaSessionInfo.AssignmentKeysUnsafe", storageDataProvider, storageChangeDelegates);
            ...
            this.SessionsTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo>("ParaSessionInfo.Sessions", storageDataProvider, storageChangeDelegates);
            ...
            this.SessionExecutorParamsTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams>("ParaSessionInfo.SessionExecutorParams", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _assignmentKeysUnsafeTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public>> AssignmentKeysUnsafeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo> SessionsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> AccountKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams> SessionExecutorParamsTypedStorage
        {
            get
            {
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> GetAssignmentKeysUnsafe()
        {
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo GetSessions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SessionsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo result))
            {
                return result;
            }
            else
        ...
        ///  The validator account keys of the validators actively participating in parachain consensus.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetAccountKeys(string key)
        {
            if ((key == null))
            {
                return null;
        ...
        ///  Executor parameter set for a given session index
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams GetSessionExecutorParams(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SessionExecutorParamsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams result))
            {
                return result;
            }
            else
