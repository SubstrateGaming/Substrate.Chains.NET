...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IOffencesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key);
        
        /// <summary>
        /// >> ConcurrentReportsIndex
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256> GetConcurrentReportsIndex(string key);
    ...
    public sealed class OffencesStorage : IOffencesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> _reportsTypedStorage;
        
        /// <summary>
        /// _concurrentReportsIndexTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256>> _concurrentReportsIndexTypedStorage;
        ...
        {
            this.ReportsTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails>("Offences.Reports", storageDataProvider, storageChangeDelegates);
            this.ConcurrentReportsIndexTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256>>("Offences.ConcurrentReportsIndex", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> ReportsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256>> ConcurrentReportsIndexTypedStorage
        {
            get
            {
        ...
        ///  The primary structure that holds all offence records keyed by report identifiers.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReportsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails result))
            {
                return result;
            }
            else
        ...
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256> GetConcurrentReportsIndex(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ConcurrentReportsIndexTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256> result))
            {
                return result;
            }
            else
