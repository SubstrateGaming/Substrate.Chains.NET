...
namespace Substrate.Polkadot.NET.RestService.Generated.Storage
{
    ...
    public interface IParasDisputesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState GetDisputes(string key);
    ...
    public sealed class ParasDisputesStorage : IParasDisputesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState> _disputesTypedStorage;
        ...
        public ParasDisputesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.DisputesTypedStorage = new TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState>("ParasDisputes.Disputes", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState> DisputesTypedStorage
        {
            get
            {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState GetDisputes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DisputesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.DisputeState result))
            {
                return result;
            }
            else
