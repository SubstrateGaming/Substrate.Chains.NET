...
namespace Substrate.Polkadot.NET.RestClient.Test.Generated
{
   ...
   public class NominationPoolsControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 GetTestValue44()
      {
      ...
      public async System.Threading.Tasks.Task TestMetadata()
      {
         ...
         // Construct new RPC client to test with.
         NominationPoolsControllerClient rpcClient = new NominationPoolsControllerClient(_httpClient, subscriptionClient);
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 mockupValue = this.GetTestValue44();
         Substrate.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 rpcResult = await rpcClient.GetMetadata(mockupKey);
