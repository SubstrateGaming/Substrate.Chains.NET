...
namespace Substrate.Polkadot.NET.RestClient.Test.Generated
{
   ...
   public class BeefyMmrLeafControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet GetTestValue2()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet();
         result.Id = this.GetTestValueU64();
         result.Len = this.GetTestValueU32();
         result.KeysetCommitment = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.primitive_types.H256();
      ...
      public async System.Threading.Tasks.Task TestBeefyAuthorities()
      {
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet mockupValue = this.GetTestValue2();
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet rpcResult = await rpcClient.GetBeefyAuthorities();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet GetTestValue5()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet();
         result.Id = this.GetTestValueU64();
      ...
      public async System.Threading.Tasks.Task TestBeefyNextAuthorities()
      {
         ...
         // Construct new RPC client to test with.
         BeefyMmrLeafControllerClient rpcClient = new BeefyMmrLeafControllerClient(_httpClient, subscriptionClient);
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet mockupValue = this.GetTestValue5();
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_consensus_beefy.mmr.BeefyAuthoritySet rpcResult = await rpcClient.GetBeefyNextAuthorities();
