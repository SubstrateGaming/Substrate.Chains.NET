...
namespace Substrate.Polkadot.NET.RestClient.Test.Generated
{
   ...
   public class InitializerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.initializer.BufferedSessionChange GetTestValue5()
      {
         ...
         result.Validators = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public>();
         result.Validators.Create(new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public[] {
                  this.GetTestValue6()});
         result.Queued = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public>();
         result.Queued.Create(new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public[] {
                  this.GetTestValue8()});
         result.SessionIndex = this.GetTestValueU32();
         return result;
      }
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public GetTestValue6()
      {
      ...
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public GetTestValue8()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public();
         result.Value = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.sr25519.Public();
