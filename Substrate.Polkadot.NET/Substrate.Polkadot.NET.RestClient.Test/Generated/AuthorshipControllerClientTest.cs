...
namespace Substrate.Polkadot.NET.RestClient.Test.Generated
{
   ...
   public class AuthorshipControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT7 GetTestValue2()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT7 result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT7();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem>();
         result.Value.Create(new Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem[] {
                  this.GetTestValue3()});
         return result;
      }
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem GetTestValue3()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem();
         result.Create(this.GetTestValueEnum<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_authorship.UncleEntryItem>(), this.GetTestValueU32());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestUncles()
      {
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT7 mockupValue = this.GetTestValue2();
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT7 rpcResult = await rpcClient.GetUncles();
