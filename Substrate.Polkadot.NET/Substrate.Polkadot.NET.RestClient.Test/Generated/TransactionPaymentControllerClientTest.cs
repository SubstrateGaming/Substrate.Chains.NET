...
namespace Substrate.Polkadot.NET.RestClient.Test.Generated
{
   ...
   using Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment;
   ...
   public class TransactionPaymentControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestNextFeeMultiplier()
      {
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 rpcResult = await rpcClient.GetNextFeeMultiplier();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases GetTestValue4()
      {
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases result;
         result = new Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases();
         result.Create(this.GetTestValueEnum<Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.Releases>());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestStorageVersion()
      {
         ...
         // Construct new RPC client to test with.
         TransactionPaymentControllerClient rpcClient = new TransactionPaymentControllerClient(_httpClient, subscriptionClient);
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases mockupValue = this.GetTestValue4();
         ...
         Substrate.Polkadot.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases rpcResult = await rpcClient.GetStorageVersion();
