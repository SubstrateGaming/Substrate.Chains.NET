...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class GrandpaControllerMockupClient : MockupBaseClient, IGrandpaControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Grandpa/State", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.GrandpaStorage.StateParams());
      }
      public async Task<bool> SetPendingChange(StoredPendingChange value)
      {
         return await SendMockupRequestAsync(_httpClient, "Grandpa/PendingChange", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.GrandpaStorage.PendingChangeParams());
      }
      public async Task<bool> SetNextForced(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Grandpa/NextForced", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.GrandpaStorage.NextForcedParams());
      }
      public async Task<bool> SetStalled(BaseTuple<U32, U32> value)
      {
         return await SendMockupRequestAsync(_httpClient, "Grandpa/Stalled", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.GrandpaStorage.StalledParams());
      }
      public async Task<bool> SetCurrentSetId(U64 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Grandpa/CurrentSetId", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.GrandpaStorage.CurrentSetIdParams());
      }
