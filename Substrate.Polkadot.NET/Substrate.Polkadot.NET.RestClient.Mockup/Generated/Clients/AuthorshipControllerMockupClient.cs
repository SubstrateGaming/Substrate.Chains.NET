...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      public async Task<bool> SetUncles(BoundedVecT7 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Uncles", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.AuthorshipStorage.UnclesParams());
      }
      public async Task<bool> SetAuthor(AccountId32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
      public async Task<bool> SetDidSetUncles(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/DidSetUncles", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.AuthorshipStorage.DidSetUnclesParams());
      }
   }
}
