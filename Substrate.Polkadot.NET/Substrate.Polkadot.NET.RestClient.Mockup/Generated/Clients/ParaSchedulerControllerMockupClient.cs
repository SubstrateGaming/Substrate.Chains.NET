...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParaSchedulerControllerMockupClient : MockupBaseClient, IParaSchedulerControllerMockupClient
   {
      ...
      public async Task<bool> SetValidatorGroups(BaseVec<BaseVec<Substrate.Polkadot.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex>> value)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParaScheduler/ClaimQueue", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParaSchedulerStorage.ClaimQueueParams());
      }
   }
}
