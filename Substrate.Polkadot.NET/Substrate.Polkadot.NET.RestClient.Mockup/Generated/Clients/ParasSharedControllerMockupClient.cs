...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParasSharedControllerMockupClient : MockupBaseClient, IParasSharedControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParasShared/CurrentSessionIndex", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasSharedStorage.CurrentSessionIndexParams());
      }
      public async Task<bool> SetActiveValidatorIndices(BaseVec<ValidatorIndex> value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParasShared/ActiveValidatorIndices", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ParasSharedStorage.ActiveValidatorIndicesParams());
      }
