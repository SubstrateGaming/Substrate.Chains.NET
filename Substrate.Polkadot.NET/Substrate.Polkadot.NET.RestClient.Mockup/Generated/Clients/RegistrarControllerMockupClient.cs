...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class RegistrarControllerMockupClient : MockupBaseClient, IRegistrarControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Registrar/PendingSwap", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.RegistrarStorage.PendingSwapParams(key));
      }
      public async Task<bool> SetParas(ParaInfo value, Id key)
      {
         return await SendMockupRequestAsync(_httpClient, "Registrar/Paras", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.RegistrarStorage.ParasParams(key));
      }
      public async Task<bool> SetNextFreeParaId(Id value)
      {
         return await SendMockupRequestAsync(_httpClient, "Registrar/NextFreeParaId", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.RegistrarStorage.NextFreeParaIdParams());
      }
   }
}
