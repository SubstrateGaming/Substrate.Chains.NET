...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ImOnlineControllerMockupClient : MockupBaseClient, IImOnlineControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ImOnline/HeartbeatAfter", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ImOnlineStorage.HeartbeatAfterParams());
      }
      ...
      public async Task<bool> SetAuthoredBlocks(U32 value, Substrate.NetApi.Model.Types.Base.BaseTuple<U32, Substrate.Polkadot.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
      {
         return await SendMockupRequestAsync(_httpClient, "ImOnline/AuthoredBlocks", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ImOnlineStorage.AuthoredBlocksParams(key));
      }
   }
}
