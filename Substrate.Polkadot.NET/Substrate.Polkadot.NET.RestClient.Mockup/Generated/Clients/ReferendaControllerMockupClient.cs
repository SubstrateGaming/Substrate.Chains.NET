...
namespace Substrate.Polkadot.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ReferendaControllerMockupClient : MockupBaseClient, IReferendaControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Referenda/ReferendumCount", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ReferendaStorage.ReferendumCountParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Referenda/DecidingCount", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ReferendaStorage.DecidingCountParams(key));
      }
      public async Task<bool> SetMetadataOf(H256 value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Referenda/MetadataOf", value.Encode(), Substrate.Polkadot.NET.NetApiExt.Generated.Storage.ReferendaStorage.MetadataOfParams(key));
      }
   }
}
