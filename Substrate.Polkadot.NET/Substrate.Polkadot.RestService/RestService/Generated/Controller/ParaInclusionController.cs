...
namespace Substrate.Polkadot.RestService.Generated.Controller
{
    ...
    public sealed class ParaInclusionController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("V1")]
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.inclusion.CandidatePendingAvailability>), 200)]
        [StorageKeyBuilder(typeof(Substrate.Polkadot.NetApiExt.Generated.Storage.ParaInclusionStorage), "V1Params", typeof(Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id))]
