...
namespace Substrate.Polkadot.RestService.Generated.Storage
{
    ...
    public interface IAuctionsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt GetWinning(string key);
    }
    ...
    public sealed class AuctionsStorage : IAuctionsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt> _winningTypedStorage;
        ...
        public AuctionsStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.WinningTypedStorage = new TypedMapStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt>("Auctions.Winning", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt> WinningTypedStorage
        {
            get
            {
        ...
        ///  first sample of the ending period is 0; the last is `Sample Size - 1`.
        /// </summary>
        public Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt GetWinning(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (WinningTypedStorage.Dictionary.TryGetValue(key, out Substrate.Polkadot.NetApiExt.Generated.Types.Base.Arr36BaseOpt result))
            {
                return result;
            }
            else
