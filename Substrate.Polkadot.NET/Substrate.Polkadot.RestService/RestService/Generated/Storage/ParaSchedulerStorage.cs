...
namespace Substrate.Polkadot.RestService.Generated.Storage
{
    ...
    public interface IParaSchedulerStorage : IStorage
    {
        ...
        ///  upper bound at 10k.
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>> GetValidatorGroups();
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied> GetAvailabilityCores();
        ...
        /// </summary>
        Substrate.Polkadot.NetApiExt.Generated.Types.Base.BTreeMapT4 GetClaimQueue();
    }
    ...
    public sealed class ParaSchedulerStorage : IParaSchedulerStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>> _validatorGroupsTypedStorage;
        
        /// <summary>
        /// _availabilityCoresTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>> _availabilityCoresTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.BTreeMapT4> _claimQueueTypedStorage;
        ...
        {
            this.ValidatorGroupsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>>("ParaScheduler.ValidatorGroups", storageDataProvider, storageChangeDelegates);
            this.AvailabilityCoresTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>>("ParaScheduler.AvailabilityCores", storageDataProvider, storageChangeDelegates);
            ...
            this.ClaimQueueTypedStorage = new TypedStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.BTreeMapT4>("ParaScheduler.ClaimQueue", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _validatorGroupsTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>>> ValidatorGroupsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied>> AvailabilityCoresTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Polkadot.NetApiExt.Generated.Types.Base.BTreeMapT4> ClaimQueueTypedStorage
        {
            get
            {
        ...
        ///  upper bound at 10k.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v7.ValidatorIndex>> GetValidatorGroups()
        {
        ...
        ///    * The number of validators divided by `configuration.max_validators_per_core`.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.pallet.EnumCoreOccupied> GetAvailabilityCores()
        {
        ...
        ///  a block. Runtime APIs should be used to determine scheduled cores for the upcoming block.
        /// </summary>
        public Substrate.Polkadot.NetApiExt.Generated.Types.Base.BTreeMapT4 GetClaimQueue()
        {
