...
namespace Substrate.Coretime.NET.NetApiExt.Generated
{
    ...
    public sealed class SubstrateClientExt : Substrate.NetApi.SubstrateClient
    {
        ...
        /// <summary>
        /// BrokerStorage storage calls.
        /// </summary>
        public BrokerStorage BrokerStorage;
                ...
                base(uri, chargeType)
        {
            ...
            this.BrokerStorage = new BrokerStorage(this);
        }
    }
}
