...
namespace Substrate.Coretime.NET.NetApiExt.Generated.Model.frame_system
{
    ...
    /// <summary>
    /// >> 147 - Composite[frame_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.Coretime.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.Coretime.NET.NetApiExt.Generated.Model.primitive_types.H256();
