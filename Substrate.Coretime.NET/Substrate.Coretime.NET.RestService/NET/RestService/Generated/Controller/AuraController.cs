...
namespace Substrate.Coretime.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Coretime.NET.NetApiExt.Generated.Storage.AuraStorage), "AuthoritiesParams")]
        ...
        /// </summary>
        [HttpGet("CurrentSlot")]
        [ProducesResponseType(typeof(Substrate.Coretime.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot), 200)]
        [StorageKeyBuilder(typeof(Substrate.Coretime.NET.NetApiExt.Generated.Storage.AuraStorage), "CurrentSlotParams")]
