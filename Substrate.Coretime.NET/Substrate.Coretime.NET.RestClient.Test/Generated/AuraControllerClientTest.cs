...
namespace Substrate.Coretime.NET.RestClient.Test.Generated
{
   ...
   public class AuraControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Coretime.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetTestValue5()
      {
      ...
      public async System.Threading.Tasks.Task TestCurrentSlot()
      {
         ...
         // Construct new RPC client to test with.
         AuraControllerClient rpcClient = new AuraControllerClient(_httpClient, subscriptionClient);
         Substrate.Coretime.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot mockupValue = this.GetTestValue5();
         ...
         Substrate.Coretime.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot rpcResult = await rpcClient.GetCurrentSlot();
