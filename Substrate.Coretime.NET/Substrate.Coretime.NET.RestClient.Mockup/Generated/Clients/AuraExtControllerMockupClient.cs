...
namespace Substrate.Coretime.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraExtControllerMockupClient : MockupBaseClient, IAuraExtControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/Authorities", value.Encode(), Substrate.Coretime.NET.NetApiExt.Generated.Storage.AuraExtStorage.AuthoritiesParams());
      }
      public async Task<bool> SetSlotInfo(BaseTuple<Slot, U32> value)
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/SlotInfo", value.Encode(), Substrate.Coretime.NET.NetApiExt.Generated.Storage.AuraExtStorage.SlotInfoParams());
      }
   }
}
