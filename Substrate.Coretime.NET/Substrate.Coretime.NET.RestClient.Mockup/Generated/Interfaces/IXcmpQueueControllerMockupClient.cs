...
namespace Substrate.Coretime.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IXcmpQueueControllerMockupClient
   {
      ...
      Task<bool> SetOutboundXcmpStatus(BoundedVecT11 value);
      Task<bool> SetOutboundXcmpMessages(WeakBoundedVecT3 value, Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Coretime.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, U16> key);
      Task<bool> SetSignalMessages(WeakBoundedVecT3 value, Substrate.Coretime.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key);
      Task<bool> SetQueueConfig(QueueConfigData value);
      Task<bool> SetQueueSuspended(Bool value);
      Task<bool> SetDeliveryFeeFactor(FixedU128 value, Substrate.Coretime.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key);
   }
}
