...
namespace Substrate.Coretime.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   {
      Task<bool> SetInvulnerables(BoundedVecT8 value);
      Task<bool> SetCandidateList(BoundedVecT9 value);
      Task<bool> SetLastAuthoredBlock(U32 value, Substrate.Coretime.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
