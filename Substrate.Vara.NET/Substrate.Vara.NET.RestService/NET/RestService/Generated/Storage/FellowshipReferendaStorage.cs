...
namespace Substrate.Vara.NET.RestService.Generated.Storage
{
    ...
    public interface IFellowshipReferendaStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 GetTrackQueue(string key);
    ...
    public sealed class FellowshipReferendaStorage : IFellowshipReferendaStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> _trackQueueTypedStorage;
        ...
        public FellowshipReferendaStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ReferendumInfoForTypedStorage = new TypedMapStorage<Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo>("FellowshipReferenda.ReferendumInfoFor", storageDataProvider, storageChangeDelegates);
            this.TrackQueueTypedStorage = new TypedMapStorage<Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17>("FellowshipReferenda.TrackQueue", storageDataProvider, storageChangeDelegates);
            ...
            this.MetadataOfTypedStorage = new TypedMapStorage<Substrate.Vara.NET.NetApiExt.Generated.Model.primitive_types.H256>("FellowshipReferenda.MetadataOf", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17> TrackQueueTypedStorage
        {
            get
            {
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 GetTrackQueue(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TrackQueueTypedStorage.Dictionary.TryGetValue(key, out Substrate.Vara.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17 result))
            {
                return result;
            }
            else
