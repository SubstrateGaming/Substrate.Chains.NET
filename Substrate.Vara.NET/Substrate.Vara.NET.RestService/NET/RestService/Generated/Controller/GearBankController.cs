...
namespace Substrate.Vara.NET.RestService.Generated.Controller
{
    ...
    public sealed class GearBankController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Bank")]
        [ProducesResponseType(typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.pallet_gear_bank.pallet.BankAccount), 200)]
        [StorageKeyBuilder(typeof(Substrate.Vara.NET.NetApiExt.Generated.Storage.GearBankStorage), "BankParams", typeof(Substrate.Vara.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Vara.NET.NetApiExt.Generated.Storage.GearBankStorage), "UnusedValueParams")]
