...
namespace Substrate.KusamaAssetHub.NET.RestService.Generated.Storage
{
    ...
    public interface ICollatorSelectionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 GetInvulnerables();
        
        /// <summary>
        /// >> Candidates
        ///  The (community, limited) collation candidates.
        /// </summary>
        Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11 GetCandidates();
    ...
    public sealed class CollatorSelectionStorage : ICollatorSelectionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10> _invulnerablesTypedStorage;
        
        /// <summary>
        /// _candidatesTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11> _candidatesTypedStorage;
        ...
        {
            this.InvulnerablesTypedStorage = new TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10>("CollatorSelection.Invulnerables", storageDataProvider, storageChangeDelegates);
            this.CandidatesTypedStorage = new TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11>("CollatorSelection.Candidates", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10> InvulnerablesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11> CandidatesTypedStorage
        {
            get
            {
        ...
        ///  The invulnerable, fixed collators.
        /// </summary>
        public Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 GetInvulnerables()
        {
        ...
        ///  The (community, limited) collation candidates.
        /// </summary>
        public Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11 GetCandidates()
        {
