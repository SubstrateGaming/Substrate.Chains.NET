...
namespace Substrate.KusamaAssetHub.NET.RestService.Generated.Storage
{
    ...
    public interface IDmpQueueStorage : IStorage
    {
        ...
        ///  The configuration.
        /// </summary>
        Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData GetConfiguration();
        
        /// <summary>
        /// >> PageIndex
        ///  The page index.
        /// </summary>
        Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData GetPageIndex();
    ...
    public sealed class DmpQueueStorage : IDmpQueueStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData> _configurationTypedStorage;
        
        /// <summary>
        /// _pageIndexTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData> _pageIndexTypedStorage;
        ...
        {
            this.ConfigurationTypedStorage = new TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData>("DmpQueue.Configuration", storageDataProvider, storageChangeDelegates);
            this.PageIndexTypedStorage = new TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData>("DmpQueue.PageIndex", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData> ConfigurationTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData> PageIndexTypedStorage
        {
            get
            {
        ...
        ///  The configuration.
        /// </summary>
        public Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData GetConfiguration()
        {
        ...
        ///  The page index.
        /// </summary>
        public Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData GetPageIndex()
        {
