...
namespace Substrate.KusamaAssetHub.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CollatorSelectionControllerClient : BaseClient, ICollatorSelectionControllerClient
   {
      ...
      public async Task<U32> GetLastAuthoredBlock(Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "collatorselection/lastauthoredblock", Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
      public async Task<bool> SubscribeLastAuthoredBlock(Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("CollatorSelection.LastAuthoredBlock", Substrate.KusamaAssetHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
