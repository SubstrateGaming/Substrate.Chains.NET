...
namespace Substrate.KusamaBridgeHub.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ICollatorSelectionControllerClient
   {
      ...
      Task<U32> GetLastAuthoredBlock(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeLastAuthoredBlock(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
