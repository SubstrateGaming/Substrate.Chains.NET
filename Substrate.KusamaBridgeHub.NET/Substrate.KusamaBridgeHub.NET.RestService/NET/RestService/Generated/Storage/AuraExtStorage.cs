...
namespace Substrate.KusamaBridgeHub.NET.RestService.Generated.Storage
{
    ...
    public sealed class AuraExtStorage : IAuraExtStorage
    {
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8>("AuraExt.Authorities", storageDataProvider, storageChangeDelegates);
        }
