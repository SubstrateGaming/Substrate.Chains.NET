...
namespace Substrate.KusamaBridgeHub.NET.RestService.Generated.Controller
{
    ...
    public sealed class DmpQueueController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.ConfigData), 200)]
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.DmpQueueStorage), "ConfigurationParams")]
        ...
        /// </summary>
        [HttpGet("PageIndex")]
        [ProducesResponseType(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue.PageIndexData), 200)]
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.DmpQueueStorage), "PageIndexParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.DmpQueueStorage), "PagesParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.DmpQueueStorage), "OverweightParams", typeof(Substrate.NetApi.Model.Types.Primitive.U64))]
        ...
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.DmpQueueStorage), "CounterForOverweightParams")]
