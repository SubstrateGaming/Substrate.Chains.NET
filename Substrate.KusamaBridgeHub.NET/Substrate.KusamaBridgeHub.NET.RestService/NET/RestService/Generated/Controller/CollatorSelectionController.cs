...
namespace Substrate.KusamaBridgeHub.NET.RestService.Generated.Controller
{
    ...
    public sealed class CollatorSelectionController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6), 200)]
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "InvulnerablesParams")]
        ...
        /// </summary>
        [HttpGet("Candidates")]
        [ProducesResponseType(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7), 200)]
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "LastAuthoredBlockParams", typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "DesiredCandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.KusamaBridgeHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidacyBondParams")]
