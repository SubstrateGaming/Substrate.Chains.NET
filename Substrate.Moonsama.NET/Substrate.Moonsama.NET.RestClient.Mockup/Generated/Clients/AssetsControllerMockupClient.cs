...
namespace Substrate.Moonsama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AssetsControllerMockupClient : MockupBaseClient, IAssetsControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Assets/Asset", value.Encode(), Substrate.Moonsama.NET.NetApiExt.Generated.Storage.AssetsStorage.AssetParams(key));
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Assets/Account", value.Encode(), Substrate.Moonsama.NET.NetApiExt.Generated.Storage.AssetsStorage.AccountParams(key));
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Assets/Approvals", value.Encode(), Substrate.Moonsama.NET.NetApiExt.Generated.Storage.AssetsStorage.ApprovalsParams(key));
      }
      public async Task<bool> SetMetadata(AssetMetadata value, Substrate.NetApi.Model.Types.Primitive.U128 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Assets/Metadata", value.Encode(), Substrate.Moonsama.NET.NetApiExt.Generated.Storage.AssetsStorage.MetadataParams(key));
      }
   }
}
