...
namespace Substrate.Moonsama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TreasuryControllerClient : BaseClient, ITreasuryControllerClient
   {
      ...
      {
         return await SendRequestAsync<Proposal>(_httpClient, "treasury/proposals", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      public async Task<bool> SubscribeProposals(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Proposals", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
