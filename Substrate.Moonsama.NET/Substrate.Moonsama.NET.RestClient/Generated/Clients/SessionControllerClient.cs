...
namespace Substrate.Moonsama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class SessionControllerClient : BaseClient, ISessionControllerClient
   {
      ...
      public async Task<BaseVec<AccountId20>> GetValidators()
      {
         return await SendRequestAsync<BaseVec<AccountId20>>(_httpClient, "session/validators");
      }
      ...
      public async Task<BaseVec<BaseTuple<AccountId20, SessionKeys>>> GetQueuedKeys()
      {
         return await SendRequestAsync<BaseVec<BaseTuple<AccountId20, SessionKeys>>>(_httpClient, "session/queuedkeys");
      }
      ...
      public async Task<SessionKeys> GetNextKeys(AccountId20 key)
      {
         return await SendRequestAsync<SessionKeys>(_httpClient, "session/nextkeys", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.SessionStorage.NextKeysParams(key));
      }
      public async Task<bool> SubscribeNextKeys(AccountId20 key)
      {
         return await _subscriptionClient.SubscribeAsync("Session.NextKeys", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.SessionStorage.NextKeysParams(key));
      }
      public async Task<AccountId20> GetKeyOwner(BaseTuple<Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, BaseVec<U8>> key)
      {
         return await SendRequestAsync<AccountId20>(_httpClient, "session/keyowner", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.SessionStorage.KeyOwnerParams(key));
      }
      public async Task<bool> SubscribeKeyOwner(BaseTuple<Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, BaseVec<U8>> key)
      {
         return await _subscriptionClient.SubscribeAsync("Session.KeyOwner", Substrate.Moonsama.NET.NetApiExt.Generated.Storage.SessionStorage.KeyOwnerParams(key));
      }
   }
}
