...
namespace Substrate.Moonsama.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ISchedulerControllerClient
   {
      ...
      Task<BaseTuple<U32, U32>> GetLookup(Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
      Task<bool> SubscribeLookup(Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 key);
   }
}
