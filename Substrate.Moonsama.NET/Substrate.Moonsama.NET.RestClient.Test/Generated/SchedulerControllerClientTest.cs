...
namespace Substrate.Moonsama.NET.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 GetTestValue3()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>[] {
                  this.GetTestValue4()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
         result.MaybeId.Create(this.GetTestValue6());
         result.Priority = this.GetTestValueU8();
         result.Call = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         result.Call.Create(this.GetTestValueEnum<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.Bounded>(), this.GetTestValue7());
         ...
         result.Origin = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.moonsama_runtime.EnumOriginCaller();
         result.Origin.Create(this.GetTestValueEnum<Substrate.Moonsama.NET.NetApiExt.Generated.Model.moonsama_runtime.OriginCaller>(), this.GetTestValue9());
         return result;
      }
      public Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue6()
      {
      ...
      public Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin GetTestValue9()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin();
         result.Create(this.GetTestValueEnum<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.RawOrigin>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 mockupValue = this.GetTestValue3();
         ...
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27 rpcResult = await rpcClient.GetAgenda(mockupKey);
      ...
      public Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue12()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8();
         result.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         Substrate.Moonsama.NET.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue12();
