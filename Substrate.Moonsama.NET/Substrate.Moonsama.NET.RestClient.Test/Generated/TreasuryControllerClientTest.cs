...
namespace Substrate.Moonsama.NET.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal();
         result.Proposer = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);
      ...
      public Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetTestValue8()
      {
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 result;
         result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24();
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 mockupValue = this.GetTestValue8();
         ...
         Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 rpcResult = await rpcClient.GetApprovals();
