...
namespace Substrate.Moonsama.NET.RestService.Generated.Storage
{
    ...
    public interface IRandomnessStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState GetRequests(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> GetLocalVrfOutput();
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult GetRandomnessResults(string key);
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetPreviousLocalVrfOutput();
    }
    ...
    public sealed class RandomnessStorage : IRandomnessStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState> _requestsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>> _localVrfOutputTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult> _randomnessResultsTypedStorage;
        
        /// <summary>
        /// _previousLocalVrfOutputTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> _previousLocalVrfOutputTypedStorage;
        ...
        {
            this.RequestsTypedStorage = new TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState>("Randomness.Requests", storageDataProvider, storageChangeDelegates);
            ...
            this.LocalVrfOutputTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>>("Randomness.LocalVrfOutput", storageDataProvider, storageChangeDelegates);
            ...
            this.RandomnessResultsTypedStorage = new TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult>("Randomness.RandomnessResults", storageDataProvider, storageChangeDelegates);
            this.PreviousLocalVrfOutputTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>("Randomness.PreviousLocalVrfOutput", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _requestsTypedStorage property
        /// </summary>
        public TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState> RequestsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>> LocalVrfOutputTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult> RandomnessResultsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> PreviousLocalVrfOutputTypedStorage
        {
            get
            {
        ...
        ///  Randomness requests not yet fulfilled or purged
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState GetRequests(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RequestsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState result))
            {
                return result;
            }
            else
        ...
        ///  Set in `on_initialize`
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> GetLocalVrfOutput()
        {
        ...
        ///  Removed once $value.request_count == 0
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult GetRandomnessResults(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RandomnessResultsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult result))
            {
                return result;
            }
            else
        ...
        ///  Set in `on_finalize` of last block
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetPreviousLocalVrfOutput()
        {
