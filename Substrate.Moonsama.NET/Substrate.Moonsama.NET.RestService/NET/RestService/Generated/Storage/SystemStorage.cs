...
namespace Substrate.Moonsama.NET.RestService.Generated.Storage
{
    ...
    public interface ISystemStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key);
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1 GetBlockWeight();
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key);
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash();
        
        /// <summary>
        /// >> Digest
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest();
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents();
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade();
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EnumPhase GetExecutionPhase();
    }
    ...
    public sealed class SystemStorage : ISystemStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> _accountTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> _blockWeightTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> _blockHashTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> _parentHashTypedStorage;
        
        /// <summary>
        /// _digestTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> _digestTypedStorage;
        
        /// <summary>
        /// _eventsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> _eventsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> _lastRuntimeUpgradeTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> _executionPhaseTypedStorage;
        ...
        {
            this.AccountTypedStorage = new TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>("System.Account", storageDataProvider, storageChangeDelegates);
            ...
            this.BlockWeightTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1>("System.BlockWeight", storageDataProvider, storageChangeDelegates);
            ...
            this.BlockHashTypedStorage = new TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>("System.BlockHash", storageDataProvider, storageChangeDelegates);
            ...
            this.ParentHashTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>("System.ParentHash", storageDataProvider, storageChangeDelegates);
            this.DigestTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>("System.Digest", storageDataProvider, storageChangeDelegates);
            this.EventsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>("System.Events", storageDataProvider, storageChangeDelegates);
            ...
            this.LastRuntimeUpgradeTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>("System.LastRuntimeUpgrade", storageDataProvider, storageChangeDelegates);
            ...
            this.ExecutionPhaseTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>("System.ExecutionPhase", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _accountTypedStorage property
        /// </summary>
        public TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> BlockWeightTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> DigestTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> EventsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgradeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhaseTypedStorage
        {
            get
            {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.AccountInfo result))
            {
                return result;
            }
            else
        ...
        ///  The current weight for the block.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1 GetBlockWeight()
        {
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BlockHashTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
        ...
        ///  Hash of the previous block.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash()
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest()
        {
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents()
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade()
        {
        ...
        ///  The execution phase of the block.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.frame_system.EnumPhase GetExecutionPhase()
        {
