...
namespace Substrate.Moonsama.NET.RestService.Generated.Storage
{
    ...
    public interface ISudoStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 GetKey();
    }
    ...
    public sealed class SudoStorage : ISudoStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20> _keyTypedStorage;
        ...
        {
            this.KeyTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20>("Sudo.Key", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _keyTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20> KeyTypedStorage
        {
            get
            {
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 GetKey()
        {
