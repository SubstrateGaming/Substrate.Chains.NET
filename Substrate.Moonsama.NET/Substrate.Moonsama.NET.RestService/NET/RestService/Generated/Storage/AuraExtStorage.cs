...
namespace Substrate.Moonsama.NET.RestService.Generated.Storage
{
    ...
    public sealed class AuraExtStorage : IAuraExtStorage
    {
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12>("AuraExt.Authorities", storageDataProvider, storageChangeDelegates);
        }
