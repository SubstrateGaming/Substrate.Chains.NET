...
namespace Substrate.Moonsama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class RandomnessStorage
    {
        ...
        public RandomnessStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Randomness", "Requests"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U64), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Randomness", "LocalVrfOutput"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Randomness", "RandomnessResults"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.EnumRequestType), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Randomness", "PreviousLocalVrfOutput"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256)));
        }
        ...
        ///  Randomness requests not yet fulfilled or purged
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState> Requests(Substrate.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = RandomnessStorage.RequestsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RequestState>(parameters, token);
            return result;
        }
        ...
        ///  Set in `on_initialize`
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>> LocalVrfOutput(CancellationToken token)
        {
            string parameters = RandomnessStorage.LocalVrfOutputParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256>>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string RandomnessResultsParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.EnumRequestType key)
        {
        ...
        ///  Removed once $value.request_count == 0
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult> RandomnessResults(Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.EnumRequestType key, CancellationToken token)
        {
            string parameters = RandomnessStorage.RandomnessResultsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_randomness.types.RandomnessResult>(parameters, token);
            return result;
        }
        ...
        ///  Set in `on_finalize` of last block
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.primitive_types.H256> PreviousLocalVrfOutput(CancellationToken token)
        {
    ...
    public sealed class RandomnessCalls
    {
        ...
        public static Method SetBabeRandomnessResults()
        {
            ...
            return new Method(55, "Randomness", 0, "set_babe_randomness_results", byteArray.ToArray());
        }
    }
