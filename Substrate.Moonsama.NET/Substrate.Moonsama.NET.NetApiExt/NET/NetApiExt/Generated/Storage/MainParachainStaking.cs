...
namespace Substrate.Moonsama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParachainStakingStorage
    {
        ...
        public ParachainStakingStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Round"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.RoundInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "LastDelegation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.DelegationCounter)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "DelegatorState"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Stake)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "CandidatePool"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Candidate)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "TotalCollatorStake"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.TotalStake)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "TopCandidates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.set.OrderedSetT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "InflationConfig"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.inflation.InflationInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Unstaking"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMap)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "LastRewardReduction"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "BlocksAuthored"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParachainStaking", "Rewards"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20), typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
        ...
        {
            return "0x000000000000000014000000";
        }
        ...
        ///  Current round number and next round scheduled transition.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.RoundInfo> Round(CancellationToken token)
        {
            string parameters = ParachainStakingStorage.RoundParams();
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.RoundInfo>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastDelegationParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  session in which they (re-)delegated.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.DelegationCounter> LastDelegation(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.LastDelegationParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.DelegationCounter>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string DelegatorStateParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  It maps from an account to its delegation details.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Stake> DelegatorState(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.DelegatorStateParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Stake>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string CandidatePoolParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  Moreover, it counts the number of candidates.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Candidate> CandidatePool(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.CandidatePoolParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.Candidate>(parameters, token);
            return result;
        }
        ...
        ///  non collating candidates is not included in [TotalCollatorStake].
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.TotalStake> TotalCollatorStake(CancellationToken token)
        {
            string parameters = ParachainStakingStorage.TotalCollatorStakeParams();
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.types.TotalStake>(parameters, token);
            return result;
        }
        ...
        ///  stake.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.set.OrderedSetT2> TopCandidates(CancellationToken token)
        {
            string parameters = ParachainStakingStorage.TopCandidatesParams();
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.set.OrderedSetT2>(parameters, token);
            return result;
        }
        ...
        ///  Inflation configuration.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.inflation.InflationInfo> InflationConfig(CancellationToken token)
        {
            string parameters = ParachainStakingStorage.InflationConfigParams();
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.parachain_staking.inflation.InflationInfo>(parameters, token);
            return result;
        }
        ...
        ///  blocks.
        /// </summary>
        public static string UnstakingParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  blocks.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMap> Unstaking(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
            string parameters = ParachainStakingStorage.UnstakingParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonsama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMap>(parameters, token);
            return result;
        }
        ...
        ///  many blocks.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LastRewardReduction(CancellationToken token)
        {
        ...
        /// </summary>
        public static string BlocksAuthoredParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  `note_author` hook when authoring a block .
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> BlocksAuthored(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string BlocksRewardedParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  `inc_delegator_rewards` or updating the `InflationInfo`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> BlocksRewarded(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string RewardsParams(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key)
        {
        ...
        ///  It maps from accounts to their total rewards since the last payout.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Rewards(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 key, CancellationToken token)
        {
    ...
    public sealed class ParachainStakingCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceRemoveCandidate(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 collator)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ExecuteLeaveCandidates(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 collator)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(collator.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method JoinDelegators(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 collator, Substrate.NetApi.Model.Types.Primitive.U128 amount)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(collator.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnlockUnstaked(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 target)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class ParachainStakingConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 DefaultBlocksPerRound()
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U32();
        ...
        ///  `unlock_unstaked`.
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 StakeDuration()
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U32();
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 NetworkRewardStart()
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U32();
            result.Create("0x48A3C800");
            return result;
        }
        ...
        ///  stake.
        /// </summary>
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill NetworkRewardRate()
        {
            var result = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perquintill();
