...
namespace Substrate.Moonsama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20)));
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20> Author(CancellationToken token)
        {
