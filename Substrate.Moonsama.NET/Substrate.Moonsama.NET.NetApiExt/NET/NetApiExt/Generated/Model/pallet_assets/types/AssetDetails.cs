...
namespace Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_assets.types
{
    
    
    /// <summary>
    /// >> 300 - Composite[pallet_assets.types.AssetDetails]
    /// </summary>
    ...
    public sealed class AssetDetails : BaseType
    {
        ...
        /// >> issuer
        /// </summary>
        private Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 _issuer;
        
        /// <summary>
        /// >> admin
        /// </summary>
        private Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 _admin;
        
        /// <summary>
        /// >> freezer
        /// </summary>
        private Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 _freezer;
        ...
        /// >> status
        /// </summary>
        private Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_assets.types.EnumAssetStatus _status;
        ...
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 Issuer
        {
            get
            {
                return this._issuer;
        ...
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 Admin
        {
            get
            {
                return this._admin;
        ...
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20 Freezer
        {
            get
            {
        ...
        public Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_assets.types.EnumAssetStatus Status
        {
            get
            {
                return this._status;
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Issuer = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20();
            Issuer.Decode(byteArray, ref p);
            Admin = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20();
            Admin.Decode(byteArray, ref p);
            Freezer = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.fp_account.AccountId20();
            ...
            Status = new Substrate.Moonsama.NET.NetApiExt.Generated.Model.pallet_assets.types.EnumAssetStatus();
