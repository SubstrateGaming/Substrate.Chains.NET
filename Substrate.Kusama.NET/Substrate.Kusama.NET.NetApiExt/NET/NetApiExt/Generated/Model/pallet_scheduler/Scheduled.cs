...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 680 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8> _maybeId;
        ...
        /// >> call
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded _call;
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call
        {
            get
            {
                return this._call;
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
