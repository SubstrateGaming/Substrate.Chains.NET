...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5
{
    ...
    /// <summary>
    /// >> 343 - Composite[polkadot_primitives.v5.BackedCandidate]
    /// </summary>
    ...
    public sealed class BackedCandidate : BaseType
    {
        ...
        {
            var start = p;
            Candidate = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.CommittedCandidateReceipt();
            Candidate.Decode(byteArray, ref p);
            ValidityVotes = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.EnumValidityAttestation>();
