...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.signed
{
    
    
    /// <summary>
    /// >> 336 - Composite[polkadot_primitives.v5.signed.UncheckedSigned]
    /// </summary>
    ...
    public sealed class UncheckedSigned : BaseType
    {
        ...
        {
            var start = p;
            Payload = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.AvailabilityBitfield();
            ...
            Signature = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.validator_app.Signature();
