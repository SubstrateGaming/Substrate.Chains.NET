...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5
{
    ...
    /// <summary>
    /// >> 334 - Composite[polkadot_primitives.v5.InherentData]
    /// </summary>
    ...
    public sealed class InherentData : BaseType
    {
        ...
        {
            var start = p;
            Bitfields = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.signed.UncheckedSigned>();
            Bitfields.Decode(byteArray, ref p);
            BackedCandidates = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.BackedCandidate>();
