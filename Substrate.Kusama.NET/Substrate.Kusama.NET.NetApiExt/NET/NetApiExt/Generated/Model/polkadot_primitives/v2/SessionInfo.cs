...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    ...
    /// <summary>
    /// >> 818 - Composite[polkadot_primitives.v2.SessionInfo]
    /// </summary>
    ...
    public sealed class SessionInfo : BaseType
    {
        ...
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> _activeValidatorIndices;
        ...
        /// >> validators
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1 _validators;
        ...
        /// >> assignment_keys
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> _assignmentKeys;
        
        /// <summary>
        /// >> validator_groups
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2 _validatorGroups;
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> ActiveValidatorIndices
        {
            get
            {
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1 Validators
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> AssignmentKeys
        {
            get
            {
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2 ValidatorGroups
        {
            get
            {
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>();
            ActiveValidatorIndices.Decode(byteArray, ref p);
            RandomSeed = new Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8();
            ...
            Validators = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT1();
            Validators.Decode(byteArray, ref p);
            DiscoveryKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public>();
            DiscoveryKeys.Decode(byteArray, ref p);
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.IndexedVecT2();
