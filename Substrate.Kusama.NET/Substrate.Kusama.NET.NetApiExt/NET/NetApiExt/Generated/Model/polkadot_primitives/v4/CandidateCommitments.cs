...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    ...
    /// <summary>
    /// >> 343 - Composite[polkadot_primitives.v4.CandidateCommitments]
    /// </summary>
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        {
            var start = p;
            UpwardMessages = new Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT2();
            UpwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3();
