...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    ...
    /// <summary>
    /// >> 803 - Composite[polkadot_primitives.v4.SessionInfo]
    /// </summary>
    ...
    public sealed class SessionInfo : BaseType
    {
        ...
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex> _activeValidatorIndices;
        ...
        /// >> validators
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT1 _validators;
        ...
        /// >> assignment_keys
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.assignment_app.Public> _assignmentKeys;
        
        /// <summary>
        /// >> validator_groups
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT2 _validatorGroups;
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex> ActiveValidatorIndices
        {
            get
            {
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT1 Validators
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.assignment_app.Public> AssignmentKeys
        {
            get
            {
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT2 ValidatorGroups
        {
            get
            {
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex>();
            ...
            Validators = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT1();
            ...
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT2();
