...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.dispatch
{
    ...
    /// <summary>
    /// >> 519 - Composite[frame_support.dispatch.PerDispatchClassT2]
    /// </summary>
    ...
    public sealed class PerDispatchClassT2 : BaseType
    {
        ...
        {
            var start = p;
            Normal = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
            Normal.Decode(byteArray, ref p);
            Operational = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_system.limits.WeightsPerClass();
