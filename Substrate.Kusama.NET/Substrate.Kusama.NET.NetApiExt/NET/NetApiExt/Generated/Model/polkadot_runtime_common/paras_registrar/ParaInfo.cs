...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.paras_registrar
{
    
    
    /// <summary>
    /// >> 855 - Composite[polkadot_runtime_common.paras_registrar.ParaInfo]
    /// </summary>
    ...
    public sealed class ParaInfo : BaseType
    {
        ...
        /// >> manager
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Manager { get; set; }
        /// <summary>
        /// >> deposit
        /// </summary>
        ...
        {
            var start = p;
            Manager = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
