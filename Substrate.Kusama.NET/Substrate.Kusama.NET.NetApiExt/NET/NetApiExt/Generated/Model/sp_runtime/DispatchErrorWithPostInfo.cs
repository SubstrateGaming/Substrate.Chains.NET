...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime
{
    ...
    /// <summary>
    /// >> 468 - Composite[sp_runtime.DispatchErrorWithPostInfo]
    /// </summary>
    ...
    public sealed class DispatchErrorWithPostInfo : BaseType
    {
        ...
        {
            var start = p;
            PostInfo = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.dispatch.PostDispatchInfo();
            PostInfo.Decode(byteArray, ref p);
            Error = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime.EnumDispatchError();
