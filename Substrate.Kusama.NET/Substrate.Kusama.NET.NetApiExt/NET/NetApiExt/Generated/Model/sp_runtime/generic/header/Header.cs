...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime.generic.header
{
    
    
    /// <summary>
    /// >> 103 - Composite[sp_runtime.generic.header.Header]
    /// </summary>
    ...
    public sealed class Header : BaseType
    {
        ...
        {
            var start = p;
            ParentHash = new Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ...
            StateRoot = new Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256();
            StateRoot.Decode(byteArray, ref p);
            ExtrinsicsRoot = new Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ExtrinsicsRoot.Decode(byteArray, ref p);
            Digest = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest();
