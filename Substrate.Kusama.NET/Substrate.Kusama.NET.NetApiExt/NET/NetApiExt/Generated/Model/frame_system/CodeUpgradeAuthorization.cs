...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_system
{
    ...
    /// <summary>
    /// >> 566 - Composite[frame_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256();
