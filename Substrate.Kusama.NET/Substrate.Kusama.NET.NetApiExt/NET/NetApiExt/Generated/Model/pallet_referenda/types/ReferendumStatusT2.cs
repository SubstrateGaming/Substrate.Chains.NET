...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_referenda.types
{
    ...
    /// <summary>
    /// >> 633 - Composite[pallet_referenda.types.ReferendumStatusT2]
    /// </summary>
    ...
    public sealed class ReferendumStatusT2 : BaseType
    {
        ...
        /// >> tally
        /// </summary>
        private Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally _tally;
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally Tally
        {
            get
            {
                return this._tally;
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Enactment = new Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime();
            Enactment.Decode(byteArray, ref p);
            Submitted = new Substrate.NetApi.Model.Types.Primitive.U32();
            Submitted.Decode(byteArray, ref p);
            SubmissionDeposit = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit();
            SubmissionDeposit.Decode(byteArray, ref p);
            DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit>();
            DecisionDeposit.Decode(byteArray, ref p);
            Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_referenda.types.DecidingStatus>();
            Deciding.Decode(byteArray, ref p);
            Tally = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally();
