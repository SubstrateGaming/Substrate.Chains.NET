...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots
{
    
    
    /// <summary>
    /// >> 102 - Composite[sp_consensus_slots.EquivocationProof]
    /// </summary>
    ...
    public sealed class EquivocationProof : BaseType
    {
        ...
        {
            var start = p;
            Offender = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.app.Public();
            ...
            FirstHeader = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime.generic.header.Header();
            FirstHeader.Decode(byteArray, ref p);
            SecondHeader = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_runtime.generic.header.Header();
