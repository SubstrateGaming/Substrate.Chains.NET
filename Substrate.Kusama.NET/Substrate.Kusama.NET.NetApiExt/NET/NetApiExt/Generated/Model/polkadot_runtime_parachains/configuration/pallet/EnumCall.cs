...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.pallet
{
    ...
    /// <summary>
    /// >> 302 - Variant[polkadot_runtime_parachains.configuration.pallet.Call]
    /// Contains a variant per dispatchable extrinsic that this pallet has.
    /// </summary>
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				...
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.async_backing.AsyncBackingParams>(Call.set_async_backing_params);
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.executor_params.ExecutorParams>(Call.set_executor_params);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Primitive.U128>(Call.set_on_demand_base_fee);
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill>(Call.set_on_demand_fee_variability);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Primitive.U32>(Call.set_on_demand_queue_max_size);
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill>(Call.set_on_demand_target_queue_utilization);
				...
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.ApprovalVotingParams>(Call.set_approval_voting_params);
				AddTypeDecoder<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.vstaging.SchedulerParams>(Call.set_scheduler_params);
        }
    }
}
