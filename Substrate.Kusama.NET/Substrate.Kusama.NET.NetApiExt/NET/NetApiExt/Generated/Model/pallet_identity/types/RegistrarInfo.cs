...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 650 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        {
            var start = p;
            Account = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Account.Decode(byteArray, ref p);
            Fee = new Substrate.NetApi.Model.Types.Primitive.U128();
            Fee.Decode(byteArray, ref p);
            Fields = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags();
