...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list
{
    ...
    /// <summary>
    /// >> 799 - Composite[pallet_bags_list.list.Node]
    /// </summary>
    ...
    public sealed class Node : BaseType
    {
        ...
        {
            var start = p;
            Id = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Id.Decode(byteArray, ref p);
            Prev = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
            Prev.Decode(byteArray, ref p);
            Next = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
