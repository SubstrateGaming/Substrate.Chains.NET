...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaInherentStorage
    {
        ...
        public ParaInherentStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaInherent", "OnChainVotes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes)));
        }
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes> OnChainVotes(CancellationToken token)
        {
            string parameters = ParaInherentStorage.OnChainVotesParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class ParaInherentCalls
    {
        ...
        /// </summary>
        public static Method Enter(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.InherentData data)
        {
