...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        public ElectionProviderMultiPhaseStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ElectionProviderMultiPhase", "SignedSubmissionIndices"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT33)));
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT33> SignedSubmissionIndices(CancellationToken token)
        {
    ...
    public sealed class ElectionProviderMultiPhaseConstants
    {
        ...
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight SignedMaxWeight()
        {
            ...
            result.Create("0x0BC00F7077560113A3703D0AD7A370BD");
            return result;
        }
