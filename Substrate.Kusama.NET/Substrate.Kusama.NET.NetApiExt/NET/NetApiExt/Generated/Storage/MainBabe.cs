...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class BabeStorage
    {
        ...
        public BabeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "UnderConstruction"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "SkippedEpochs"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12)));
        }
        ...
        ///  Current epoch authorities.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> Authorities(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  until the first block of the chain.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> GenesisSlot(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.GenesisSlotParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Current slot number.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlot(string blockhash, CancellationToken token)
        {
        ...
        ///  adversary, for purposes such as public-coin zero-knowledge proofs.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8> Randomness(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.RandomnessParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Pending epoch configuration change that will be applied when the next epoch is enacted.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor> PendingEpochConfigChange(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.PendingEpochConfigChangeParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Next epoch randomness.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8> NextRandomness(string blockhash, CancellationToken token)
        {
        ...
        ///  Next epoch authorities.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT2> NextAuthorities(string blockhash, CancellationToken token)
        {
        ...
        ///  TWOX-NOTE: `SegmentIndex` is an increasing integer, so this is okay.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11> UnderConstruction(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.UnderConstructionParams(key);
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT11>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  if per-block initialization has already been called for current block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumPreDigest>> Initialized(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.InitializedParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumPreDigest>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  It is set in `on_finalize`, before it will contain the value from the last block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8>> AuthorVrfRandomness(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.AuthorVrfRandomnessParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  genesis.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration> EpochConfig(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.EpochConfigParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  (you can fallback to `EpochConfig` instead in that case).
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration> NextEpochConfig(string blockhash, CancellationToken token)
        {
        ...
        ///  active epoch index was during that session.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12> SkippedEpochs(string blockhash, CancellationToken token)
        {
            string parameters = BabeStorage.SkippedEpochsParams();
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class BabeCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots.EquivocationProof equivocation_proof, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(1, "Babe", 0, "report_equivocation", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_slots.EquivocationProof equivocation_proof, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(1, "Babe", 1, "report_equivocation_unsigned", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method PlanConfigChange(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor config)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(config.Encode());
            return new Method(1, "Babe", 2, "plan_config_change", byteArray.ToArray());
        }
    }
