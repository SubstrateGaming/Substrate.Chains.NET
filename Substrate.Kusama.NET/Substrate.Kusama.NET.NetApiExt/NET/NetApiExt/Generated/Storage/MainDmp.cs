...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class DmpStorage
    {
        ...
        /// </summary>
        public static string DownwardMessageQueuesParams(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  The downward messages addressed for a certain para.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage>> DownwardMessageQueues(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string DownwardMessageQueueHeadsParams(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  - `H(M)`: is the hash of the message being appended.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256> DownwardMessageQueueHeads(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
