...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParasSlashingStorage
    {
        ...
        ///  Validators pending dispute slashes.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.PendingSlashes> UnappliedSlashes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key, string blockhash, CancellationToken token)
        {
            string parameters = ParasSlashingStorage.UnappliedSlashesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.PendingSlashes>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class ParasSlashingCalls
    {
        ...
        /// </summary>
        public static Method ReportDisputeLostUnsigned(Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v7.slashing.DisputeProof dispute_proof, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
