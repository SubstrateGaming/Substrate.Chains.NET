...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class WhitelistStorage
    {
        ...
        public WhitelistStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Whitelist", "WhitelistedCall"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        
        /// <summary>
        /// >> WhitelistedCallParams
        /// </summary>
        public static string WhitelistedCallParams(Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
    ...
    public sealed class WhitelistCalls
    {
        ...
        public static Method WhitelistCall(Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash)
        {
            ...
            return new Method(44, "Whitelist", 0, "whitelist_call", byteArray.ToArray());
        }
        ...
        public static Method RemoveWhitelistedCall(Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call_hash.Encode());
            return new Method(44, "Whitelist", 1, "remove_whitelisted_call", byteArray.ToArray());
        }
        ...
        public static Method DispatchWhitelistedCall(Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 call_hash, Substrate.NetApi.Model.Types.Primitive.U32 call_encoded_len, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight call_weight_witness)
        {
            ...
            return new Method(44, "Whitelist", 2, "dispatch_whitelisted_call", byteArray.ToArray());
        }
        ...
        public static Method DispatchWhitelistedCallWithPreimage(Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_kusama_runtime.EnumRuntimeCall call)
        {
            ...
            return new Method(44, "Whitelist", 3, "dispatch_whitelisted_call_with_preimage", byteArray.ToArray());
        }
    }
