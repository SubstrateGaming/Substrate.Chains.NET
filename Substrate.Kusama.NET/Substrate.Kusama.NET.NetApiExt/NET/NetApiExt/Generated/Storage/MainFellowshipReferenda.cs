...
namespace Substrate.Kusama.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class FellowshipReferendaStorage
    {
        ...
        public FellowshipReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25)));
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT25> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class FellowshipReferendaCalls
    {
        ...
        /// </summary>
        public static Method Submit(Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_kusama_runtime.EnumOriginCaller proposal_origin, Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, Substrate.Kusama.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
            ...
            return new Method(23, "FellowshipReferenda", 0, "submit", byteArray.ToArray());
        }
        ...
        public static Method PlaceDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(23, "FellowshipReferenda", 1, "place_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method RefundDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(23, "FellowshipReferenda", 2, "refund_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(23, "FellowshipReferenda", 3, "cancel", byteArray.ToArray());
        }
        ...
        public static Method Kill(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(23, "FellowshipReferenda", 4, "kill", byteArray.ToArray());
        }
        ...
        public static Method NudgeReferendum(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(23, "FellowshipReferenda", 5, "nudge_referendum", byteArray.ToArray());
        }
        ...
        public static Method OneFewerDeciding(Substrate.NetApi.Model.Types.Primitive.U16 track)
        {
            ...
            return new Method(23, "FellowshipReferenda", 6, "one_fewer_deciding", byteArray.ToArray());
        }
    ...
    public sealed class FellowshipReferendaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            ...
            result.Create("0x2800002863616E646964617465730A0000003435261A0803000000000000000000002C010000C08" +
                    "901002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D01001C6" +
                    "D656D626572730A0000005205379C4D00000000000000000000002C010000C08901002C0100000A0" +
                    "000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D02002C70726F66696369656" +
                    "E74730A0000005205379C4D00000000000000000000002C010000C08901002C0100000A000000000" +
                    "0CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D03001C66656C6C6F77730A000000520" +
                    "5379C4D00000000000000000000002C010000C08901002C0100000A0000000000CA9A3B0065CD1D0" +
                    "0CA9A3B0000CA9A3B000000000065CD1D04003873656E696F722066656C6C6F77730A00000052053" +
                    "79C4D00000000000000000000002C010000C08901002C0100000A0000000000CA9A3B0065CD1D00C" +
                    "A9A3B0000CA9A3B000000000065CD1D05001C657870657274730A000000554DD2C20700000000000" +
                    "000000000002C010000C08901002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0" +
                    "00000000065CD1D06003873656E696F7220657870657274730A000000554DD2C2070000000000000" +
                    "0000000002C010000C08901002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000" +
                    "000000065CD1D07001C6D6173746572730A000000554DD2C20700000000000000000000002C01000" +
                    "0C08901002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D080" +
                    "03873656E696F72206D6173746572730A000000554DD2C20700000000000000000000002C010000C" +
                    "08901002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D09003" +
                    "46772616E64206D6173746572730A000000554DD2C20700000000000000000000002C010000C0890" +
                    "1002C0100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D");
            return result;
        }
    }
