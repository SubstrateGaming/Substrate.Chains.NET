...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class BeefyControllerClient : BaseClient, IBeefyControllerClient
   {
      ...
      public async Task<BoundedVecT17> GetAuthorities()
      {
         return await SendRequestAsync<BoundedVecT17>(_httpClient, "beefy/authorities");
      }
      ...
      public async Task<BoundedVecT17> GetNextAuthorities()
      {
         return await SendRequestAsync<BoundedVecT17>(_httpClient, "beefy/nextauthorities");
      }
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "beefy/setidsession", Substrate.Kusama.NET.NetApiExt.Generated.Storage.BeefyStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Beefy.SetIdSession", Substrate.Kusama.NET.NetApiExt.Generated.Storage.BeefyStorage.SetIdSessionParams(key));
      }
