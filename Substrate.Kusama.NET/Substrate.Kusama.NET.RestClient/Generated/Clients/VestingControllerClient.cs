...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class VestingControllerClient : BaseClient, IVestingControllerClient
   {
      ...
      public async Task<BoundedVecT28> GetVesting(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT28>(_httpClient, "vesting/vesting", Substrate.Kusama.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
