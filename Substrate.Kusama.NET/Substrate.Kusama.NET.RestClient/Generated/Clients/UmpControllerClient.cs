...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class UmpControllerClient : BaseClient, IUmpControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseVec<BaseVec<U8>>>(_httpClient, "ump/relaydispatchqueues", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.RelayDispatchQueuesParams(key));
      }
      public async Task<bool> SubscribeRelayDispatchQueues(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Ump.RelayDispatchQueues", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.RelayDispatchQueuesParams(key));
      }
      public async Task<BaseTuple<U32, U32>> GetRelayDispatchQueueSize(Id key)
      {
         return await SendRequestAsync<BaseTuple<U32, U32>>(_httpClient, "ump/relaydispatchqueuesize", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.RelayDispatchQueueSizeParams(key));
      }
      public async Task<bool> SubscribeRelayDispatchQueueSize(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Ump.RelayDispatchQueueSize", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.RelayDispatchQueueSizeParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Id, BaseVec<U8>>>(_httpClient, "ump/overweight", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.OverweightParams(key));
      }
      public async Task<bool> SubscribeOverweight(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Ump.Overweight", Substrate.Kusama.NET.NetApiExt.Generated.Storage.UmpStorage.OverweightParams(key));
      }
      public async Task<U32> GetCounterForOverweight()
      {
         return await SendRequestAsync<U32>(_httpClient, "ump/counterforoverweight");
      }
      public async Task<bool> SubscribeCounterForOverweight()
      {
         return await _subscriptionClient.SubscribeAsync("Ump.CounterForOverweight");
      }
