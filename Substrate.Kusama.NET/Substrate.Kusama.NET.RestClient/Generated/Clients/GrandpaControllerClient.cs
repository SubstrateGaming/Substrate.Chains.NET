...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class GrandpaControllerClient : BaseClient, IGrandpaControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "grandpa/setidsession", Substrate.Kusama.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Grandpa.SetIdSession", Substrate.Kusama.NET.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
