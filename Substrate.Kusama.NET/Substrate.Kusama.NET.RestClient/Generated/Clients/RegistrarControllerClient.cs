...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class RegistrarControllerClient : BaseClient, IRegistrarControllerClient
   {
      ...
      {
         return await SendRequestAsync<Id>(_httpClient, "registrar/pendingswap", Substrate.Kusama.NET.NetApiExt.Generated.Storage.RegistrarStorage.PendingSwapParams(key));
      }
      public async Task<bool> SubscribePendingSwap(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Registrar.PendingSwap", Substrate.Kusama.NET.NetApiExt.Generated.Storage.RegistrarStorage.PendingSwapParams(key));
      }
      public async Task<ParaInfo> GetParas(Id key)
      {
         return await SendRequestAsync<ParaInfo>(_httpClient, "registrar/paras", Substrate.Kusama.NET.NetApiExt.Generated.Storage.RegistrarStorage.ParasParams(key));
      }
      public async Task<bool> SubscribeParas(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("Registrar.Paras", Substrate.Kusama.NET.NetApiExt.Generated.Storage.RegistrarStorage.ParasParams(key));
      }
