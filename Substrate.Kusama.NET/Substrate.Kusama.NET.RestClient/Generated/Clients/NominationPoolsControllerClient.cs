...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class NominationPoolsControllerClient : BaseClient, INominationPoolsControllerClient
   {
      ...
      {
         return await SendRequestAsync<PoolMember>(_httpClient, "nominationpools/poolmembers", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.PoolMembersParams(key));
      }
      public async Task<bool> SubscribePoolMembers(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.PoolMembers", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.PoolMembersParams(key));
      }
      ...
      {
         return await SendRequestAsync<BondedPoolInner>(_httpClient, "nominationpools/bondedpools", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.BondedPoolsParams(key));
      }
      public async Task<bool> SubscribeBondedPools(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.BondedPools", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.BondedPoolsParams(key));
      }
      ...
      {
         return await SendRequestAsync<RewardPool>(_httpClient, "nominationpools/rewardpools", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.RewardPoolsParams(key));
      }
      public async Task<bool> SubscribeRewardPools(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.RewardPools", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.RewardPoolsParams(key));
      }
      ...
      {
         return await SendRequestAsync<SubPools>(_httpClient, "nominationpools/subpoolsstorage", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.SubPoolsStorageParams(key));
      }
      public async Task<bool> SubscribeSubPoolsStorage(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.SubPoolsStorage", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.SubPoolsStorageParams(key));
      }
      ...
      public async Task<BoundedVecT41> GetMetadata(U32 key)
      {
         return await SendRequestAsync<BoundedVecT41>(_httpClient, "nominationpools/metadata", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.MetadataParams(key));
      }
      public async Task<bool> SubscribeMetadata(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.Metadata", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.MetadataParams(key));
      }
      ...
      public async Task<U32> GetReversePoolIdLookup(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "nominationpools/reversepoolidlookup", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.ReversePoolIdLookupParams(key));
      }
      public async Task<bool> SubscribeReversePoolIdLookup(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("NominationPools.ReversePoolIdLookup", Substrate.Kusama.NET.NetApiExt.Generated.Storage.NominationPoolsStorage.ReversePoolIdLookupParams(key));
      }
