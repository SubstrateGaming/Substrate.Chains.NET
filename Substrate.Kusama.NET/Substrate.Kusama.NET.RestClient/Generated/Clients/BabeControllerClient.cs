...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class BabeControllerClient : BaseClient, IBabeControllerClient
   {
      ...
      {
         return await SendRequestAsync<WeakBoundedVecT2>(_httpClient, "babe/authorities");
      }
      ...
      public async Task<WeakBoundedVecT2> GetNextAuthorities()
      {
         return await SendRequestAsync<WeakBoundedVecT2>(_httpClient, "babe/nextauthorities");
      }
      ...
      public async Task<BoundedVecT11> GetUnderConstruction(U32 key)
      {
         return await SendRequestAsync<BoundedVecT11>(_httpClient, "babe/underconstruction", Substrate.Kusama.NET.NetApiExt.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
      public async Task<bool> SubscribeUnderConstruction(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Babe.UnderConstruction", Substrate.Kusama.NET.NetApiExt.Generated.Storage.BabeStorage.UnderConstructionParams(key));
      }
      ...
      public async Task<BoundedVecT12> GetSkippedEpochs()
      {
         return await SendRequestAsync<BoundedVecT12>(_httpClient, "babe/skippedepochs");
      }
