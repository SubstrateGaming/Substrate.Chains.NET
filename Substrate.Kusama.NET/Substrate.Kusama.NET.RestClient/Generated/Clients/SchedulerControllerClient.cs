...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class SchedulerControllerClient : BaseClient, ISchedulerControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT29>(_httpClient, "scheduler/agenda", Substrate.Kusama.NET.NetApiExt.Generated.Storage.SchedulerStorage.AgendaParams(key));
      }
