...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ElectionProviderMultiPhaseControllerClient : BaseClient, IElectionProviderMultiPhaseControllerClient
   {
      ...
      public async Task<BoundedVecT33> GetSignedSubmissionIndices()
      {
         return await SendRequestAsync<BoundedVecT33>(_httpClient, "electionprovidermultiphase/signedsubmissionindices");
      }
      ...
      {
         return await SendRequestAsync<SignedSubmission>(_httpClient, "electionprovidermultiphase/signedsubmissionsmap", Substrate.Kusama.NET.NetApiExt.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
      public async Task<bool> SubscribeSignedSubmissionsMap(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("ElectionProviderMultiPhase.SignedSubmissionsMap", Substrate.Kusama.NET.NetApiExt.Generated.Storage.ElectionProviderMultiPhaseStorage.SignedSubmissionsMapParams(key));
      }
