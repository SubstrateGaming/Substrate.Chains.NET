...
namespace Substrate.Kusama.NET.RestClient.Generated.Clients
{
   ...
   public sealed class PhragmenElectionControllerClient : BaseClient, IPhragmenElectionControllerClient
   {
      ...
      public async Task<BaseVec<BaseTuple<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U128>>> GetCandidates()
      {
         return await SendRequestAsync<BaseVec<BaseTuple<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U128>>>(_httpClient, "phragmenelection/candidates");
      }
      ...
      public async Task<Voter> GetVoting(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<Voter>(_httpClient, "phragmenelection/voting", Substrate.Kusama.NET.NetApiExt.Generated.Storage.PhragmenElectionStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("PhragmenElection.Voting", Substrate.Kusama.NET.NetApiExt.Generated.Storage.PhragmenElectionStorage.VotingParams(key));
      }
   }
}
