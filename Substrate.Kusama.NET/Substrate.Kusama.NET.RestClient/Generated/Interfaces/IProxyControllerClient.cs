...
namespace Substrate.Kusama.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BaseTuple<BoundedVecT30, U128>> GetProxies(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeProxies(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<BaseTuple<BoundedVecT31, U128>> GetAnnouncements(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
