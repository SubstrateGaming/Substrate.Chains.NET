...
namespace Substrate.Kusama.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BaseVec<BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>>> GetValidatorGroups();
      Task<bool> SubscribeValidatorGroups();
      Task<ParathreadClaimQueue> GetParathreadQueue();
      Task<bool> SubscribeParathreadQueue();
      Task<BaseVec<BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.EnumCoreOccupied>>> GetAvailabilityCores();
