...
namespace Substrate.Kusama.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IXcmPalletControllerClient
   {
      ...
      Task<BoundedVecT44> GetVersionDiscoveryQueue();
      ...
      Task<BoundedVecT46> GetLockedFungibles(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
