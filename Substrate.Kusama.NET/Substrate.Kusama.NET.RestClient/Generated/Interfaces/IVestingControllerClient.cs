...
namespace Substrate.Kusama.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BoundedVecT28> GetVesting(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeVesting(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
