...
namespace Substrate.Kusama.NET.RestService.Generated.Controller
{
    ...
    public sealed class FastUnstakeController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Head")]
        [ProducesResponseType(typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest), 200)]
        [StorageKeyBuilder(typeof(Substrate.Kusama.NET.NetApiExt.Generated.Storage.FastUnstakeStorage), "HeadParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Kusama.NET.NetApiExt.Generated.Storage.FastUnstakeStorage), "QueueParams", typeof(Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Kusama.NET.NetApiExt.Generated.Storage.FastUnstakeStorage), "CounterForQueueParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.Kusama.NET.NetApiExt.Generated.Storage.FastUnstakeStorage), "ErasToCheckPerBlockParams")]
