...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IVestingStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 GetVesting(string key);
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_vesting.EnumReleases GetStorageVersion();
    }
    ...
    public sealed class VestingStorage : IVestingStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> _vestingTypedStorage;
        
        /// <summary>
        /// _storageVersionTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_vesting.EnumReleases> _storageVersionTypedStorage;
        ...
        {
            this.VestingTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28>("Vesting.Vesting", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> VestingTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_vesting.EnumReleases> StorageVersionTypedStorage
        {
            get
            {
        ...
        ///  Information regarding the vesting of a given account.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 GetVesting(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VestingTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28 result))
            {
                return result;
            }
            else
        ...
        ///  New networks start with latest version, as determined by the genesis build.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_vesting.EnumReleases GetStorageVersion()
        {
