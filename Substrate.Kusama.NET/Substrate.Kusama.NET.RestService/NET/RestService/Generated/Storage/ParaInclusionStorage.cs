...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IParaInclusionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments GetPendingAvailabilityCommitments(string key);
    }
    ...
    public sealed class ParaInclusionStorage : IParaInclusionStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments> _pendingAvailabilityCommitmentsTypedStorage;
        ...
        public ParaInclusionStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.PendingAvailabilityCommitmentsTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments>("ParaInclusion.PendingAvailabilityCommitments", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments> PendingAvailabilityCommitmentsTypedStorage
        {
            get
            {
        ...
        ///  The commitments of candidates pending availability, by `ParaId`.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments GetPendingAvailabilityCommitments(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PendingAvailabilityCommitmentsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.CandidateCommitments result))
            {
                return result;
            }
            else
