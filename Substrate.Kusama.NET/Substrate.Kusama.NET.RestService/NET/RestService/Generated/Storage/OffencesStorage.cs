...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IOffencesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key);
    ...
    public sealed class OffencesStorage : IOffencesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> _reportsTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> ReportsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256>> ConcurrentReportsIndexTypedStorage
        {
            get
            {
        ...
        ///  The primary structure that holds all offence records keyed by report identifiers.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReportsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails result))
            {
                return result;
            }
            else
        ...
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256> GetConcurrentReportsIndex(string key)
        {
            if ((key == null))
            {
                return null;
