...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public sealed class ParasDisputesStorage : IParasDisputesStorage
    {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState> DisputesTypedStorage
        {
            get
            {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState GetDisputes(string key)
        {
            if ((key == null))
            {
                return null;
