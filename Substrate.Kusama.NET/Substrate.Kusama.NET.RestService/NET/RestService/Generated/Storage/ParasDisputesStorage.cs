...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IParasDisputesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState GetDisputes(string key);
    ...
    public sealed class ParasDisputesStorage : IParasDisputesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState> _disputesTypedStorage;
        ...
        public ParasDisputesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.DisputesTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState>("ParasDisputes.Disputes", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState> DisputesTypedStorage
        {
            get
            {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState GetDisputes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DisputesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.DisputeState result))
            {
                return result;
            }
            else
