...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IXcmPalletStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45 GetVersionDiscoveryQueue();
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47 GetLockedFungibles(string key);
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm();
    }
    ...
    public sealed class XcmPalletStorage : IXcmPalletStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45> _versionDiscoveryQueueTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47> _lockedFungiblesTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> _recordedXcmTypedStorage;
        ...
        public XcmPalletStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.VersionDiscoveryQueueTypedStorage = new TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45>("XcmPallet.VersionDiscoveryQueue", storageDataProvider, storageChangeDelegates);
            ...
            this.LockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47>("XcmPallet.LockedFungibles", storageDataProvider, storageChangeDelegates);
            ...
            this.RecordedXcmTypedStorage = new TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1>("XcmPallet.RecordedXcm", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45> VersionDiscoveryQueueTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47> LockedFungiblesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcmTypedStorage
        {
            get
            {
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45 GetVersionDiscoveryQueue()
        {
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47 GetLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT47 result))
            {
                return result;
            }
            else
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm()
        {
