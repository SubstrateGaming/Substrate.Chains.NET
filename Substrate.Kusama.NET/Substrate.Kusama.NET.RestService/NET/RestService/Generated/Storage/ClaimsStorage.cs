...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IClaimsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind GetSigning(string key);
        
        /// <summary>
        /// >> Preclaims
        ///  Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetPreclaims(string key);
    }
    ...
    public sealed class ClaimsStorage : IClaimsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind> _signingTypedStorage;
        
        /// <summary>
        /// _preclaimsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress> _preclaimsTypedStorage;
        ...
        public ClaimsStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.SigningTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind>("Claims.Signing", storageDataProvider, storageChangeDelegates);
            this.PreclaimsTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress>("Claims.Preclaims", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind> SigningTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress> PreclaimsTypedStorage
        {
            get
            {
        ...
        ///  The statement kind that must be signed, if any.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind GetSigning(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SigningTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind result))
            {
                return result;
            }
            else
        ...
        ///  Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetPreclaims(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PreclaimsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress result))
            {
                return result;
            }
            else
