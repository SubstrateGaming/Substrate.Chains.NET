...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface ITipsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip GetTips(string key);
    ...
    public sealed class TipsStorage : ITipsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip> _tipsTypedStorage;
        ...
        {
            this.TipsTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip>("Tips.Tips", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip> TipsTypedStorage
        {
            get
            {
        ...
        ///  guaranteed to be a secure hash.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip GetTips(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TipsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_tips.OpenTip result))
            {
                return result;
            }
            else
