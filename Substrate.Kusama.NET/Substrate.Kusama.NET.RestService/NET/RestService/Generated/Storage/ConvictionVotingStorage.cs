...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IConvictionVotingStorage : IStorage
    {
        ...
        ///  this list.
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 GetClassLocksFor(string key);
    }
    ...
    public sealed class ConvictionVotingStorage : IConvictionVotingStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17> _classLocksForTypedStorage;
        ...
        public ConvictionVotingStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ClassLocksForTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17>("ConvictionVoting.ClassLocksFor", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17> ClassLocksForTypedStorage
        {
            get
            {
        ...
        ///  this list.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 GetClassLocksFor(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ClassLocksForTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 result))
            {
                return result;
            }
            else
