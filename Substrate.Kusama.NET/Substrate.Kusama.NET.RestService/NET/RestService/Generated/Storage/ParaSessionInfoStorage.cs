...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IParaSessionInfoStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> GetAssignmentKeysUnsafe();
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo GetSessions(string key);
    ...
    public sealed class ParaSessionInfoStorage : IParaSessionInfoStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public>> _assignmentKeysUnsafeTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo> _sessionsTypedStorage;
        ...
        {
            this.AssignmentKeysUnsafeTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public>>("ParaSessionInfo.AssignmentKeysUnsafe", storageDataProvider, storageChangeDelegates);
            ...
            this.SessionsTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo>("ParaSessionInfo.Sessions", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public>> AssignmentKeysUnsafeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo> SessionsTypedStorage
        {
            get
            {
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.assignment_app.Public> GetAssignmentKeysUnsafe()
        {
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo GetSessions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SessionsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.SessionInfo result))
            {
                return result;
            }
            else
