...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IDmpStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage> GetDownwardMessageQueues(string key);
    ...
    public sealed class DmpStorage : IDmpStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage>> _downwardMessageQueuesTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage>> DownwardMessageQueuesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256> DownwardMessageQueueHeadsTypedStorage
        {
            get
            {
        ...
        ///  The downward messages addressed for a certain para.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage> GetDownwardMessageQueues(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DownwardMessageQueuesTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage> result))
            {
                return result;
            }
            else
        ...
        ///  - `H(M)`: is the hash of the message being appended.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.primitive_types.H256 GetDownwardMessageQueueHeads(string key)
        {
            if ((key == null))
            {
                return null;
