...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface ICrowdloanStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.FundInfo GetFunds(string key);
    ...
    public sealed class CrowdloanStorage : ICrowdloanStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.FundInfo> _fundsTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.FundInfo> FundsTypedStorage
        {
            get
            {
        ...
        ///  Info on all of the funds.
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.FundInfo GetFunds(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (FundsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.FundInfo result))
            {
                return result;
            }
            else
