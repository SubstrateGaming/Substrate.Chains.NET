...
namespace Substrate.Kusama.NET.RestService.Generated.Storage
{
    ...
    public interface IFellowshipCollectiveStorage : IStorage
    {
        ...
        /// >> VotingCleanup
        /// </summary>
        Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19 GetVotingCleanup(string key);
    }
    ...
    public sealed class FellowshipCollectiveStorage : IFellowshipCollectiveStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19> _votingCleanupTypedStorage;
        ...
        public FellowshipCollectiveStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.VotingCleanupTypedStorage = new TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19>("FellowshipCollective.VotingCleanup", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19> VotingCleanupTypedStorage
        {
            get
            {
        ...
        /// >> VotingCleanup
        /// </summary>
        public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19 GetVotingCleanup(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingCleanupTypedStorage.Dictionary.TryGetValue(key, out Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19 result))
            {
                return result;
            }
            else
