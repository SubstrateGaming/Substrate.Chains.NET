...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class CrowdloanControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestNewRaise()
      {
         ...
         // Construct new RPC client to test with.
         CrowdloanControllerClient rpcClient = new CrowdloanControllerClient(_httpClient, subscriptionClient);
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> mockupValue = this.GetTestValue8();
         ...
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> rpcResult = await rpcClient.GetNewRaise();
