...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class AssetRateControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.impls.EnumVersionedLocatableAsset GetTestValue3()
      {
      ...
      public async System.Threading.Tasks.Task TestConversionRateToNative()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.impls.EnumVersionedLocatableAsset mockupKey = this.GetTestValue3();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 rpcResult = await rpcClient.GetConversionRateToNative(mockupKey);
