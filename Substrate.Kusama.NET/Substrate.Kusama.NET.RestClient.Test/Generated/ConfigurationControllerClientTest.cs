...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class ConfigurationControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_parachains.configuration.HostConfiguration GetTestValue2()
      {
         ...
         result.ExecutorParams = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParams();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParams GetTestValue4()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.EnumExecutorParam GetTestValue5()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParams GetTestValue13()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParams result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParams();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.EnumExecutorParam>();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.EnumExecutorParam GetTestValue14()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.EnumExecutorParam result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.EnumExecutorParam();
         result.Create(this.GetTestValueEnum<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v5.executor_params.ExecutorParam>(), this.GetTestValueBaseVoid());
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill GetTestValue15()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
         result.Value = this.GetTestValueU32();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill GetTestValue16()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
         result.Value = this.GetTestValueU32();
