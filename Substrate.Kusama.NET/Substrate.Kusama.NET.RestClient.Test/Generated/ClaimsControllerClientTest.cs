...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class ClaimsControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetTestValue2()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress();
         result.Value = new Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr20U8();
      ...
      public async System.Threading.Tasks.Task TestClaims()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress mockupKey = this.GetTestValue2();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetTestValue6()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress();
         result.Value = new Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr20U8();
      ...
      public async System.Threading.Tasks.Task TestVesting()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress mockupKey = this.GetTestValue6();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind GetTestValue8()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind();
         result.Create(this.GetTestValueEnum<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.StatementKind>());
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetTestValue9()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress();
         result.Value = new Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr20U8();
      ...
      public async System.Threading.Tasks.Task TestSigning()
      {
         ...
         // Construct new RPC client to test with.
         ClaimsControllerClient rpcClient = new ClaimsControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind mockupValue = this.GetTestValue8();
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress mockupKey = this.GetTestValue9();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EnumStatementKind rpcResult = await rpcClient.GetSigning(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress GetTestValue11()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress();
         result.Value = new Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr20U8();
      ...
      public async System.Threading.Tasks.Task TestPreclaims()
      {
         ...
         // Construct new RPC client to test with.
         ClaimsControllerClient rpcClient = new ClaimsControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress mockupValue = this.GetTestValue11();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_runtime_common.claims.EthereumAddress rpcResult = await rpcClient.GetPreclaims(mockupKey);
