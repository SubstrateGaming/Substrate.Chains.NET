...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class AuthorshipControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 GetTestValue2()
      {
         ...
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem>();
         result.Value.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem[] {
                  this.GetTestValue3()});
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem GetTestValue3()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem();
         result.Create(this.GetTestValueEnum<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_authorship.UncleEntryItem>(), this.GetTestValueU32());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestUncles()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 mockupValue = this.GetTestValue2();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 rpcResult = await rpcClient.GetUncles();
      ...
      public async System.Threading.Tasks.Task TestAuthor()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 rpcResult = await rpcClient.GetAuthor();
