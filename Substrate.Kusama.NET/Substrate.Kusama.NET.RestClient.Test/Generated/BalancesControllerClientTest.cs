...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class BalancesControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13 GetTestValue12()
      {
      ...
      public async System.Threading.Tasks.Task TestReserves()
      {
         ...
         // Construct new RPC client to test with.
         BalancesControllerClient rpcClient = new BalancesControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13 mockupValue = this.GetTestValue12();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13 rpcResult = await rpcClient.GetReserves(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestFreezes()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15 rpcResult = await rpcClient.GetFreezes(mockupKey);
