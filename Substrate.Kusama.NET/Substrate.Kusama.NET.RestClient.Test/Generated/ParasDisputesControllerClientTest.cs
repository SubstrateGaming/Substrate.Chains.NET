...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class ParasDisputesControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState GetTestValue3()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState();
      ...
      public async System.Threading.Tasks.Task TestDisputes()
      {
         ...
         // Construct new RPC client to test with.
         ParasDisputesControllerClient rpcClient = new ParasDisputesControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState mockupValue = this.GetTestValue3();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState rpcResult = await rpcClient.GetDisputes(mockupKey);
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.BTreeSet GetTestValue10()
      {
         ...
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex>();
         result.Value.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex[] {
                  this.GetTestValue11()});
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex GetTestValue11()
      {
