...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class FellowshipReferendaControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetTestValue16()
      {
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         FellowshipReferendaControllerClient rpcClient = new FellowshipReferendaControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 mockupValue = this.GetTestValue16();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
