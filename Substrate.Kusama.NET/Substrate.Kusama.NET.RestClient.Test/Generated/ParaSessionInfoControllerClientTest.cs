...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class ParaSessionInfoControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> GetTestValue2()
      {
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public>();
         result.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public[] {
                  this.GetTestValue3()});
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public GetTestValue3()
      {
      ...
      public async System.Threading.Tasks.Task TestAssignmentKeysUnsafe()
      {
         ...
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> mockupValue = this.GetTestValue2();
         ...
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public> rpcResult = await rpcClient.GetAssignmentKeysUnsafe();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo GetTestValue7()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo();
         result.ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex>();
         result.ActiveValidatorIndices.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex[] {
                  this.GetTestValue8()});
         ...
         result.Validators = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT1();
         ...
         result.DiscoveryKeys.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public[] {
                  this.GetTestValue12()});
         result.AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public>();
         result.AssignmentKeys.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public[] {
                  this.GetTestValue14()});
         result.ValidatorGroups = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT2();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex GetTestValue8()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT1 GetTestValue9()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT1 result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT1();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.validator_app.Public>();
         result.Value.Create(new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.validator_app.Public[] {
                  this.GetTestValue10()});
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.validator_app.Public GetTestValue10()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public GetTestValue14()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.assignment_app.Public();
         result.Value = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.sr25519.Public();
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT2 GetTestValue16()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT2 result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.IndexedVecT2();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex>>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex>[] {
                  this.GetTestValue17()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex> GetTestValue17()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex GetTestValue18()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.ValidatorIndex();
         result.Value = this.GetTestValueU32();
      ...
      public async System.Threading.Tasks.Task TestSessions()
      {
         ...
         // Construct new RPC client to test with.
         ParaSessionInfoControllerClient rpcClient = new ParaSessionInfoControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo mockupValue = this.GetTestValue7();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.SessionInfo rpcResult = await rpcClient.GetSessions(mockupKey);
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams GetTestValue23()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.EnumExecutorParam GetTestValue24()
      {
      ...
      public async System.Threading.Tasks.Task TestSessionExecutorParams()
      {
         ...
         // Construct new RPC client to test with.
         ParaSessionInfoControllerClient rpcClient = new ParaSessionInfoControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams mockupValue = this.GetTestValue23();
         Substrate.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v6.executor_params.ExecutorParams rpcResult = await rpcClient.GetSessionExecutorParams(mockupKey);
