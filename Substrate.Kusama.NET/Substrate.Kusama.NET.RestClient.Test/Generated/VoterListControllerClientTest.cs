...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class VoterListControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node GetTestValue2()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node();
         result.Id = new Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Id = this.GetTestValue3();
         result.Prev = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Prev.Create(this.GetTestValue4());
         result.Next = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
      ...
      public async System.Threading.Tasks.Task TestListNodes()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node mockupValue = this.GetTestValue2();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Node rpcResult = await rpcClient.GetListNodes(mockupKey);
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag GetTestValue9()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag();
         result.Head = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Head.Create(this.GetTestValue10());
         result.Tail = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
      ...
      public async System.Threading.Tasks.Task TestListBags()
      {
         ...
         // Construct new RPC client to test with.
         VoterListControllerClient rpcClient = new VoterListControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag mockupValue = this.GetTestValue9();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_bags_list.list.Bag rpcResult = await rpcClient.GetListBags(mockupKey);
