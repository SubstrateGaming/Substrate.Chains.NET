...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
         ...
         result.Origin = new Substrate.Kusama.NET.NetApiExt.Generated.Model.kusama_runtime.EnumOriginCaller();
         result.Origin.Create(this.GetTestValueEnum<Substrate.Kusama.NET.NetApiExt.Generated.Model.kusama_runtime.OriginCaller>(), this.GetTestValue9());
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 mockupValue = this.GetTestValue3();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT26 rpcResult = await rpcClient.GetAgenda(mockupKey);
