...
namespace Substrate.Kusama.NET.RestClient.Test.Generated
{
   ...
   public class RegistrarControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id GetTestValue2()
      {
      ...
      public Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id GetTestValue3()
      {
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id result;
         result = new Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
         result.Value = this.GetTestValueU32();
      ...
      public async System.Threading.Tasks.Task TestPendingSwap()
      {
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id mockupValue = this.GetTestValue2();
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id mockupKey = this.GetTestValue3();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id rpcResult = await rpcClient.GetPendingSwap(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestNextFreeParaId()
      {
         ...
         // Construct new RPC client to test with.
         RegistrarControllerClient rpcClient = new RegistrarControllerClient(_httpClient, subscriptionClient);
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id mockupValue = this.GetTestValue9();
         ...
         Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id rpcResult = await rpcClient.GetNextFreeParaId();
