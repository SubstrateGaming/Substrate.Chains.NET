...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class BountiesControllerMockupClient : MockupBaseClient, IBountiesControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Bounties/BountyCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.BountiesStorage.BountyCountParams());
      }
