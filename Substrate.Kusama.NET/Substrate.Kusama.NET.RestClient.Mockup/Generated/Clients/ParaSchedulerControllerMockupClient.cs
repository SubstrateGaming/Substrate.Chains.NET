...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParaSchedulerControllerMockupClient : MockupBaseClient, IParaSchedulerControllerMockupClient
   {
      ...
      public async Task<bool> SetValidatorGroups(BaseVec<BaseVec<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>> value)
      {
      ...
      public async Task<bool> SetAvailabilityCores(BaseVec<BaseOpt<Substrate.Kusama.NET.NetApiExt.Generated.Model.polkadot_primitives.v2.EnumCoreOccupied>> value)
      {
