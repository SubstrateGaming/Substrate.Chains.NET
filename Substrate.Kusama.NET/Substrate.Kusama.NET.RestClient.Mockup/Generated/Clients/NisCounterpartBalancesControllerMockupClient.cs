...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class NisCounterpartBalancesControllerMockupClient : MockupBaseClient, INisCounterpartBalancesControllerMockupClient
   {
      ...
      public async Task<bool> SetReserves(BoundedVecT39 value, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
      ...
      public async Task<bool> SetFreezes(BoundedVecT40 value, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
