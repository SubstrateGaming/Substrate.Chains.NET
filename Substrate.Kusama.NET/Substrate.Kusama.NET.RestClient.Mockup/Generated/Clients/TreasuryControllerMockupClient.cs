...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TreasuryControllerMockupClient : MockupBaseClient, ITreasuryControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/ProposalCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalCountParams());
      }
      public async Task<bool> SetProposals(Proposal value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/Proposals", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.TreasuryStorage.ProposalsParams(key));
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/SpendCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendCountParams());
      }
      public async Task<bool> SetSpends(SpendStatus value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/Spends", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
   }
}
