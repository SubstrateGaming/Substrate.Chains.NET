...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class BeefyControllerMockupClient : MockupBaseClient, IBeefyControllerMockupClient
   {
      ...
      public async Task<bool> SetAuthorities(BoundedVecT17 value)
      {
      ...
      public async Task<bool> SetNextAuthorities(BoundedVecT17 value)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Beefy/SetIdSession", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.BeefyStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SetGenesisBlock(BaseOpt<U32> value)
      {
         return await SendMockupRequestAsync(_httpClient, "Beefy/GenesisBlock", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.BeefyStorage.GenesisBlockParams());
      }
   }
}
