...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ChildBountiesControllerMockupClient : MockupBaseClient, IChildBountiesControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ChildBounties/ChildBountyCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.ChildBountiesStorage.ChildBountyCountParams());
      }
      public async Task<bool> SetParentChildBounties(U32 value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "ChildBounties/ParentChildBounties", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.ChildBountiesStorage.ParentChildBountiesParams(key));
      }
      ...
      public async Task<bool> SetChildBountyDescriptions(BoundedVecT31 value, U32 key)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ChildBounties/ChildrenCuratorFees", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.ChildBountiesStorage.ChildrenCuratorFeesParams(key));
      }
   }
}
