...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class FellowshipCollectiveControllerMockupClient : MockupBaseClient, IFellowshipCollectiveControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "FellowshipCollective/MemberCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage.MemberCountParams(key));
      }
      public async Task<bool> SetMembers(MemberRecord value, AccountId32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "FellowshipCollective/Members", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage.MembersParams(key));
      }
      public async Task<bool> SetIdToIndex(U32 value, Substrate.NetApi.Model.Types.Base.BaseTuple<U16, AccountId32> key)
      {
         return await SendMockupRequestAsync(_httpClient, "FellowshipCollective/IdToIndex", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage.IdToIndexParams(key));
      }
      public async Task<bool> SetIndexToId(AccountId32 value, Substrate.NetApi.Model.Types.Base.BaseTuple<U16, U32> key)
      {
         return await SendMockupRequestAsync(_httpClient, "FellowshipCollective/IndexToId", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.FellowshipCollectiveStorage.IndexToIdParams(key));
      }
      ...
      public async Task<bool> SetVotingCleanup(BoundedVecT22 value, U32 key)
      {
