...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class FellowshipReferendaControllerMockupClient : MockupBaseClient, IFellowshipReferendaControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "FellowshipReferenda/ReferendumCount", value.Encode(), Substrate.Kusama.NET.NetApiExt.Generated.Storage.FellowshipReferendaStorage.ReferendumCountParams());
      }
