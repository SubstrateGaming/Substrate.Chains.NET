...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IOffencesControllerMockupClient
   {
      ...
      Task<bool> SetConcurrentReportsIndex(BaseVec<H256> value, BaseTuple<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr16U8, BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key);
   }
}
