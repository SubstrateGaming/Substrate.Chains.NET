...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IOffencesControllerMockupClient
   {
      ...
      Task<bool> SetConcurrentReportsIndex(BaseVec<H256> value, BaseTuple<Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr16U8, BaseVec<U8>> key);
      Task<bool> SetReportsByKindIndex(BaseVec<U8> value, Substrate.Kusama.NET.NetApiExt.Generated.Types.Base.Arr16U8 key);
   }
}
