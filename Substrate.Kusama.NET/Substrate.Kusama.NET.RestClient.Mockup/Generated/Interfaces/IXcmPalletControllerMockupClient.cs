...
namespace Substrate.Kusama.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IXcmPalletControllerMockupClient
   {
      ...
      Task<bool> SetVersionDiscoveryQueue(BoundedVecT48 value);
      ...
      Task<bool> SetLockedFungibles(BoundedVecT50 value, Substrate.Kusama.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
