...
namespace Substrate.Statemine.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Uncles"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        ...
        ///  Uncles
        /// </summary>
        public async Task<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> Uncles(CancellationToken token)
        {
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
    ...
    public sealed class AuthorshipCalls
    {
        ...
        /// </summary>
        public static Method SetUncles(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_runtime.generic.header.Header> new_uncles)
        {
