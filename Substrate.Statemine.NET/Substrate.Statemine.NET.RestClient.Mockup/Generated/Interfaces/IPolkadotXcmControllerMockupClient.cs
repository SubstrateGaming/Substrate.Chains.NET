...
namespace Substrate.Statemine.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerMockupClient
   {
      ...
      Task<bool> SetAssetTraps(U32 value, Substrate.Statemine.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      ...
      Task<bool> SetVersionNotifyTargets(BaseTuple<U64, U64, U32> value, BaseTuple<U32, Substrate.Statemine.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
