...
namespace Substrate.Statemine.NET.RestService.Generated.Storage
{
    ...
    public interface IAuthorshipStorage : IStorage
    {
        ...
        ///  Uncles
        /// </summary>
        Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 GetUncles();
        
        /// <summary>
        /// >> Author
        ///  Author of current block.
        /// </summary>
        Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor();
    ...
    public sealed class AuthorshipStorage : IAuthorshipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> _unclesTypedStorage;
        
        /// <summary>
        /// _authorTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _authorTypedStorage;
        ...
        {
            this.UnclesTypedStorage = new TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5>("Authorship.Uncles", storageDataProvider, storageChangeDelegates);
            this.AuthorTypedStorage = new TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Authorship.Author", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> UnclesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> AuthorTypedStorage
        {
            get
            {
        ...
        ///  Uncles
        /// </summary>
        public Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 GetUncles()
        {
        ...
        ///  Author of current block.
        /// </summary>
        public Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAuthor()
        {
