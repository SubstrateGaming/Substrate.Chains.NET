...
namespace Substrate.Statemine.NET.RestClient.Generated.Interfaces
{
   ...
   public interface INftsControllerClient
   {
      ...
      Task<BaseTuple> GetCollectionAccount(BaseTuple<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      Task<bool> SubscribeCollectionAccount(BaseTuple<Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      Task<BitFlagsT3> GetCollectionRoleOf(BaseTuple<U32, Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key);
      Task<bool> SubscribeCollectionRoleOf(BaseTuple<U32, Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key);
