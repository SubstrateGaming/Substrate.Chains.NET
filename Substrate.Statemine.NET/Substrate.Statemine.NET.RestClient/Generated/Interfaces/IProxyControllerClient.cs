...
namespace Substrate.Statemine.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BaseTuple<BoundedVecT18, U128>> GetProxies(Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeProxies(Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<BaseTuple<BoundedVecT19, U128>> GetAnnouncements(Substrate.Statemine.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
