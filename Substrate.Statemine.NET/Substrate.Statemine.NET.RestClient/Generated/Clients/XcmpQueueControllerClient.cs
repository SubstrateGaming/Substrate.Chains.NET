...
namespace Substrate.Statemine.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmpQueueControllerClient : BaseClient, IXcmpQueueControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/inboundxcmpmessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeInboundXcmpMessages(BaseTuple<Id, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.InboundXcmpMessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/outboundxcmpmessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OutboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeOutboundXcmpMessages(BaseTuple<Id, U16> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.OutboundXcmpMessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OutboundXcmpMessagesParams(key));
      }
      public async Task<BaseVec<U8>> GetSignalMessages(Id key)
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/signalmessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.SignalMessagesParams(key));
      }
      public async Task<bool> SubscribeSignalMessages(Id key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.SignalMessages", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.SignalMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Id, U32, BaseVec<U8>>>(_httpClient, "xcmpqueue/overweight", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
      public async Task<bool> SubscribeOverweight(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.Overweight", Substrate.Statemine.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
