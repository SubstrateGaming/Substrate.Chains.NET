...
namespace Substrate.HydraDX.NET.RestService.Generated.Controller
{
    ...
    public sealed class DemocracyController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "PublicPropCountParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "ReferendumCountParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "LowestUnbakedParams")]
        ...
        [ProducesResponseType(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumReferendumInfo), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "ReferendumInfoOfParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        /// </summary>
        [HttpGet("VotingOf")]
        [ProducesResponseType(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_democracy.vote.EnumVoting), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "VotingOfParams", typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "LastTabledWasExternalParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded, Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_democracy.vote_threshold.EnumVoteThreshold>), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "NextExternalParams")]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.Bool), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "CancellationsParams", typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256))]
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DemocracyStorage), "MetadataOfParams", typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_democracy.types.EnumMetadataOwner))]
