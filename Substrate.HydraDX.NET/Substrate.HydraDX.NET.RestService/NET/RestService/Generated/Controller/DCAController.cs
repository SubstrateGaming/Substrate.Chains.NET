...
namespace Substrate.HydraDX.NET.RestService.Generated.Controller
{
    ...
    public sealed class DCAController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DCAStorage), "ScheduleIdSequencerParams")]
        ...
        /// </summary>
        [HttpGet("Schedules")]
        [ProducesResponseType(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule), 200)]
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DCAStorage), "SchedulesParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DCAStorage), "ScheduleOwnershipParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>))]
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DCAStorage), "RemainingAmountsParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Storage.DCAStorage), "RetriesOnErrorParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
