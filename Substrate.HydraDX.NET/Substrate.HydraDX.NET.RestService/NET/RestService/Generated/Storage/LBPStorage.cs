...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public interface ILBPStorage : IStorage
    {
        ...
        ///  Details of a pool.
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool GetPoolData(string key);
    ...
    public sealed class LBPStorage : ILBPStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool> _poolDataTypedStorage;
        ...
        {
            this.PoolDataTypedStorage = new TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool>("LBP.PoolData", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool> PoolDataTypedStorage
        {
            get
            {
        ...
        ///  Details of a pool.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool GetPoolData(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PoolDataTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_lbp.Pool result))
            {
                return result;
            }
            else
