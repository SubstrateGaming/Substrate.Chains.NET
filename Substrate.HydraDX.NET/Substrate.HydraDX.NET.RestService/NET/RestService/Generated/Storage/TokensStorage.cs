...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public interface ITokensStorage : IStorage
    {
        ...
        ///  balances.
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.orml_tokens.AccountData GetAccounts(string key);
    ...
    public sealed class TokensStorage : ITokensStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.orml_tokens.AccountData> _accountsTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.orml_tokens.AccountData> AccountsTypedStorage
        {
            get
            {
        ...
        ///  balances.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.orml_tokens.AccountData GetAccounts(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountsTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.orml_tokens.AccountData result))
            {
                return result;
            }
            else
