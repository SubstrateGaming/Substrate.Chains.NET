...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT45>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
