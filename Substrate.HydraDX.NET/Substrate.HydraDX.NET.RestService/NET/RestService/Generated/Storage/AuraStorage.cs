...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public interface IAuraStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot();
    }
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> _currentSlotTypedStorage;
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT49>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
            this.CurrentSlotTypedStorage = new TypedStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot>("Aura.CurrentSlot", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlotTypedStorage
        {
            get
            {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot()
        {
