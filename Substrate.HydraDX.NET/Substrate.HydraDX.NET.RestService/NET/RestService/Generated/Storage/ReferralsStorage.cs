...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public interface IReferralsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetReferralCodes(string key);
        ...
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetLinkedAccounts(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128> GetReferrer(string key);
        ...
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution GetAssetRewards(string key);
    ...
    public sealed class ReferralsStorage : IReferralsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _referralCodesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _linkedAccountsTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128>> _referrerTypedStorage;
        
        /// <summary>
        /// _assetRewardsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution> _assetRewardsTypedStorage;
        ...
        public ReferralsStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ReferrerTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128>>("Referrals.Referrer", storageDataProvider, storageChangeDelegates);
            this.AssetRewardsTypedStorage = new TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution>("Referrals.AssetRewards", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> ReferralCodesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> LinkedAccountsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128>> ReferrerTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution> AssetRewardsTypedStorage
        {
            get
            {
        ...
        ///  Maps a referral code to an account.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetReferralCodes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferralCodesTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
        ...
        ///  Maps an account to a referral account.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetLinkedAccounts(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LinkedAccountsTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
        ...
        ///  Dev note: we use OptionQuery here because this helps to easily determine that an account if referrer account.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128> GetReferrer(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReferrerTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.NetApi.Model.Types.Primitive.U128> result))
            {
                return result;
            }
            else
        ...
        ///  Maps (asset_id, level) to asset reward percentages.
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution GetAssetRewards(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetRewardsTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution result))
            {
                return result;
            }
            else
