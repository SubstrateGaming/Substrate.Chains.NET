...
namespace Substrate.HydraDX.NET.RestService.Generated.Storage
{
    ...
    public interface IEVMStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata GetAccountCodesMetadata(string key);
        
        /// <summary>
        /// >> AccountStorages
        /// </summary>
        Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key);
    ...
    public sealed class EVMStorage : IEVMStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata> _accountCodesMetadataTypedStorage;
        
        /// <summary>
        /// _accountStoragesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256> _accountStoragesTypedStorage;
        ...
        public EVMStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountCodesMetadataTypedStorage = new TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata>("EVM.AccountCodesMetadata", storageDataProvider, storageChangeDelegates);
            this.AccountStoragesTypedStorage = new TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256>("EVM.AccountStorages", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata> AccountCodesMetadataTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256> AccountStoragesTypedStorage
        {
            get
            {
        ...
        /// >> AccountCodesMetadata
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata GetAccountCodesMetadata(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountCodesMetadataTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata result))
            {
                return result;
            }
            else
        ...
        /// >> AccountStorages
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountStoragesTypedStorage.Dictionary.TryGetValue(key, out Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
