...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_traits.router
{
    
    
    /// <summary>
    /// >> 150 - Composite[hydradx_traits.router.Trade]
    /// </summary>
    ...
    public sealed class Trade : BaseType
    {
        ...
        /// >> pool
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_traits.router.EnumPoolType Pool { get; set; }
        /// <summary>
        /// >> asset_in
        /// </summary>
        ...
        {
            var start = p;
            Pool = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_traits.router.EnumPoolType();
