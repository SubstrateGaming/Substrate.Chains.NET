...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.polkadot_primitives.v5
{
    
    
    /// <summary>
    /// >> 369 - Composite[polkadot_primitives.v5.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        /// >> parent_head
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HeadData ParentHead { get; set; }
        /// <summary>
        /// >> relay_parent_number
        /// </summary>
        ...
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 RelayParentStorageRoot { get; set; }
        /// <summary>
        /// >> max_pov_size
        /// </summary>
        ...
        {
            var start = p;
            ParentHead = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.HeadData();
            ...
            RelayParentStorageRoot = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256();
