...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types
{
    
    
    /// <summary>
    /// >> 513 - Composite[pallet_liquidity_mining.types.YieldFarmDataT1]
    /// </summary>
    ...
    public sealed class YieldFarmDataT1 : BaseType
    {
        ...
        /// >> accumulated_rpvs
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 AccumulatedRpvs { get; set; }
        /// <summary>
        /// >> accumulated_rpz
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 AccumulatedRpz { get; set; }
        /// <summary>
        /// >> loyalty_curve
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.LoyaltyCurve> LoyaltyCurve { get; set; }
        /// <summary>
        /// >> multiplier
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 Multiplier { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.EnumFarmState State { get; set; }
        /// <summary>
        /// >> entries_count
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            AccumulatedRpvs = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            AccumulatedRpvs.Decode(byteArray, ref p);
            AccumulatedRpz = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            AccumulatedRpz.Decode(byteArray, ref p);
            LoyaltyCurve = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.LoyaltyCurve>();
            LoyaltyCurve.Decode(byteArray, ref p);
            Multiplier = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            Multiplier.Decode(byteArray, ref p);
            State = new Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.EnumFarmState();
