...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.cumulus_primitives_parachain_inherent
{
    ...
    public sealed class ParachainInherentData : BaseType
    {
        ...
        /// >> relay_chain_state
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_trie.storage_proof.StorageProof RelayChainState { get; set; }
        /// <summary>
        /// >> downward_messages
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage> DownwardMessages { get; set; }
        /// <summary>
        /// >> horizontal_messages
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.BTreeMapT1 HorizontalMessages { get; set; }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            DownwardMessages = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.polkadot_core_primitives.InboundDownwardMessage>();
            DownwardMessages.Decode(byteArray, ref p);
            HorizontalMessages = new Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.BTreeMapT1();
