...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.xcm.v2.multiasset
{
    ...
    /// <summary>
    /// >> 203 - Variant[xcm.v2.multiasset.AssetId]
    /// </summary>
    public sealed class EnumAssetId : BaseEnumRust<AssetId>
    {
        ...
        public EnumAssetId()
        {
				AddTypeDecoder<Substrate.HydraDX.NET.NetApiExt.Generated.Model.xcm.v2.multilocation.MultiLocation>(AssetId.Concrete);
