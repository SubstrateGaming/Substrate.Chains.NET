...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.xcm.v2.multiasset
{
    ...
    /// <summary>
    /// >> 211 - Variant[xcm.v2.multiasset.Fungibility]
    /// </summary>
    public sealed class EnumFungibility : BaseEnumRust<Fungibility>
    {
        ...
        public EnumFungibility()
        {
				...
				AddTypeDecoder<Substrate.HydraDX.NET.NetApiExt.Generated.Model.xcm.v2.multiasset.EnumAssetInstance>(Fungibility.NonFungible);
        }
    }
}
