...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.xcm.v2
{
    ...
    public sealed class EnumBodyId : BaseEnumRust<BodyId>
    {
        ...
        public EnumBodyId()
        {
				...
				AddTypeDecoder<Substrate.HydraDX.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1>(BodyId.Named);
