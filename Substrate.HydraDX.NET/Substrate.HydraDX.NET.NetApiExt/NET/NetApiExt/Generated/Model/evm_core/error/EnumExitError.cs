...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Model.evm_core.error
{
    ...
    public sealed class EnumExitError : BaseEnumRust<ExitError>
    {
        ...
        public EnumExitError()
        {
				...
				AddTypeDecoder<Substrate.HydraDX.NET.NetApiExt.Generated.Model.evm_core.opcode.Opcode>(ExitError.InvalidCode);
				...
				AddTypeDecoder<Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.CowT1>(ExitError.Other);
