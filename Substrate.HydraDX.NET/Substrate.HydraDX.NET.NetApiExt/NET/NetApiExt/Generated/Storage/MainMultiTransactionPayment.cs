...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class MultiTransactionPaymentStorage
    {
        ...
        public MultiTransactionPaymentStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("MultiTransactionPayment", "AccountCurrencyMap"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("MultiTransactionPayment", "AcceptedCurrencies"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
        ...
        /// </summary>
        public static string AccountCurrencyMapParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Account currency map
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AccountCurrencyMap(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Curated list of currencies which fees can be paid mapped to corresponding fallback price
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> AcceptedCurrencies(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Asset prices from the spot price provider or the fallback price if the price is not available. Updated at the beginning of every block.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> AcceptedCurrencyPrice(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string TransactionCurrencyOverrideParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> TransactionCurrencyOverride(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class MultiTransactionPaymentCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddCurrency(Substrate.NetApi.Model.Types.Primitive.U32 currency, Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 price)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(currency.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ResetPaymentCurrency(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 account_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DispatchPermit(Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H160 from, Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H160 to, Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.U256 value, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> data, Substrate.NetApi.Model.Types.Primitive.U64 gas_limit, Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.U256 deadline, Substrate.NetApi.Model.Types.Primitive.U8 v, Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 r, Substrate.HydraDX.NET.NetApiExt.Generated.Model.primitive_types.H256 s)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
