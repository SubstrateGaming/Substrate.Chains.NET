...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetRegistryStorage
    {
        ...
        public AssetRegistryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "LocationAssets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  Details of an asset.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.AssetDetails> Assets(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.AssetsParams(key);
            var result = await _client.GetStorageAsync<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.AssetDetails>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Native location of an asset.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation> AssetLocations(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.AssetLocationsParams(key);
            var result = await _client.GetStorageAsync<Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LocationAssetsParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation key)
        {
        ...
        ///  Local asset for native location.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LocationAssets(Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AssetRegistryCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RegisterExternal(Substrate.HydraDX.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
