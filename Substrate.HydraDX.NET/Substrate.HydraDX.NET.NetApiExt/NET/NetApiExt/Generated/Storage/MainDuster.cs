...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class DusterStorage
    {
        ...
        public DusterStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Duster", "AccountBlacklist"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Duster", "RewardAccount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Duster", "DustAccount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        /// </summary>
        public static string AccountBlacklistParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Accounts excluded from dusting.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> AccountBlacklist(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Account to take reward from.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> RewardAccount(string blockhash, CancellationToken token)
        {
        ...
        ///  Account to send dust to.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> DustAccount(string blockhash, CancellationToken token)
        {
    ...
    public sealed class DusterCalls
    {
        ...
        /// </summary>
        public static Method DustAccount(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 account, Substrate.NetApi.Model.Types.Primitive.U32 currency_id)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddNondustableAccount(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(account.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveNondustableAccount(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(account.Encode());
