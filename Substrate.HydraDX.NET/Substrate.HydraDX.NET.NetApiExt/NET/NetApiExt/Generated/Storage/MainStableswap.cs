...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StableswapStorage
    {
        ...
        public StableswapStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Stableswap", "Pools"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Stableswap", "AssetTradability"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability)));
        }
        ...
        ///  Existing pools
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo> Pools(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = StableswapStorage.PoolsParams(key);
            var result = await _client.GetStorageAsync<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Tradability state of pool assets.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability> AssetTradability(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = StableswapStorage.AssetTradabilityParams(key);
            var result = await _client.GetStorageAsync<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class StableswapCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.NetApi.Model.Types.Primitive.U32 share_asset, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U32> assets, Substrate.NetApi.Model.Types.Primitive.U16 amplification, Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill fee)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdatePoolFee(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill fee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddLiquidity(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.AssetAmount> assets)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(assets.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAssetTradableState(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Primitive.U32 asset_id, Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(asset_id.Encode());
    ...
    public sealed class StableswapConstants
    {
        ...
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.RangeInclusive AmplificationRange()
        {
            var result = new Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.RangeInclusive();
