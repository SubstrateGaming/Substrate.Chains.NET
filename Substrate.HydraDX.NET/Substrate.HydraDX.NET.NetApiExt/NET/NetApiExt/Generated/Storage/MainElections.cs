...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ElectionsStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Elections", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.SeatHolder>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Elections", "RunnersUp"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.SeatHolder>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Elections", "Candidates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Elections", "Voting"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.Voter)));
        }
        ...
        ///  Invariant: Always sorted based on account id.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.SeatHolder>> Members(string blockhash, CancellationToken token)
        {
            string parameters = ElectionsStorage.MembersParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.SeatHolder>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  last (i.e. _best_) runner-up will be replaced.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.SeatHolder>> RunnersUp(string blockhash, CancellationToken token)
        {
        ...
        ///  Invariant: Always sorted based on account id.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>> Candidates(string blockhash, CancellationToken token)
        {
            string parameters = ElectionsStorage.CandidatesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE as `AccountId` is a crypto hash.
        /// </summary>
        public async Task<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.Voter> Voting(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = ElectionsStorage.VotingParams(key);
            var result = await _client.GetStorageAsync<Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.Voter>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class ElectionsCalls
    {
        ...
        /// </summary>
        public static Method Vote(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> votes, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> value)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RenounceCandidacy(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_elections_phragmen.EnumRenouncing renouncing)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveMember(Substrate.HydraDX.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who, Substrate.NetApi.Model.Types.Primitive.Bool slash_bond, Substrate.NetApi.Model.Types.Primitive.Bool rerun_election)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class ElectionsConstants
    {
        ...
        /// </summary>
        public Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.Arr8U8 PalletId()
        {
            var result = new Substrate.HydraDX.NET.NetApiExt.Generated.Types.Base.Arr8U8();
