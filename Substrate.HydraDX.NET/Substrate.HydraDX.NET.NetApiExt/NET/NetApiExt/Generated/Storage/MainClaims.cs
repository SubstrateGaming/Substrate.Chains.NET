...
namespace Substrate.HydraDX.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ClaimsStorage
    {
        ...
        public ClaimsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Claims", "Claims"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_claims.traits.EthereumAddress), typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
        }
        ...
        /// </summary>
        public static string ClaimsParams(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_claims.traits.EthereumAddress key)
        {
        ...
        ///  Asset id storage for each shared token
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Claims(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_claims.traits.EthereumAddress key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class ClaimsCalls
    {
        ...
        /// </summary>
        public static Method Claim(Substrate.HydraDX.NET.NetApiExt.Generated.Model.pallet_claims.traits.EcdsaSignature ethereum_signature)
        {
