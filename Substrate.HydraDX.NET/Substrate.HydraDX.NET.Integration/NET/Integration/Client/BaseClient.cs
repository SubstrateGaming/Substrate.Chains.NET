...
using Serilog;
using StreamJsonRpc;
using Substrate.HydraDX.NET.NetApiExt.Generated;
using Substrate.HydraDX.NET.NetApiExt.Generated.Model.frame_system;
using Substrate.HydraDX.NET.NetApiExt.Generated.Storage;
using Substrate.HydraDX.NET.Integration.Helper;
...
namespace Substrate.HydraDX.NET.Integration.Client
{
    /// <summary>
    /// Base client
    /// </summary>
