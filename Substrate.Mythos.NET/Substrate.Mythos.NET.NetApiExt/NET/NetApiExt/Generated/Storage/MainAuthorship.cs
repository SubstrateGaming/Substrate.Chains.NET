...
namespace Substrate.Mythos.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Mythos.NET.NetApiExt.Generated.Model.account.AccountId20)));
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Mythos.NET.NetApiExt.Generated.Model.account.AccountId20> Author(string blockhash, CancellationToken token)
        {
