...
namespace Substrate.Mythos.NET.NetApiExt.Generated.Model.pallet_nfts.types
{
    ...
    public sealed class ItemDeposit : BaseType
    {
        ...
        /// >> account
        /// </summary>
        public Substrate.Mythos.NET.NetApiExt.Generated.Model.account.AccountId20 Account { get; set; }
        /// <summary>
        /// >> amount
        /// </summary>
        ...
        {
            var start = p;
            Account = new Substrate.Mythos.NET.NetApiExt.Generated.Model.account.AccountId20();
