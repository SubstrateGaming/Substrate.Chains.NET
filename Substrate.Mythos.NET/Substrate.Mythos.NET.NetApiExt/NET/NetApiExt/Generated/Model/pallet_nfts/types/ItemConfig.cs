...
namespace Substrate.Mythos.NET.NetApiExt.Generated.Model.pallet_nfts.types
{
    ...
    public sealed class ItemConfig : BaseType
    {
        ...
        /// >> settings
        /// </summary>
        public Substrate.Mythos.NET.NetApiExt.Generated.Model.pallet_nfts.types.BitFlagsT2 Settings { get; set; }
        ...
        {
            var start = p;
            Settings = new Substrate.Mythos.NET.NetApiExt.Generated.Model.pallet_nfts.types.BitFlagsT2();
