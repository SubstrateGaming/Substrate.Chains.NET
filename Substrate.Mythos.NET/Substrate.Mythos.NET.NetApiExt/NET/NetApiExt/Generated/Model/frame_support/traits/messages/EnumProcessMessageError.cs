...
namespace Substrate.Mythos.NET.NetApiExt.Generated.Model.frame_support.traits.messages
{
    ...
    public sealed class EnumProcessMessageError : BaseEnumRust<ProcessMessageError>
    {
        ...
        public EnumProcessMessageError()
        {
				...
				AddTypeDecoder<Substrate.Mythos.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight>(ProcessMessageError.Overweight);
