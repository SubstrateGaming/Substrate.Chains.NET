...
namespace Substrate.Mythos.NET.NetApiExt.Generated.Model.cumulus_primitives_core
{
    ...
    public sealed class EnumAggregateMessageOrigin : BaseEnumRust<AggregateMessageOrigin>
    {
        ...
        public EnumAggregateMessageOrigin()
        {
				...
				AddTypeDecoder<Substrate.Mythos.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id>(AggregateMessageOrigin.Sibling);
        }
    }
}
