...
namespace Substrate.Mythos.NET.RestService.Generated.Controller
{
    ...
    public sealed class SchedulerController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Storage.SchedulerStorage), "IncompleteSinceParams")]
        ...
        /// </summary>
        [HttpGet("Agenda")]
        [ProducesResponseType(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18), 200)]
        [StorageKeyBuilder(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Storage.SchedulerStorage), "AgendaParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        /// </summary>
        [HttpGet("Retries")]
        [ProducesResponseType(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig), 200)]
        [StorageKeyBuilder(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Storage.SchedulerStorage), "RetriesParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Mythos.NET.NetApiExt.Generated.Storage.SchedulerStorage), "LookupParams", typeof(Substrate.Mythos.NET.NetApiExt.Generated.Types.Base.Arr32U8))]
