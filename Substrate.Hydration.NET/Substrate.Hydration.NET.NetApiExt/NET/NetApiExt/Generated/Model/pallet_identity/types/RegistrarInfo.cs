...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> account
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Account { get; set; }
        /// <summary>
        /// >> fee
        /// </summary>
        ...
        {
            var start = p;
            Account = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
