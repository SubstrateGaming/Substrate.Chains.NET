...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_omnipool_liquidity_mining.pallet
{
    ...
    public sealed class EnumError : BaseEnumRust<Error>
    {
        ...
        public EnumError()
        {
				...
				AddTypeDecoder<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_omnipool_liquidity_mining.pallet.EnumInconsistentStateError>(Error.InconsistentState);
