...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types
{
    ...
    public sealed class AssetDetails : BaseType
    {
        ...
        /// >> name
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> Name { get; set; }
        /// <summary>
        /// >> asset_type
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.EnumAssetType AssetType { get; set; }
        /// <summary>
        /// >> existential_deposit
        /// </summary>
        ...
        /// >> symbol
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> Symbol { get; set; }
        /// <summary>
        /// >> decimals
        /// </summary>
        ...
        {
            var start = p;
            Name = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7>();
            Name.Decode(byteArray, ref p);
            AssetType = new Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.EnumAssetType();
            ...
            Symbol = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7>();
