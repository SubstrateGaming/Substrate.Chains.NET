...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_referrals.pallet
{
    ...
    public sealed class EnumCall : BaseEnumRust<Call>
    {
        ...
        public EnumCall()
        {
				AddTypeDecoder<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14>(Call.register_code);
				AddTypeDecoder<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14>(Call.link_code);
				AddTypeDecoder<Substrate.NetApi.Model.Types.Primitive.U32>(Call.convert);
				AddTypeDecoder<BaseVoid>(Call.claim_rewards);
				AddTypeDecoder<BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_referrals.EnumLevel, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_referrals.FeeDistribution>>(Call.set_reward_percentage);
        }
    }
}
