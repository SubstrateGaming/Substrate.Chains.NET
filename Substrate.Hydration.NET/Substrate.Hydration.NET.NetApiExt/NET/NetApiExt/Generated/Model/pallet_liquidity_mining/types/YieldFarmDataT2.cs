...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types
{
    ...
    public sealed class YieldFarmDataT2 : BaseType
    {
        ...
        /// >> accumulated_rpvs
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 AccumulatedRpvs { get; set; }
        /// <summary>
        /// >> accumulated_rpz
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 AccumulatedRpz { get; set; }
        /// <summary>
        /// >> loyalty_curve
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.LoyaltyCurve> LoyaltyCurve { get; set; }
        /// <summary>
        /// >> multiplier
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 Multiplier { get; set; }
        /// <summary>
        /// >> state
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.EnumFarmState State { get; set; }
        /// <summary>
        /// >> entries_count
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            AccumulatedRpvs = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            AccumulatedRpvs.Decode(byteArray, ref p);
            AccumulatedRpz = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            AccumulatedRpz.Decode(byteArray, ref p);
            LoyaltyCurve = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.LoyaltyCurve>();
            LoyaltyCurve.Decode(byteArray, ref p);
            Multiplier = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128();
            Multiplier.Decode(byteArray, ref p);
            State = new Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.EnumFarmState();
