...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Model.frame_system
{
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.Hydration.NET.NetApiExt.Generated.Model.primitive_types.H256();
