...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class XYKLiquidityMiningCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateGlobalFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 price_adjustment)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreateYieldFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 multiplier, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.LoyaltyCurve> loyalty_curve)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdateYieldFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 multiplier)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
            byteArray.AddRange(asset_pair.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method StopYieldFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
            byteArray.AddRange(asset_pair.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ResumeYieldFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.NetApi.Model.Types.Primitive.U32 yield_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 multiplier)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TerminateYieldFarm(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.NetApi.Model.Types.Primitive.U32 yield_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
            byteArray.AddRange(yield_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method DepositShares(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.NetApi.Model.Types.Primitive.U32 yield_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.NetApi.Model.Types.Primitive.U128 shares_amount)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
            byteArray.AddRange(yield_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method JoinFarms(Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15 farm_entries, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.NetApi.Model.Types.Primitive.U128 shares_amount)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RedepositShares(Substrate.NetApi.Model.Types.Primitive.U32 global_farm_id, Substrate.NetApi.Model.Types.Primitive.U32 yield_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.NetApi.Model.Types.Primitive.U128 deposit_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(global_farm_id.Encode());
            byteArray.AddRange(yield_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method WithdrawShares(Substrate.NetApi.Model.Types.Primitive.U128 deposit_id, Substrate.NetApi.Model.Types.Primitive.U32 yield_farm_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(deposit_id.Encode());
            byteArray.AddRange(yield_farm_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ExitFarms(Substrate.NetApi.Model.Types.Primitive.U128 deposit_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_xyk.types.AssetPair asset_pair, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 farm_entries)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(deposit_id.Encode());
            byteArray.AddRange(asset_pair.Encode());
