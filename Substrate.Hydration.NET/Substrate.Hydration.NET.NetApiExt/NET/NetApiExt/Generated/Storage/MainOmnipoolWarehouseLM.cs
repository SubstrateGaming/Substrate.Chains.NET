    ...
    public sealed class OmnipoolWarehouseLMStorage
    {
        ...
        public OmnipoolWarehouseLMStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("OmnipoolWarehouseLM", "GlobalFarm"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("OmnipoolWarehouseLM", "YieldFarm"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("OmnipoolWarehouseLM", "Deposit"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U128), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1)));
        ...
        /// >> GlobalFarm
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1> GlobalFarm(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = OmnipoolWarehouseLMStorage.GlobalFarmParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Yield farm details.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1> YieldFarm(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = OmnipoolWarehouseLMStorage.YieldFarmParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Deposit details.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1> Deposit(Substrate.NetApi.Model.Types.Primitive.U128 key, string blockhash, CancellationToken token)
        {
            string parameters = OmnipoolWarehouseLMStorage.DepositParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1>(parameters, blockhash, token);
            return result;
        }
