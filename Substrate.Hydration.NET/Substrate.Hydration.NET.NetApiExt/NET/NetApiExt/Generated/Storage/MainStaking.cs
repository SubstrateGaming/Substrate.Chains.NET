...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StakingStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Staking", "Staking"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.StakingData)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Staking", "Positions"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U128), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Position)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Staking", "Votes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U128), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Voting)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Staking", "VotesRewarded"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Vote)));
        ...
        ///  Global staking state.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.StakingData> Staking(string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.StakingParams();
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.StakingData>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  User's position state.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Position> Positions(Substrate.NetApi.Model.Types.Primitive.U128 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.PositionsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Position>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  List of position votes.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Voting> Votes(Substrate.NetApi.Model.Types.Primitive.U128 key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.VotesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Voting>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotesRewardedParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  List of processed vote. Used to determine if the vote should be locked in case of voting not in favor.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Vote> VotesRewarded(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = StakingStorage.VotesRewardedParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Vote>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Legacy storage! - Used to handle democracy votes until democracy pallet is fully removed.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Voting> PositionVotes(Substrate.NetApi.Model.Types.Primitive.U128 key, string blockhash, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ProcessedVotesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  Legacy storage! - Used to handle democracy processed votes until democracy pallet is fully removed.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_staking.types.Vote> ProcessedVotes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class StakingConstants
    {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill TimePointsWeight()
        {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill ActionPointsWeight()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
