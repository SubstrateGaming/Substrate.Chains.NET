...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetRegistryStorage
    {
        ...
        public AssetRegistryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "Assets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.AssetDetails)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "AssetIds"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "AssetLocations"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "LocationAssets"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  Details of an asset.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.AssetDetails> Assets(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.AssetsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.AssetDetails>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string AssetIdsParams(Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 key)
        {
        ...
        ///  Mapping between asset name and asset id.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AssetIds(Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Native location of an asset.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation> AssetLocations(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.AssetLocationsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LocationAssetsParams(Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation key)
        {
        ...
        ///  Local asset for native location.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LocationAssets(Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AssetRegistryCalls
    {
        ...
        /// </summary>
        public static Method Register(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> asset_id, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> name, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.EnumAssetType asset_type, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> existential_deposit, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> symbol, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U8> decimals, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation> location, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> xcm_rate_limit, Substrate.NetApi.Model.Types.Primitive.Bool is_sufficient)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Update(Substrate.NetApi.Model.Types.Primitive.U32 asset_id, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> name, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_asset_registry.types.EnumAssetType> asset_type, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> existential_deposit, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> xcm_rate_limit, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.Bool> is_sufficient, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT7> symbol, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U8> decimals, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation> location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_id.Encode());
            byteArray.AddRange(name.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RegisterExternal(Substrate.Hydration.NET.NetApiExt.Generated.Model.hydradx_runtime.xcm.AssetLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
