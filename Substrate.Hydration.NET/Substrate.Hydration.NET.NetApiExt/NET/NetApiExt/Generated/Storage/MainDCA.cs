...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class DCAStorage
    {
        ...
        public DCAStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DCA", "Schedules"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DCA", "ScheduleOwnership"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DCA", "ScheduleIdsPerBlock"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52)));
        }
        ...
        ///  Storing schedule details
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule> Schedules(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = DCAStorage.SchedulesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ScheduleOwnershipParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
        ...
        ///  Storing schedule ownership
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> ScheduleOwnership(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
        ...
        ///  Keep tracking of the schedule ids to be executed in the block
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52> ScheduleIdsPerBlock(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = DCAStorage.ScheduleIdsPerBlockParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class DCACalls
    {
        ...
        /// </summary>
        public static Method Schedule(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule schedule, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> start_execution_block)
        {
    ...
    public sealed class DCAConstants
    {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill MaxPriceDifferenceBetweenBlocks()
        {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill MaxConfigurablePriceDifferenceBetweenBlocks()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent BumpChance()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent();
            result.Create("0x11");
            return result;
        }
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 FeeReceiver()
        {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Types.Base.Arr8U8 NamedReserveId()
        {
