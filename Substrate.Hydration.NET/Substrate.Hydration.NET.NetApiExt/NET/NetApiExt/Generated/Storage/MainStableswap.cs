...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StableswapStorage
    {
        ...
        public StableswapStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Stableswap", "Pools"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Stableswap", "PoolPegs"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolPegInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Stableswap", "AssetTradability"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability)));
        }
        ...
        ///  Existing pools
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo> Pools(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = StableswapStorage.PoolsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Pool peg info.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolPegInfo> PoolPegs(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = StableswapStorage.PoolPegsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.PoolPegInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Tradability state of pool assets.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability> AssetTradability(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, string blockhash, CancellationToken token)
        {
            string parameters = StableswapStorage.AssetTradabilityParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class StableswapCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.NetApi.Model.Types.Primitive.U32 share_asset, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12 assets, Substrate.NetApi.Model.Types.Primitive.U16 amplification, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill fee)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method UpdatePoolFee(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill fee)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddLiquidity(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 assets)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(assets.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetAssetTradableState(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Primitive.U32 asset_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_stableswap.types.Tradability state)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(asset_id.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveLiquidity(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.NetApi.Model.Types.Primitive.U128 share_amount, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 min_amounts_out)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(share_amount.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method CreatePoolWithPegs(Substrate.NetApi.Model.Types.Primitive.U32 share_asset, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12 assets, Substrate.NetApi.Model.Types.Primitive.U16 amplification, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill fee, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT13 peg_source, Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill max_peg_update)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(share_asset.Encode());
            byteArray.AddRange(assets.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddAssetsLiquidity(Substrate.NetApi.Model.Types.Primitive.U32 pool_id, Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 assets, Substrate.NetApi.Model.Types.Primitive.U128 min_shares)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(pool_id.Encode());
            byteArray.AddRange(assets.Encode());
    ...
    public sealed class StableswapConstants
    {
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Types.Base.RangeInclusive AmplificationRange()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Types.Base.RangeInclusive();
