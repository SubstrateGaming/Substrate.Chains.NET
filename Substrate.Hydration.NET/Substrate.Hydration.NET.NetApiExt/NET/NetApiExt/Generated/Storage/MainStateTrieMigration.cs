...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class StateTrieMigrationStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("StateTrieMigration", "MigrationProcess"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationTask)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("StateTrieMigration", "AutoLimits"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("StateTrieMigration", "SignedMigrationMaxLimits"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits)));
        }
        ...
        ///  forward by any of the means provided by this pallet.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationTask> MigrationProcess(string blockhash, CancellationToken token)
        {
            string parameters = StateTrieMigrationStorage.MigrationProcessParams();
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationTask>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  If set to None, then no automatic migration happens.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits>> AutoLimits(string blockhash, CancellationToken token)
        {
            string parameters = StateTrieMigrationStorage.AutoLimitsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits>>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  If not set, no signed submission is allowed.
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits> SignedMigrationMaxLimits(string blockhash, CancellationToken token)
        {
            string parameters = StateTrieMigrationStorage.SignedMigrationMaxLimitsParams();
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class StateTrieMigrationCalls
    {
        ...
        /// </summary>
        public static Method ControlAutoMigration(Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits> maybe_config)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ContinueMigrate(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits limits, Substrate.NetApi.Model.Types.Primitive.U32 real_size_upper, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationTask witness_task)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method SetSignedMaxLimits(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.MigrationLimits limits)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(limits.Encode());
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceSetProgress(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.EnumProgress progress_top, Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_state_trie_migration.pallet.EnumProgress progress_child)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
