...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class DynamicFeesStorage
    {
        ...
        public DynamicFeesStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("DynamicFees", "AssetFee"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry)));
        }
        ...
        ///  Stored as (Asset fee, Protocol fee, Block number)
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry> AssetFee(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = DynamicFeesStorage.AssetFeeParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class DynamicFeesConstants
    {
        ...
        /// >> AssetFeeParameters
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeParams AssetFeeParameters()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeParams();
        ...
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeParams ProtocolFeeParameters()
        {
            var result = new Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeParams();
