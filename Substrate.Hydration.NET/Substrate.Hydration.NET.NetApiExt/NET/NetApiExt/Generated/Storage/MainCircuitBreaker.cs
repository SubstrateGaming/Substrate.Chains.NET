    ...
    public sealed class CircuitBreakerStorage
    {
        ...
        public CircuitBreakerStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CircuitBreaker", "AllowedTradeVolumeLimitPerAsset"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CircuitBreaker", "AllowedAddLiquidityAmountPerAsset"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit)));
        ...
        ///  Trade volumes per asset
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit> AllowedTradeVolumeLimitPerAsset(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = CircuitBreakerStorage.AllowedTradeVolumeLimitPerAssetParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Add liquidity volumes per asset
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> AllowedAddLiquidityAmountPerAsset(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = CircuitBreakerStorage.AllowedAddLiquidityAmountPerAssetParams(key);
            var result = await _client.GetStorageAsync<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Remove liquidity volumes per asset
        /// </summary>
        public async Task<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> AllowedRemoveLiquidityAmountPerAsset(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
