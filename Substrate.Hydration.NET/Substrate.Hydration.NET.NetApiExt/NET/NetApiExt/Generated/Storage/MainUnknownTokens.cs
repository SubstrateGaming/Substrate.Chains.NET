...
namespace Substrate.Hydration.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class UnknownTokensStorage
    {
        ...
        /// </summary>
        public static string ConcreteFungibleBalancesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> key)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> ConcreteFungibleBalances(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> key, string blockhash, CancellationToken token)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public static string AbstractFungibleBalancesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  double_map: who, asset_id => u128
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> AbstractFungibleBalances(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Hydration.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, string blockhash, CancellationToken token)
        {
