...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface IDusterStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetRewardAccount();
        
        /// <summary>
        /// >> DustAccount
        ///  Account to send dust to.
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetDustAccount();
    }
    ...
    public sealed class DusterStorage : IDusterStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _rewardAccountTypedStorage;
        
        /// <summary>
        /// _dustAccountTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _dustAccountTypedStorage;
        ...
        public DusterStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.RewardAccountTypedStorage = new TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Duster.RewardAccount", storageDataProvider, storageChangeDelegates);
            this.DustAccountTypedStorage = new TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Duster.DustAccount", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> RewardAccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> DustAccountTypedStorage
        {
            get
            {
        ...
        ///  Account to take reward from.
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetRewardAccount()
        {
        ...
        ///  Account to send dust to.
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetDustAccount()
        {
