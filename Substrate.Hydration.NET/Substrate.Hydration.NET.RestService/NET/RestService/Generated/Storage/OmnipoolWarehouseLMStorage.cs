...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface IOmnipoolWarehouseLMStorage : IStorage
    {
        ...
        /// >> GlobalFarm
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1 GetGlobalFarm(string key);
        
        /// <summary>
        /// >> YieldFarm
        ///  Yield farm details.
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1 GetYieldFarm(string key);
        
        /// <summary>
        /// >> Deposit
        ///  Deposit details.
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1 GetDeposit(string key);
    ...
    public sealed class OmnipoolWarehouseLMStorage : IOmnipoolWarehouseLMStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1> _globalFarmTypedStorage;
        
        /// <summary>
        /// _yieldFarmTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1> _yieldFarmTypedStorage;
        
        /// <summary>
        /// _depositTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1> _depositTypedStorage;
        ...
        public OmnipoolWarehouseLMStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.GlobalFarmTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1>("OmnipoolWarehouseLM.GlobalFarm", storageDataProvider, storageChangeDelegates);
            this.YieldFarmTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1>("OmnipoolWarehouseLM.YieldFarm", storageDataProvider, storageChangeDelegates);
            this.DepositTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1>("OmnipoolWarehouseLM.Deposit", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1> GlobalFarmTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1> YieldFarmTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1> DepositTypedStorage
        {
            get
            {
        ...
        /// >> GlobalFarm
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1 GetGlobalFarm(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (GlobalFarmTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.GlobalFarmDataT1 result))
            {
                return result;
            }
            else
        ...
        ///  Yield farm details.
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1 GetYieldFarm(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (YieldFarmTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.YieldFarmDataT1 result))
            {
                return result;
            }
            else
        ...
        ///  Deposit details.
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1 GetDeposit(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DepositTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_liquidity_mining.types.DepositDataT1 result))
            {
                return result;
            }
            else
