...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface IDynamicFeesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry GetAssetFee(string key);
    }
    ...
    public sealed class DynamicFeesStorage : IDynamicFeesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry> _assetFeeTypedStorage;
        ...
        {
            this.AssetFeeTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry>("DynamicFees.AssetFee", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _assetFeeTypedStorage property
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry> AssetFeeTypedStorage
        {
            get
            {
        ...
        ///  Stored as (Asset fee, Protocol fee, Block number)
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry GetAssetFee(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetFeeTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dynamic_fees.types.FeeEntry result))
            {
                return result;
            }
            else
