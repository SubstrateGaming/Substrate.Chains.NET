...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface ICircuitBreakerStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit GetAllowedTradeVolumeLimitPerAsset(string key);
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit GetAllowedAddLiquidityAmountPerAsset(string key);
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit GetAllowedRemoveLiquidityAmountPerAsset(string key);
    }
    ...
    public sealed class CircuitBreakerStorage : ICircuitBreakerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit> _allowedTradeVolumeLimitPerAssetTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> _allowedAddLiquidityAmountPerAssetTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> _allowedRemoveLiquidityAmountPerAssetTypedStorage;
        ...
        public CircuitBreakerStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AllowedTradeVolumeLimitPerAssetTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit>("CircuitBreaker.AllowedTradeVolumeLimitPerAsset", storageDataProvider, storageChangeDelegates);
            ...
            this.AllowedAddLiquidityAmountPerAssetTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit>("CircuitBreaker.AllowedAddLiquidityAmountPerAsset", storageDataProvider, storageChangeDelegates);
            ...
            this.AllowedRemoveLiquidityAmountPerAssetTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit>("CircuitBreaker.AllowedRemoveLiquidityAmountPerAsset", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit> AllowedTradeVolumeLimitPerAssetTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> AllowedAddLiquidityAmountPerAssetTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit> AllowedRemoveLiquidityAmountPerAssetTypedStorage
        {
            get
            {
        ...
        ///  Trade volumes per asset
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit GetAllowedTradeVolumeLimitPerAsset(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AllowedTradeVolumeLimitPerAssetTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.TradeVolumeLimit result))
            {
                return result;
            }
            else
        ...
        ///  Add liquidity volumes per asset
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit GetAllowedAddLiquidityAmountPerAsset(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AllowedAddLiquidityAmountPerAssetTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit result))
            {
                return result;
            }
            else
        ...
        ///  Remove liquidity volumes per asset
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit GetAllowedRemoveLiquidityAmountPerAsset(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AllowedRemoveLiquidityAmountPerAssetTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_circuit_breaker.LiquidityLimit result))
            {
                return result;
            }
            else
