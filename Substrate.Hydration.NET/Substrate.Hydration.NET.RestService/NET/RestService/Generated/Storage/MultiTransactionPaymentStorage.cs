...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface IMultiTransactionPaymentStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 GetAcceptedCurrencies(string key);
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 GetAcceptedCurrencyPrice(string key);
    ...
    public sealed class MultiTransactionPaymentStorage : IMultiTransactionPaymentStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> _acceptedCurrenciesTypedStorage;
        
        /// <summary>
        /// _acceptedCurrencyPriceTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> _acceptedCurrencyPriceTypedStorage;
        ...
        public MultiTransactionPaymentStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AcceptedCurrenciesTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128>("MultiTransactionPayment.AcceptedCurrencies", storageDataProvider, storageChangeDelegates);
            this.AcceptedCurrencyPriceTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128>("MultiTransactionPayment.AcceptedCurrencyPrice", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> AcceptedCurrenciesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> AcceptedCurrencyPriceTypedStorage
        {
            get
            {
        ...
        ///  Curated list of currencies which fees can be paid mapped to corresponding fallback price
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 GetAcceptedCurrencies(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AcceptedCurrenciesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 result))
            {
                return result;
            }
            else
        ...
        ///  Asset prices from the spot price provider or the fallback price if the price is not available. Updated at the beginning of every block.
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 GetAcceptedCurrencyPrice(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AcceptedCurrencyPriceTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 result))
            {
                return result;
            }
            else
