...
namespace Substrate.Hydration.NET.RestService.Generated.Storage
{
    ...
    public interface IDCAStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule GetSchedules(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Primitive.U32 GetScheduleExecutionBlock(string key);
        
        /// <summary>
        /// >> ScheduleIdsPerBlock
        ///  Keep tracking of the schedule ids to be executed in the block
        /// </summary>
        Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52 GetScheduleIdsPerBlock(string key);
    }
    ...
    public sealed class DCAStorage : IDCAStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule> _schedulesTypedStorage;
        ...
        /// <summary>
        /// _scheduleExecutionBlockTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Primitive.U32> _scheduleExecutionBlockTypedStorage;
        
        /// <summary>
        /// _scheduleIdsPerBlockTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52> _scheduleIdsPerBlockTypedStorage;
        ...
        public DCAStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.SchedulesTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule>("DCA.Schedules", storageDataProvider, storageChangeDelegates);
            ...
            this.ScheduleExecutionBlockTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Primitive.U32>("DCA.ScheduleExecutionBlock", storageDataProvider, storageChangeDelegates);
            this.ScheduleIdsPerBlockTypedStorage = new TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52>("DCA.ScheduleIdsPerBlock", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule> SchedulesTypedStorage
        {
            get
            {
        ...
        /// <summary>
        /// _scheduleExecutionBlockTypedStorage property
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Primitive.U32> ScheduleExecutionBlockTypedStorage
        {
            get
            {
                return _scheduleExecutionBlockTypedStorage;
            }
            set
            {
                _scheduleExecutionBlockTypedStorage = value;
            }
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52> ScheduleIdsPerBlockTypedStorage
        {
            get
            {
        ...
        public async Task InitializeAsync(Substrate.ServiceLayer.Storage.IStorageDataProvider dataProvider)
        {
            ...
            await ScheduleExecutionBlockTypedStorage.InitializeAsync("DCA", "ScheduleExecutionBlock");
        ...
        ///  Storing schedule details
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule GetSchedules(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SchedulesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_dca.types.Schedule result))
            {
                return result;
            }
            else
        ...
        /// <summary>
        /// Implements any storage change for DCA.ScheduleExecutionBlock
        /// </summary>
        [StorageChange("DCA", "ScheduleExecutionBlock")]
        public void OnUpdateScheduleExecutionBlock(string key, string data)
        {
            ScheduleExecutionBlockTypedStorage.Update(key, data);
        }
        ...
        ///  Keep tracking the blocknumber when the schedule is planned to be executed
        /// </summary>
        public Substrate.NetApi.Model.Types.Primitive.U32 GetScheduleExecutionBlock(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ScheduleExecutionBlockTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Primitive.U32 result))
            {
                return result;
            }
            else
        ...
        ///  Keep tracking of the schedule ids to be executed in the block
        /// </summary>
        public Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52 GetScheduleIdsPerBlock(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ScheduleIdsPerBlockTypedStorage.Dictionary.TryGetValue(key, out Substrate.Hydration.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT52 result))
            {
                return result;
            }
            else
