...
namespace Substrate.Hydration.NET.RestService.Generated.Controller
{
    ...
    public sealed class OTCController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Hydration.NET.NetApiExt.Generated.Storage.OTCStorage), "NextOrderIdParams")]
        ...
        /// </summary>
        [HttpGet("Orders")]
        [ProducesResponseType(typeof(Substrate.Hydration.NET.NetApiExt.Generated.Model.pallet_otc.Order), 200)]
        [StorageKeyBuilder(typeof(Substrate.Hydration.NET.NetApiExt.Generated.Storage.OTCStorage), "OrdersParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
