...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class CouncilControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 GetTestValue2()
      {
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 mockupValue = this.GetTestValue2();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 rpcResult = await rpcClient.GetProposals();
