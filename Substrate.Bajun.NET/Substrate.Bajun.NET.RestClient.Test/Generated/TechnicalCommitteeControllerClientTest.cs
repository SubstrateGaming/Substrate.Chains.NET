...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class TechnicalCommitteeControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 GetTestValue2()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 mockupValue = this.GetTestValue2();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44 rpcResult = await rpcClient.GetProposals();
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.bajun_runtime.EnumRuntimeCall GetTestValue5()
      {
         ...
         // NOT IMPLEMENTED >> Initialize Substrate.Bajun.NET.NetApiExt.Generated.Model.bajun_runtime.EnumRuntimeCall
         return result;
      }
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_collective.Votes GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestVoting()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_collective.Votes mockupValue = this.GetTestValue8();
      ...
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetTestValue14()
      {
      ...
      public async System.Threading.Tasks.Task TestMembers()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> mockupValue = this.GetTestValue14();
      ...
      public async System.Threading.Tasks.Task TestPrime()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 mockupValue = this.GetTestValue17();
