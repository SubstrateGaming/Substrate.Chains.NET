...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class RandomnessControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 GetTestValue2()
      {
      ...
      public async System.Threading.Tasks.Task TestRandomMaterial()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 mockupValue = this.GetTestValue2();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT30 rpcResult = await rpcClient.GetRandomMaterial();
