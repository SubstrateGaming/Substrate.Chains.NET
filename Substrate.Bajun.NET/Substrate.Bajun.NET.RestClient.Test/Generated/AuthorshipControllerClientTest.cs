...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class AuthorshipControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 GetTestValue2()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem>();
         result.Value.Create(new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem[] {
                  this.GetTestValue3()});
         return result;
      }
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem GetTestValue3()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.EnumUncleEntryItem();
         result.Create(this.GetTestValueEnum<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_authorship.UncleEntryItem>(), this.GetTestValueU32());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestUncles()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 mockupValue = this.GetTestValue2();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22 rpcResult = await rpcClient.GetUncles();
      ...
      public async System.Threading.Tasks.Task TestAuthor()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 rpcResult = await rpcClient.GetAuthor();
