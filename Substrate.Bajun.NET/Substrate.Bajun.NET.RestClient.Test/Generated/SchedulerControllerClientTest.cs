...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 GetTestValue3()
      {
         ...
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>[] {
                  this.GetTestValue4()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
      ...
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8();
      ...
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 mockupValue = this.GetTestValue3();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 rpcResult = await rpcClient.GetAgenda(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetTestValue11()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig();
      ...
      public async System.Threading.Tasks.Task TestRetries()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig mockupValue = this.GetTestValue11();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig rpcResult = await rpcClient.GetRetries(mockupKey);
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue15()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8();
         result.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue15();
