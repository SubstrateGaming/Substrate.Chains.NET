...
namespace Substrate.Bajun.NET.RestClient.Test.Generated
{
   ...
   public class TreasuryControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetTestValue3()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal();
         result.Proposer = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Proposer = this.GetTestValue4();
         result.Value = this.GetTestValueU128();
         result.Beneficiary = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal mockupValue = this.GetTestValue3();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal rpcResult = await rpcClient.GetProposals(mockupKey);
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetTestValue8()
      {
      ...
      public async System.Threading.Tasks.Task TestApprovals()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 mockupValue = this.GetTestValue8();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 rpcResult = await rpcClient.GetApprovals();
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus GetTestValue11()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus();
         ...
         result.Status = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState();
      ...
      public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState GetTestValue13()
      {
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState result;
         result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState();
         // NOT IMPLEMENTED >> Initialize Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.EnumPaymentState
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestSpends()
      {
         ...
         // Construct new RPC client to test with.
         TreasuryControllerClient rpcClient = new TreasuryControllerClient(_httpClient, subscriptionClient);
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus mockupValue = this.GetTestValue11();
         Substrate.NetApi.Model.Types.Primitive.U32 mockupKey = this.GetTestValueU32();
         ...
         Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_treasury.SpendStatus rpcResult = await rpcClient.GetSpends(mockupKey);
