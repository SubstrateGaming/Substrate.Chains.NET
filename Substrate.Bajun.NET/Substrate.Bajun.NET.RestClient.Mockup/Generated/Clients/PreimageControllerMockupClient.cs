...
namespace Substrate.Bajun.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class PreimageControllerMockupClient : MockupBaseClient, IPreimageControllerMockupClient
   {
      ...
      public async Task<bool> SetStatusFor(EnumOldRequestStatus value, Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
      ...
      public async Task<bool> SetRequestStatusFor(EnumRequestStatus value, Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
      ...
      public async Task<bool> SetPreimageFor(BoundedVecT30 value, Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256, Substrate.NetApi.Model.Types.Primitive.U32> key)
      {
