...
namespace Substrate.Bajun.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class SchedulerControllerMockupClient : MockupBaseClient, ISchedulerControllerMockupClient
   {
      ...
      public async Task<bool> SetAgenda(BoundedVecT30 value, U32 key)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Scheduler/Retries", value.Encode(), Substrate.Bajun.NET.NetApiExt.Generated.Storage.SchedulerStorage.RetriesParams(key));
      }
      public async Task<bool> SetLookup(BaseTuple<U32, U32> value, Substrate.Bajun.NET.NetApiExt.Generated.Types.Base.Arr32U8 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Scheduler/Lookup", value.Encode(), Substrate.Bajun.NET.NetApiExt.Generated.Storage.SchedulerStorage.LookupParams(key));
      }
   }
}
