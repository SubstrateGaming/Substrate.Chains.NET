...
namespace Substrate.Bajun.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParachainInfoControllerMockupClient : MockupBaseClient, IParachainInfoControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainInfo/ParachainId", value.Encode(), Substrate.Bajun.NET.NetApiExt.Generated.Storage.ParachainInfoStorage.ParachainIdParams());
      }
   }
}
