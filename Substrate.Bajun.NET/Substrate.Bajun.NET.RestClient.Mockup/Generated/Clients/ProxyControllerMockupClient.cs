...
namespace Substrate.Bajun.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ProxyControllerMockupClient : MockupBaseClient, IProxyControllerMockupClient
   {
      ...
      public async Task<bool> SetProxies(BaseTuple<BoundedVecT16, U128> value, Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
      ...
      public async Task<bool> SetAnnouncements(BaseTuple<BoundedVecT17, U128> value, Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
