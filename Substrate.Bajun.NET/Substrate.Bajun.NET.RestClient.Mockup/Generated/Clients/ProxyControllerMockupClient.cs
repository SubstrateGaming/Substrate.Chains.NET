...
namespace Substrate.Bajun.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ProxyControllerMockupClient : MockupBaseClient, IProxyControllerMockupClient
   {
      ...
      public async Task<bool> SetProxies(BaseTuple<BoundedVecT19, U128> value, Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
      ...
      public async Task<bool> SetAnnouncements(BaseTuple<BoundedVecT20, U128> value, Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
