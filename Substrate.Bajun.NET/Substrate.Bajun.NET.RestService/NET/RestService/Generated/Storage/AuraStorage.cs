...
namespace Substrate.Bajun.NET.RestService.Generated.Storage
{
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
