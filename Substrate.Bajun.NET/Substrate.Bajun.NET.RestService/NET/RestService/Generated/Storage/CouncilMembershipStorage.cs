...
namespace Substrate.Bajun.NET.RestService.Generated.Storage
{
    ...
    public sealed class CouncilMembershipStorage : ICouncilMembershipStorage
    {
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT44>("CouncilMembership.Members", storageDataProvider, storageChangeDelegates);
