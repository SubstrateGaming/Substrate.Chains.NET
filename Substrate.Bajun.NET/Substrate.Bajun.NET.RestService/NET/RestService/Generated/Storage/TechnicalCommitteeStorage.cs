...
namespace Substrate.Bajun.NET.RestService.Generated.Storage
{
    ...
    public sealed class TechnicalCommitteeStorage : ITechnicalCommitteeStorage
    {
        ...
        {
            this.ProposalsTypedStorage = new TypedStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT43>("TechnicalCommittee.Proposals", storageDataProvider, storageChangeDelegates);
            ...
            this.MembersTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>("TechnicalCommittee.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("TechnicalCommittee.Prime", storageDataProvider, storageChangeDelegates);
        }
