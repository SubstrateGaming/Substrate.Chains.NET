...
namespace Substrate.Bajun.NET.RestService.Generated.Storage
{
    ...
    public interface IPreimageStorage : IStorage
    {
        ...
        /// >> PreimageFor
        /// </summary>
        Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 GetPreimageFor(string key);
    }
    ...
    public sealed class PreimageStorage : IPreimageStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31> _preimageForTypedStorage;
        ...
        public PreimageStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.PreimageForTypedStorage = new TypedMapStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31>("Preimage.PreimageFor", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31> PreimageForTypedStorage
        {
            get
            {
        ...
        /// >> PreimageFor
        /// </summary>
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 GetPreimageFor(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PreimageForTypedStorage.Dictionary.TryGetValue(key, out Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT31 result))
            {
                return result;
            }
            else
