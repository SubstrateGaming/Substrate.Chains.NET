...
namespace Substrate.Bajun.NET.RestClient.Generated.Interfaces
{
   ...
   public interface ICouncilControllerClient
   {
      ...
      Task<Votes> GetVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
