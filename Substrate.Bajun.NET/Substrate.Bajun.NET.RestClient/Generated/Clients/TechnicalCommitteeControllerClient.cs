...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TechnicalCommitteeControllerClient : BaseClient, ITechnicalCommitteeControllerClient
   {
      ...
      public async Task<BoundedVecT44> GetProposals()
      {
         return await SendRequestAsync<BoundedVecT44>(_httpClient, "technicalcommittee/proposals");
      }
      public async Task<bool> SubscribeProposals()
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.Proposals");
      }
      public async Task<EnumRuntimeCall> GetProposalOf(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "technicalcommittee/proposalof", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.ProposalOf", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "technicalcommittee/voting", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("TechnicalCommittee.Voting", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TechnicalCommitteeStorage.VotingParams(key));
      }
