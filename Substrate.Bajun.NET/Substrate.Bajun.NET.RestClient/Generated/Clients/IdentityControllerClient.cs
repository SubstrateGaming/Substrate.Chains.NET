...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class IdentityControllerClient : BaseClient, IIdentityControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<U128, BoundedVecT17>>(_httpClient, "identity/subsof", Substrate.Bajun.NET.NetApiExt.Generated.Storage.IdentityStorage.SubsOfParams(key));
      }
      ...
      public async Task<BoundedVecT18> GetRegistrars()
      {
         return await SendRequestAsync<BoundedVecT18>(_httpClient, "identity/registrars");
      }
