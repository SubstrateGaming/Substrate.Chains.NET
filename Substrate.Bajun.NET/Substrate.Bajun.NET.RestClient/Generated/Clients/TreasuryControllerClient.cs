...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class TreasuryControllerClient : BaseClient, ITreasuryControllerClient
   {
      ...
      {
         return await SendRequestAsync<SpendStatus>(_httpClient, "treasury/spends", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
      public async Task<bool> SubscribeSpends(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Treasury.Spends", Substrate.Bajun.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
   }
}
