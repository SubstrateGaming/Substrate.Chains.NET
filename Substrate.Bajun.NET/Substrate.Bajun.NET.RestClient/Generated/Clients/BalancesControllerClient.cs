...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class BalancesControllerClient : BaseClient, IBalancesControllerClient
   {
      ...
      public async Task<BoundedVecT32> GetReserves(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT32>(_httpClient, "balances/reserves", Substrate.Bajun.NET.NetApiExt.Generated.Storage.BalancesStorage.ReservesParams(key));
      }
      ...
      public async Task<BoundedVecT33> GetHolds(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT33>(_httpClient, "balances/holds", Substrate.Bajun.NET.NetApiExt.Generated.Storage.BalancesStorage.HoldsParams(key));
      }
      ...
      public async Task<BoundedVecT34> GetFreezes(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT34>(_httpClient, "balances/freezes", Substrate.Bajun.NET.NetApiExt.Generated.Storage.BalancesStorage.FreezesParams(key));
      }
