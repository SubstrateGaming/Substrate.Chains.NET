...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CouncilControllerClient : BaseClient, ICouncilControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT42>(_httpClient, "council/proposals");
      }
      ...
      {
         return await SendRequestAsync<EnumRuntimeCall>(_httpClient, "council/proposalof", Substrate.Bajun.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<bool> SubscribeProposalOf(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.ProposalOf", Substrate.Bajun.NET.NetApiExt.Generated.Storage.CouncilStorage.ProposalOfParams(key));
      }
      public async Task<Votes> GetVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendRequestAsync<Votes>(_httpClient, "council/voting", Substrate.Bajun.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
      public async Task<bool> SubscribeVoting(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("Council.Voting", Substrate.Bajun.NET.NetApiExt.Generated.Storage.CouncilStorage.VotingParams(key));
      }
