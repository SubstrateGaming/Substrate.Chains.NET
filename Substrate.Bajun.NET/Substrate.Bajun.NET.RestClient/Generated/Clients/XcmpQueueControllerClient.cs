...
namespace Substrate.Bajun.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmpQueueControllerClient : BaseClient, IXcmpQueueControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/inboundxcmpmessages", Substrate.Bajun.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeInboundXcmpMessages(BaseTuple<Id, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.InboundXcmpMessages", Substrate.Bajun.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Id, U32, BaseVec<U8>>>(_httpClient, "xcmpqueue/overweight", Substrate.Bajun.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
