...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config
{
    ...
    /// <summary>
    /// >> 173 - Composite[pallet_ajuna_awesome_avatars.types.config.FreemintTransferConfig]
    /// </summary>
    ...
    public sealed class FreemintTransferConfig : BaseType
    {
        ...
        /// >> mode
        /// </summary>
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config.EnumFreeMintTransferMode Mode { get; set; }
        /// <summary>
        ...
        {
            var start = p;
            Mode = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.config.EnumFreeMintTransferMode();
