...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee
{
    
    
    /// <summary>
    /// >> 159 - Composite[pallet_ajuna_awesome_avatars.types.fee.Fee]
    /// </summary>
    ...
    public sealed class Fee : BaseType
    {
        ...
        {
            var start = p;
            Mint = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.MintFees();
