...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_nfts.types
{
    ...
    /// <summary>
    /// >> 309 - Composite[pallet_nfts.types.MintSettings]
    /// </summary>
    ...
    public sealed class MintSettings : BaseType
    {
        ...
        {
            var start = p;
            MintType = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_nfts.types.EnumMintType();
            ...
            DefaultItemSettings = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_nfts.types.BitFlagsT2();
