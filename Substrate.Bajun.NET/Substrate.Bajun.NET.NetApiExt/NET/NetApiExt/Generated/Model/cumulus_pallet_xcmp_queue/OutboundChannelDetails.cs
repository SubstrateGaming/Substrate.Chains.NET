...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 403 - Composite[cumulus_pallet_xcmp_queue.OutboundChannelDetails]
    /// </summary>
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> state
        /// </summary>
        private Substrate.Bajun.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState _state;
        ...
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State
        {
            get
            {
                return this._state;
        ...
        {
            var start = p;
            Recipient = new Substrate.Bajun.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
