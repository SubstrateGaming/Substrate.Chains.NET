...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 405 - Composite[cumulus_pallet_xcmp_queue.QueueConfigData]
    /// </summary>
    ...
    public sealed class QueueConfigData : BaseType
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            ThresholdWeight = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            ThresholdWeight.Decode(byteArray, ref p);
            WeightRestrictDecay = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            WeightRestrictDecay.Decode(byteArray, ref p);
            XcmpMaxIndividualWeight = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
