...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime
{
    ...
    public sealed class EnumDispatchError : BaseEnumRust<DispatchError>
    {
        ...
        public EnumDispatchError()
        {
				...
				AddTypeDecoder<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.ModuleError>(DispatchError.Module);
				...
				AddTypeDecoder<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.EnumTokenError>(DispatchError.Token);
				AddTypeDecoder<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_arithmetic.EnumArithmeticError>(DispatchError.Arithmetic);
				AddTypeDecoder<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.EnumTransactionalError>(DispatchError.Transactional);
