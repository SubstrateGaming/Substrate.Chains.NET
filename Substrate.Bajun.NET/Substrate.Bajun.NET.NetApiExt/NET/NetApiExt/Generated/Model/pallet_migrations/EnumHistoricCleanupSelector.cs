...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_migrations
{
    ...
    public sealed class EnumHistoricCleanupSelector : BaseEnumRust<HistoricCleanupSelector>
    {
        ...
        {
				AddTypeDecoder<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT17>>(HistoricCleanupSelector.Specific);
