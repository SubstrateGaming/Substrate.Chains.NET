...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 342 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> fields
        /// </summary>
        private Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags _fields;
        ...
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags Fields
        {
            get
            {
                return this._fields;
        ...
        {
            var start = p;
            Account = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Account.Decode(byteArray, ref p);
            Fee = new Substrate.NetApi.Model.Types.Primitive.U128();
            Fee.Decode(byteArray, ref p);
            Fields = new Substrate.Bajun.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags();
