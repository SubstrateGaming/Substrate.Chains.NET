...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class PolkadotXcmStorage
    {
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcm(string blockhash, CancellationToken token)
        {
            string parameters = PolkadotXcmStorage.RecordedXcmParams();
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class PolkadotXcmCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method TransferAssetsUsingTypeAndThen(Substrate.Bajun.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation dest, Substrate.Bajun.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssets assets, Substrate.Bajun.NET.NetApiExt.Generated.Model.staging_xcm_executor.traits.asset_transfer.EnumTransferType assets_transfer_type, Substrate.Bajun.NET.NetApiExt.Generated.Model.xcm.EnumVersionedAssetId remote_fees_id, Substrate.Bajun.NET.NetApiExt.Generated.Model.staging_xcm_executor.traits.asset_transfer.EnumTransferType fees_transfer_type, Substrate.Bajun.NET.NetApiExt.Generated.Model.xcm.EnumVersionedXcm custom_xcm_on_dest, Substrate.Bajun.NET.NetApiExt.Generated.Model.xcm.v3.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(assets.Encode());
