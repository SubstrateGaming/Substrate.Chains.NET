...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AwesomeAvatarsCalls
    {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ForceSetAffiliateeState(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 account, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> chain)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(account.Encode());
