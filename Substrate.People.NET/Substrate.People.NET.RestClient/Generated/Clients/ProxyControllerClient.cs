...
namespace Substrate.People.NET.RestClient.Generated.Clients
{
   ...
   public sealed class ProxyControllerClient : BaseClient, IProxyControllerClient
   {
      ...
      {
         return await _subscriptionClient.SubscribeAsync("Proxy.Announcements", Substrate.People.NET.NetApiExt.Generated.Storage.ProxyStorage.AnnouncementsParams(key));
      }
   }
}
