...
namespace Substrate.People.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), Substrate.People.NET.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
   }
}
