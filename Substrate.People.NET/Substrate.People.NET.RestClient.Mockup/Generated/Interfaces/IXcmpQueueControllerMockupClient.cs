...
namespace Substrate.People.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IXcmpQueueControllerMockupClient
   {
      ...
      Task<bool> SetOutboundXcmpMessages(WeakBoundedVecT3 value, Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.People.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, U16> key);
      Task<bool> SetSignalMessages(WeakBoundedVecT3 value, Substrate.People.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key);
