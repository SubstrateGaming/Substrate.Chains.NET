...
namespace Substrate.People.NET.RestClient.Test.Generated
{
   ...
   public class CollatorSelectionControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 GetTestValue2()
      {
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 result;
         result = new Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8();
      ...
      public async System.Threading.Tasks.Task TestInvulnerables()
      {
         ...
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 mockupValue = this.GetTestValue2();
         ...
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 rpcResult = await rpcClient.GetInvulnerables();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetTestValue5()
      {
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 result;
         result = new Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.People.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>();
         result.Value.Create(new Substrate.People.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo[] {
                  this.GetTestValue6()});
         return result;
      }
      public Substrate.People.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo GetTestValue6()
      {
         Substrate.People.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo result;
         result = new Substrate.People.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo();
         result.Who = new Substrate.People.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Who = this.GetTestValue7();
         result.Deposit = this.GetTestValueU128();
         return result;
      }
      public Substrate.People.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetTestValue7()
      {
         Substrate.People.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result;
         result = new Substrate.People.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Value = new Substrate.People.NET.NetApiExt.Generated.Types.Base.Arr32U8();
      ...
      public async System.Threading.Tasks.Task TestCandidateList()
      {
         ...
         // Construct new RPC client to test with.
         CollatorSelectionControllerClient rpcClient = new CollatorSelectionControllerClient(_httpClient, subscriptionClient);
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 mockupValue = this.GetTestValue5();
         ...
         Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 rpcResult = await rpcClient.GetCandidateList();
      ...
      public async System.Threading.Tasks.Task TestLastAuthoredBlock()
      {
         ...
         Substrate.People.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 mockupKey = this.GetTestValue9();
