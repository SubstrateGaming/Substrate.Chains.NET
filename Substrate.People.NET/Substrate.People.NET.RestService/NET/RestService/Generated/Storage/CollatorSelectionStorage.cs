...
namespace Substrate.People.NET.RestService.Generated.Storage
{
    ...
    public interface ICollatorSelectionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 GetInvulnerables();
        ...
        /// </summary>
        Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetCandidateList();
    ...
    public sealed class CollatorSelectionStorage : ICollatorSelectionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8> _invulnerablesTypedStorage;
        
        /// <summary>
        /// _candidateListTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9> _candidateListTypedStorage;
        ...
        {
            this.InvulnerablesTypedStorage = new TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8>("CollatorSelection.Invulnerables", storageDataProvider, storageChangeDelegates);
            this.CandidateListTypedStorage = new TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9>("CollatorSelection.CandidateList", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8> InvulnerablesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9> CandidateListTypedStorage
        {
            get
            {
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 GetInvulnerables()
        {
        ...
        ///  recently updated is considered greater.
        /// </summary>
        public Substrate.People.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT9 GetCandidateList()
        {
