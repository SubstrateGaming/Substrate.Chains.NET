...
namespace Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_contracts.storage
{
    
    
    /// <summary>
    /// >> 454 - Composite[pallet_contracts.storage.ContractInfo]
    /// </summary>
    ...
    public sealed class ContractInfo : BaseType
    {
        ...
        /// >> trie_id
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8 TrieId { get; set; }
        /// <summary>
        /// >> deposit_account
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_contracts.storage.DepositAccount DepositAccount { get; set; }
        /// <summary>
        /// >> code_hash
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> storage_bytes
        /// </summary>
        ...
        {
            var start = p;
            TrieId = new Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8();
            TrieId.Decode(byteArray, ref p);
            DepositAccount = new Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_contracts.storage.DepositAccount();
            DepositAccount.Decode(byteArray, ref p);
            CodeHash = new Substrate.GameDAO.NET.NetApiExt.Generated.Model.primitive_types.H256();
