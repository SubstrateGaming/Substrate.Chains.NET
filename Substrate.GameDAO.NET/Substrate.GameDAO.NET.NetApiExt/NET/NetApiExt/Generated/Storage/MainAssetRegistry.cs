...
namespace Substrate.GameDAO.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetRegistryStorage
    {
        ...
        public AssetRegistryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "Metadata"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Model.orml_traits.asset_registry.AssetMetadata)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AssetRegistry", "LocationToAssetId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Model.xcm.v3.multilocation.MultiLocation), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  The metadata of an asset, indexed by asset id.
        /// </summary>
        public async Task<Substrate.GameDAO.NET.NetApiExt.Generated.Model.orml_traits.asset_registry.AssetMetadata> Metadata(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = AssetRegistryStorage.MetadataParams(key);
            var result = await _client.GetStorageAsync<Substrate.GameDAO.NET.NetApiExt.Generated.Model.orml_traits.asset_registry.AssetMetadata>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  messages.
        /// </summary>
        public static string LocationToAssetIdParams(Substrate.GameDAO.NET.NetApiExt.Generated.Model.xcm.v3.multilocation.MultiLocation key)
        {
        ...
        ///  messages.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LocationToAssetId(Substrate.GameDAO.NET.NetApiExt.Generated.Model.xcm.v3.multilocation.MultiLocation key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class AssetRegistryCalls
    {
        ...
        /// </summary>
        public static Method RegisterAsset(Substrate.GameDAO.NET.NetApiExt.Generated.Model.orml_traits.asset_registry.AssetMetadata metadata, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> asset_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(metadata.Encode());
            byteArray.AddRange(asset_id.Encode());
            return new Method(60, "AssetRegistry", 0, "register_asset", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdateAsset(Substrate.NetApi.Model.Types.Primitive.U32 asset_id, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> decimals, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> name, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> symbol, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> existential_deposit, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.GameDAO.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>> location, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.GameDAO.NET.NetApiExt.Generated.Model.zero_primitives.currency.CustomMetadata> additional)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_id.Encode());
            ...
            return new Method(60, "AssetRegistry", 1, "update_asset", byteArray.ToArray());
        }
    }
