...
namespace Substrate.GameDAO.NET.RestService.Generated.Storage
{
    ...
    public interface IRandomnessCollectiveFlipStorage : IStorage
    {
        ...
        ///  the oldest hash.
        /// </summary>
        Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetRandomMaterial();
    }
    ...
    public sealed class RandomnessCollectiveFlipStorage : IRandomnessCollectiveFlipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24> _randomMaterialTypedStorage;
        ...
        {
            this.RandomMaterialTypedStorage = new TypedStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24>("RandomnessCollectiveFlip.RandomMaterial", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _randomMaterialTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24> RandomMaterialTypedStorage
        {
            get
            {
        ...
        ///  the oldest hash.
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetRandomMaterial()
        {
