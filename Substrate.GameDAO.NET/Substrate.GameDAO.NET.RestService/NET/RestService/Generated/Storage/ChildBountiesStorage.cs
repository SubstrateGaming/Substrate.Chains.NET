...
namespace Substrate.GameDAO.NET.RestService.Generated.Storage
{
    ...
    public interface IChildBountiesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty GetChildBounties(string key);
        
        /// <summary>
        /// >> ChildBountyDescriptions
        ///  The description of each child-bounty.
        /// </summary>
        Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15 GetChildBountyDescriptions(string key);
    ...
    public sealed class ChildBountiesStorage : IChildBountiesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty> _childBountiesTypedStorage;
        
        /// <summary>
        /// _childBountyDescriptionsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15> _childBountyDescriptionsTypedStorage;
        ...
        public ChildBountiesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ChildBountiesTypedStorage = new TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty>("ChildBounties.ChildBounties", storageDataProvider, storageChangeDelegates);
            this.ChildBountyDescriptionsTypedStorage = new TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15>("ChildBounties.ChildBountyDescriptions", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty> ChildBountiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15> ChildBountyDescriptionsTypedStorage
        {
            get
            {
        ...
        ///  Child bounties that have been added.
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty GetChildBounties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ChildBountiesTypedStorage.Dictionary.TryGetValue(key, out Substrate.GameDAO.NET.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty result))
            {
                return result;
            }
            else
        ...
        ///  The description of each child-bounty.
        /// </summary>
        public Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15 GetChildBountyDescriptions(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ChildBountyDescriptionsTypedStorage.Dictionary.TryGetValue(key, out Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT15 result))
            {
                return result;
            }
            else
