...
namespace Substrate.GameDAO.NET.RestService.Generated.Controller
{
    ...
    public sealed class CollatorSelectionController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28), 200)]
        [StorageKeyBuilder(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "InvulnerablesParams")]
        ...
        /// </summary>
        [HttpGet("Candidates")]
        [ProducesResponseType(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29), 200)]
        [StorageKeyBuilder(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "LastAuthoredBlockParams", typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "DesiredCandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.GameDAO.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidacyBondParams")]
