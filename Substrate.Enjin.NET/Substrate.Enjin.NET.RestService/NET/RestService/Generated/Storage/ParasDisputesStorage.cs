...
namespace Substrate.Enjin.NET.RestService.Generated.Storage
{
    ...
    public interface IParasDisputesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState GetDisputes(string key);
        ...
        /// </summary>
        Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4 GetBackersOnDisputes(string key);
    ...
    public sealed class ParasDisputesStorage : IParasDisputesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState> _disputesTypedStorage;
        
        /// <summary>
        /// _backersOnDisputesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4> _backersOnDisputesTypedStorage;
        ...
        public ParasDisputesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.DisputesTypedStorage = new TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState>("ParasDisputes.Disputes", storageDataProvider, storageChangeDelegates);
            this.BackersOnDisputesTypedStorage = new TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4>("ParasDisputes.BackersOnDisputes", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState> DisputesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4> BackersOnDisputesTypedStorage
        {
            get
            {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState GetDisputes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DisputesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.DisputeState result))
            {
                return result;
            }
            else
        ...
        ///  This storage is used for slashing.
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4 GetBackersOnDisputes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BackersOnDisputesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.BTreeSetT4 result))
            {
                return result;
            }
            else
