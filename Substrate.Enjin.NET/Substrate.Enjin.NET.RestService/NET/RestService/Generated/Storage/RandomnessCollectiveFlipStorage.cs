...
namespace Substrate.Enjin.NET.RestService.Generated.Storage
{
    ...
    public interface IRandomnessCollectiveFlipStorage : IStorage
    {
        ...
        ///  the oldest hash.
        /// </summary>
        Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 GetRandomMaterial();
    }
    ...
    public sealed class RandomnessCollectiveFlipStorage : IRandomnessCollectiveFlipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26> _randomMaterialTypedStorage;
        ...
        {
            this.RandomMaterialTypedStorage = new TypedStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26>("RandomnessCollectiveFlip.RandomMaterial", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _randomMaterialTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26> RandomMaterialTypedStorage
        {
            get
            {
        ...
        ///  the oldest hash.
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT26 GetRandomMaterial()
        {
