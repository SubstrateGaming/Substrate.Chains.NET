...
namespace Substrate.Enjin.NET.RestService.Generated.Controller
{
    ...
    public sealed class SchedulerController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Enjin.NET.NetApiExt.Generated.Storage.SchedulerStorage), "IncompleteSinceParams")]
        ...
        /// </summary>
        [HttpGet("Agenda")]
        [ProducesResponseType(typeof(Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT49), 200)]
        [StorageKeyBuilder(typeof(Substrate.Enjin.NET.NetApiExt.Generated.Storage.SchedulerStorage), "AgendaParams", typeof(Substrate.NetApi.Model.Types.Primitive.U32))]
        ...
        [StorageKeyBuilder(typeof(Substrate.Enjin.NET.NetApiExt.Generated.Storage.SchedulerStorage), "LookupParams", typeof(Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.Arr32U8))]
