...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Model.pallet_staking
{
    ...
    /// <summary>
    /// >> 715 - Composite[pallet_staking.Nominations]
    /// </summary>
    ...
    public sealed class Nominations : BaseType
    {
        ...
        /// >> targets
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32 Targets { get; set; }
        /// <summary>
        /// >> submitted_in
        /// </summary>
        ...
        {
            var start = p;
            Targets = new Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32();
