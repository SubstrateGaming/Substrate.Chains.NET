...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Model.pallet_staking
{
    ...
    /// <summary>
    /// >> 710 - Composite[pallet_staking.StakingLedger]
    /// </summary>
    ...
    public sealed class StakingLedger : BaseType
    {
        ...
        /// >> stash
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Stash { get; set; }
        /// <summary>
        /// >> total
        /// </summary>
        ...
        /// >> unlocking
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 Unlocking { get; set; }
        /// <summary>
        /// >> claimed_rewards
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35 ClaimedRewards { get; set; }
        ...
        {
            var start = p;
            Stash = new Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            ...
            Unlocking = new Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34();
            Unlocking.Decode(byteArray, ref p);
            ClaimedRewards = new Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT35();
