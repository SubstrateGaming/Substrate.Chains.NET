...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    ...
    /// <summary>
    /// >> 839 - Composite[polkadot_primitives.v4.SessionInfo]
    /// </summary>
    ...
    public sealed class SessionInfo : BaseType
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex> ActiveValidatorIndices { get; set; }
        /// <summary>
        /// >> random_seed
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.Arr32U8 RandomSeed { get; set; }
        /// <summary>
        /// >> dispute_period
        /// </summary>
        ...
        /// >> validators
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT1 Validators { get; set; }
        /// <summary>
        /// >> discovery_keys
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public> DiscoveryKeys { get; set; }
        /// <summary>
        /// >> assignment_keys
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.assignment_app.Public> AssignmentKeys { get; set; }
        /// <summary>
        /// >> validator_groups
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT2 ValidatorGroups { get; set; }
        /// <summary>
        /// >> n_cores
        /// </summary>
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ValidatorIndex>();
            ActiveValidatorIndices.Decode(byteArray, ref p);
            RandomSeed = new Substrate.Enjin.NET.NetApiExt.Generated.Types.Base.Arr32U8();
            ...
            Validators = new Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT1();
            Validators.Decode(byteArray, ref p);
            DiscoveryKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_authority_discovery.app.Public>();
            DiscoveryKeys.Decode(byteArray, ref p);
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.IndexedVecT2();
