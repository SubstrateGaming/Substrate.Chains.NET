...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan
{
    
    
    /// <summary>
    /// >> 862 - Composite[polkadot_runtime_common.crowdloan.FundInfo]
    /// </summary>
    ...
    public sealed class FundInfo : BaseType
    {
        ...
        /// >> depositor
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Depositor { get; set; }
        /// <summary>
        /// >> verifier
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_runtime.EnumMultiSigner> Verifier { get; set; }
        /// <summary>
        /// >> deposit
        /// </summary>
        ...
        /// >> last_contribution
        /// </summary>
        public Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.EnumLastContribution LastContribution { get; set; }
        /// <summary>
        /// >> first_period
        /// </summary>
        ...
        {
            var start = p;
            Depositor = new Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Depositor.Decode(byteArray, ref p);
            Verifier = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_runtime.EnumMultiSigner>();
            ...
            LastContribution = new Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_runtime_common.crowdloan.EnumLastContribution();
