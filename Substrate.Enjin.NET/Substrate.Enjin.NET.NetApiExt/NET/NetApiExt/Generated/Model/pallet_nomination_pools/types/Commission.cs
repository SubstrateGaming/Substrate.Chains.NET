...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Model.pallet_nomination_pools.types
{
    ...
    /// <summary>
    /// >> 765 - Composite[pallet_nomination_pools.types.Commission]
    /// </summary>
    ...
    public sealed class Commission : BaseType
    {
        ...
        /// >> current
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill> Current { get; set; }
        /// <summary>
        /// >> max
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill> Max { get; set; }
        /// <summary>
        /// >> change_rate
        /// </summary>
        ...
        {
            var start = p;
            Current = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill>();
            Current.Decode(byteArray, ref p);
            Max = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill>();
