...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class FellowshipReferendaStorage
    {
        ...
        public FellowshipReferendaStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipReferenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55)));
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
            string parameters = FellowshipReferendaStorage.TrackQueueParams(key);
            var result = await _client.GetStorageAsync<Substrate.Enjin.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT55>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class FellowshipReferendaCalls
    {
        ...
        public static Method Submit(Substrate.Enjin.NET.NetApiExt.Generated.Model.enjin_runtime.EnumOriginCaller proposal_origin, Substrate.Enjin.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, Substrate.Enjin.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
            ...
            return new Method(107, "FellowshipReferenda", 0, "submit", byteArray.ToArray());
        }
        ...
        public static Method PlaceDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(107, "FellowshipReferenda", 1, "place_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method RefundDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(107, "FellowshipReferenda", 2, "refund_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(107, "FellowshipReferenda", 3, "cancel", byteArray.ToArray());
        }
        ...
        public static Method Kill(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(107, "FellowshipReferenda", 4, "kill", byteArray.ToArray());
        }
        ...
        public static Method NudgeReferendum(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(107, "FellowshipReferenda", 5, "nudge_referendum", byteArray.ToArray());
        }
        ...
        public static Method OneFewerDeciding(Substrate.NetApi.Model.Types.Primitive.U16 track)
        {
            ...
            return new Method(107, "FellowshipReferenda", 6, "one_fewer_deciding", byteArray.ToArray());
        }
        ...
        public static Method RefundSubmissionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(107, "FellowshipReferenda", 7, "refund_submission_deposit", byteArray.ToArray());
        }
        ...
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Enjin.NET.NetApiExt.Generated.Model.primitive_types.H256> maybe_hash)
        {
            ...
            return new Method(107, "FellowshipReferenda", 8, "set_metadata", byteArray.ToArray());
        }
    }
    ...
    public sealed class FellowshipReferendaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.Enjin.NET.NetApiExt.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            ...
            result.Create("0x2800002863616E646964617465730A0000000000E8890423C78A000000000000000058020000801" +
                    "30300C20100000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D01001C6" +
                    "D656D626572730A000000000010632D5EC76B0500000000000000C2010000803202002C0100000A0" +
                    "000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D02002C70726F66696369656" +
                    "E74730A000000000020C65ABC8ED70A000000000000002C010000C0890100960000000A000000000" +
                    "0CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D03001C66656C6C6F77730A000000000" +
                    "0A0DEC5ADC935360000000000000096000000C0A80000960000000A0000000000CA9A3B0065CD1D0" +
                    "0CA9A3B0000CA9A3B000000000065CD1D04003873656E696F722066656C6C6F77730A00000000009" +
                    "0AC6E32788687000000000000009600000080700000640000000A0000000000CA9A3B0065CD1D00C" +
                    "A9A3B0000CA9A3B000000000065CD1D05001C657870657274730A00000000002059DD64F00C0F010" +
                    "000000000006400000040380000640000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B0" +
                    "00000000065CD1D06003873656E696F7220657870657274730A0000000000B0054C9768939601000" +
                    "0000000006400000080250000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000" +
                    "000000065CD1D07001C6D6173746572730A000000000040B2BAC9E0191E020000000000003200000" +
                    "0201C0000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D080" +
                    "03873656E696F72206D6173746572730A0000000000407BA5F06381960A00000000000032000000C" +
                    "0120000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D09003" +
                    "46772616E64206D6173746572730A000000000080F64AE1C7022D150000000000003200000060090" +
                    "000320000000A0000000000CA9A3B0065CD1D00CA9A3B0000CA9A3B000000000065CD1D");
            return result;
        }
    }
