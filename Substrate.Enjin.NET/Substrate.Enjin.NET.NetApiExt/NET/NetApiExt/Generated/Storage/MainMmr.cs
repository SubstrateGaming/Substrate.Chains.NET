...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class MmrStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Mmr", "RootHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Enjin.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Mmr", "Nodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Primitive.U64), typeof(Substrate.Enjin.NET.NetApiExt.Generated.Model.primitive_types.H256)));
        }
        ...
        ///  Latest MMR Root hash.
        /// </summary>
        public async Task<Substrate.Enjin.NET.NetApiExt.Generated.Model.primitive_types.H256> RootHash(string blockhash, CancellationToken token)
        {
        ...
        ///  are pruned and only stored in the Offchain DB.
        /// </summary>
        public async Task<Substrate.Enjin.NET.NetApiExt.Generated.Model.primitive_types.H256> Nodes(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
