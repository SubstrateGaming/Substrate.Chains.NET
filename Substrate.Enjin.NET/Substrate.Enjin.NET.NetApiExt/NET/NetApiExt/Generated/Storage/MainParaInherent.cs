...
namespace Substrate.Enjin.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaInherentStorage
    {
        ...
        public ParaInherentStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaInherent", "OnChainVotes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ScrapedOnChainVotes)));
        }
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ScrapedOnChainVotes> OnChainVotes(string blockhash, CancellationToken token)
        {
            string parameters = ParaInherentStorage.OnChainVotesParams();
            var result = await _client.GetStorageAsync<Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.ScrapedOnChainVotes>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class ParaInherentCalls
    {
        ...
        /// </summary>
        public static Method Enter(Substrate.Enjin.NET.NetApiExt.Generated.Model.polkadot_primitives.v4.InherentData data)
        {
