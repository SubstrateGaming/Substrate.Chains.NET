...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class TechnicalCommitteeControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 GetTestValue2()
      {
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 mockupValue = this.GetTestValue2();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT30 rpcResult = await rpcClient.GetProposals();
      ...
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.pallet.EnumCall result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.pallet.EnumCall();
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes GetTestValue10()
      {
      ...
      public async System.Threading.Tasks.Task TestVoting()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes mockupValue = this.GetTestValue10();
      ...
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetTestValue16()
      {
      ...
      public async System.Threading.Tasks.Task TestMembers()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> mockupValue = this.GetTestValue16();
