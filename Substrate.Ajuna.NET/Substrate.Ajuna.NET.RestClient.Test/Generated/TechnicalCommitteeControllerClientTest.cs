...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class TechnicalCommitteeControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 GetTestValue2()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42();
      ...
      public async System.Threading.Tasks.Task TestProposals()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 mockupValue = this.GetTestValue2();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 rpcResult = await rpcClient.GetProposals();
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.ajuna_runtime.EnumRuntimeCall GetTestValue5()
      {
         ...
         // NOT IMPLEMENTED >> Initialize Substrate.Ajuna.NET.NetApiExt.Generated.Model.ajuna_runtime.EnumRuntimeCall
         return result;
      }
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes GetTestValue8()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes();
         result.Index = this.GetTestValueU32();
         result.Threshold = this.GetTestValueU32();
         result.Ayes = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Ayes.Create(new Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32[] {
                  this.GetTestValue9()});
         result.Nays = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>();
         result.Nays.Create(new Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32[] {
                  this.GetTestValue10()});
      ...
      public async System.Threading.Tasks.Task TestVoting()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes mockupValue = this.GetTestValue8();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_collective.Votes rpcResult = await rpcClient.GetVoting(mockupKey);
      ...
      public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetTestValue14()
      {
      ...
      public async System.Threading.Tasks.Task TestMembers()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> mockupValue = this.GetTestValue14();
         ...
         Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> rpcResult = await rpcClient.GetMembers();
      ...
      public async System.Threading.Tasks.Task TestPrime()
      {
         ...
         // Construct new RPC client to test with.
         TechnicalCommitteeControllerClient rpcClient = new TechnicalCommitteeControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 mockupValue = this.GetTestValue17();
