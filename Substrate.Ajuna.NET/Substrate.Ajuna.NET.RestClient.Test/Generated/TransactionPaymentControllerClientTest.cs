...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   using Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment;
   ...
   public class TransactionPaymentControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 GetTestValue2()
      {
      ...
      public async System.Threading.Tasks.Task TestNextFeeMultiplier()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 mockupValue = this.GetTestValue2();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128 rpcResult = await rpcClient.GetNextFeeMultiplier();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases GetTestValue4()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases();
         result.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.Releases>());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestStorageVersion()
      {
         ...
         // Construct new RPC client to test with.
         TransactionPaymentControllerClient rpcClient = new TransactionPaymentControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases mockupValue = this.GetTestValue4();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases rpcResult = await rpcClient.GetStorageVersion();
