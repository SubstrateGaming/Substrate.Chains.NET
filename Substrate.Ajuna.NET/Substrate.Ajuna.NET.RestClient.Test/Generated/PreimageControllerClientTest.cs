...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class PreimageControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_preimage.EnumOldRequestStatus GetTestValue2()
      {
         ...
         // NOT IMPLEMENTED >> Initialize Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_preimage.EnumOldRequestStatus
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestStatusFor()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 mockupKey = this.GetTestValue3();
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus GetTestValue5()
      {
         ...
         // NOT IMPLEMENTED >> Initialize Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus
         return result;
      }
      ...
      public async System.Threading.Tasks.Task TestRequestStatusFor()
      {
         ...
         // Construct new RPC client to test with.
         PreimageControllerClient rpcClient = new PreimageControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus mockupValue = this.GetTestValue5();
      ...
      public async System.Threading.Tasks.Task TestPreimageFor()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 rpcResult = await rpcClient.GetPreimageFor(mockupKey);
