...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class MessageQueueControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_message_queue.Neighbours GetTestValue3()
      {
         ...
         result.Prev.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.AggregateMessageOrigin>(), this.GetTestValueBaseVoid());
         result.Next = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin();
         result.Next.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.AggregateMessageOrigin>(), this.GetTestValueBaseVoid());
         return result;
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin GetTestValue4()
      {
         ...
         result.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.AggregateMessageOrigin>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestBookStateFor()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin mockupKey = this.GetTestValue4();
      ...
      public async System.Threading.Tasks.Task TestServiceHead()
      {
         ...
         // Construct new RPC client to test with.
         MessageQueueControllerClient rpcClient = new MessageQueueControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin mockupValue = this.GetTestValue6();
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_message_queue.Page GetTestValue8()
      {
         ...
         result.Heap = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29();
         result.Heap = this.GetTestValue9();
         return result;
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 GetTestValue9()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29();
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
                  this.GetTestValueU8()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin, Substrate.NetApi.Model.Types.Primitive.U32> GetTestValue10()
      {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin GetTestValue11()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin();
         result.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.AggregateMessageOrigin>(), this.GetTestValueBaseVoid());
      ...
      public async System.Threading.Tasks.Task TestPages()
      {
         ...
         // Construct new RPC client to test with.
         MessageQueueControllerClient rpcClient = new MessageQueueControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_message_queue.Page mockupValue = this.GetTestValue8();
         Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Ajuna.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin, Substrate.NetApi.Model.Types.Primitive.U32> mockupKey = this.GetTestValue10();
