...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 GetTestValue3()
      {
         ...
         result.Value = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>>();
         result.Value.Create(new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>[] {
                  this.GetTestValue4()});
         return result;
      }
      public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> GetTestValue4()
      {
         Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled>();
         result.Create(this.GetTestValue5());
         return result;
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled GetTestValue5()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.Scheduled();
         result.MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
         result.MaybeId.Create(this.GetTestValue6());
         result.Priority = this.GetTestValueU8();
         result.Call = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         result.Call.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.Bounded>(), this.GetTestValue7());
         ...
         result.Origin = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.ajuna_runtime.EnumOriginCaller();
         result.Origin.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.ajuna_runtime.OriginCaller>(), this.GetTestValue9());
         return result;
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue6()
      {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 GetTestValue7()
      {
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin GetTestValue9()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin();
         result.Create(this.GetTestValueEnum<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.dispatch.RawOrigin>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 mockupValue = this.GetTestValue3();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 rpcResult = await rpcClient.GetAgenda(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetTestValue11()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig();
      ...
      public async System.Threading.Tasks.Task TestRetries()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig mockupValue = this.GetTestValue11();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig rpcResult = await rpcClient.GetRetries(mockupKey);
      ...
      public Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue15()
      {
         Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8();
         result.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue15();
