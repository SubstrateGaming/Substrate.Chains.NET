...
namespace Substrate.Ajuna.NET.RestClient.Test.Generated
{
   ...
   public class CollatorSelectionControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestInvulnerables()
      {
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 rpcResult = await rpcClient.GetInvulnerables();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 GetTestValue5()
      {
      ...
      public async System.Threading.Tasks.Task TestCandidateList()
      {
         ...
         // Construct new RPC client to test with.
         CollatorSelectionControllerClient rpcClient = new CollatorSelectionControllerClient(_httpClient, subscriptionClient);
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 mockupValue = this.GetTestValue5();
         ...
         Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT24 rpcResult = await rpcClient.GetCandidateList();
