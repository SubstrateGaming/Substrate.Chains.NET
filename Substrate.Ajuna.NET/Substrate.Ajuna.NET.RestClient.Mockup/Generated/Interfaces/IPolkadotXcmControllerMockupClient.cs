...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerMockupClient
   {
      ...
      Task<bool> SetSupportedVersion(U32 value, BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SetVersionNotifiers(U64 value, BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SetVersionNotifyTargets(BaseTuple<U64, Weight, U32> value, BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SetVersionDiscoveryQueue(BoundedVecT20 value);
      ...
      Task<bool> SetLockedFungibles(BoundedVecT21 value, Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
