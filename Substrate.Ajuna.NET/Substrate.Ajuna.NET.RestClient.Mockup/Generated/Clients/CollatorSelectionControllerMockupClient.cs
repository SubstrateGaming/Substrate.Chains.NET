...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class CollatorSelectionControllerMockupClient : MockupBaseClient, ICollatorSelectionControllerMockupClient
   {
      ...
      public async Task<bool> SetInvulnerables(BoundedVecT22 value)
      {
      ...
      public async Task<bool> SetCandidateList(BoundedVecT23 value)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "CollatorSelection/DesiredCandidates", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.DesiredCandidatesParams());
      }
      public async Task<bool> SetCandidacyBond(U128 value)
      {
         return await SendMockupRequestAsync(_httpClient, "CollatorSelection/CandidacyBond", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.CandidacyBondParams());
      }
   }
}
