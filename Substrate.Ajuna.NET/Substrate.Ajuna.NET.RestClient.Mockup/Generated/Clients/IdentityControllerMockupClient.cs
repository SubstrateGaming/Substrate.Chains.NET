...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class IdentityControllerMockupClient : MockupBaseClient, IIdentityControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Identity/UsernameAuthorities", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.IdentityStorage.UsernameAuthoritiesParams(key));
      }
      public async Task<bool> SetAccountOfUsername(AccountId32 value, BoundedVecT1 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Identity/AccountOfUsername", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.IdentityStorage.AccountOfUsernameParams(key));
      }
      public async Task<bool> SetPendingUsernames(BaseTuple<AccountId32, U32> value, BoundedVecT1 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Identity/PendingUsernames", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.IdentityStorage.PendingUsernamesParams(key));
      }
   }
}
