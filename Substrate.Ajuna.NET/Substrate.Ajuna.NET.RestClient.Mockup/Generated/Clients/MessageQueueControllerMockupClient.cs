...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class MessageQueueControllerMockupClient : MockupBaseClient, IMessageQueueControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "MessageQueue/BookStateFor", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.MessageQueueStorage.BookStateForParams(key));
      }
      public async Task<bool> SetServiceHead(EnumAggregateMessageOrigin value)
      {
         return await SendMockupRequestAsync(_httpClient, "MessageQueue/ServiceHead", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.MessageQueueStorage.ServiceHeadParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "MessageQueue/Pages", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.MessageQueueStorage.PagesParams(key));
      }
   }
}
