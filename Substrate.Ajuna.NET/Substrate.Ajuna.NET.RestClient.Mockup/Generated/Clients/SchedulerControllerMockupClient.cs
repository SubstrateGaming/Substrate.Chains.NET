...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class SchedulerControllerMockupClient : MockupBaseClient, ISchedulerControllerMockupClient
   {
      ...
      public async Task<bool> SetAgenda(BoundedVecT28 value, U32 key)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Scheduler/Lookup", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.SchedulerStorage.LookupParams(key));
      }
   }
}
