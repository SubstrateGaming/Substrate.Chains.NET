...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraExtControllerMockupClient : MockupBaseClient, IAuraExtControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/SlotInfo", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.AuraExtStorage.SlotInfoParams());
      }
   }
}
