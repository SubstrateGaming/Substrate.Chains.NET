...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraControllerMockupClient : MockupBaseClient, IAuraControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/Authorities", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.AuraStorage.AuthoritiesParams());
      }
      public async Task<bool> SetCurrentSlot(Slot value)
      {
         return await SendMockupRequestAsync(_httpClient, "Aura/CurrentSlot", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.AuraStorage.CurrentSlotParams());
      }
   }
}
