...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TreasuryControllerMockupClient : MockupBaseClient, ITreasuryControllerMockupClient
   {
      ...
      public async Task<bool> SetApprovals(BoundedVecT30 value)
      {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/SpendCount", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendCountParams());
      }
      public async Task<bool> SetSpends(SpendStatus value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "Treasury/Spends", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.TreasuryStorage.SpendsParams(key));
      }
   }
}
