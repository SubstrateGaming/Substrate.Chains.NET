...
namespace Substrate.Ajuna.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class TechnicalCommitteeMembershipControllerMockupClient : MockupBaseClient, ITechnicalCommitteeMembershipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "TechnicalCommitteeMembership/Prime", value.Encode(), Substrate.Ajuna.NET.NetApiExt.Generated.Storage.TechnicalCommitteeMembershipStorage.PrimeParams());
      }
   }
}
