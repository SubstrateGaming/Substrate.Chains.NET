...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetConversionStorage
    {
        ...
        /// </summary>
        public static string PoolsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId> key)
        {
        ...
        ///  created rather than people sending tokens directly to a pool's public account.
        /// </summary>
        public async Task<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo> Pools(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId> key, string blockhash, CancellationToken token)
        {
            string parameters = AssetConversionStorage.PoolsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class AssetConversionCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset1, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset2)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            return new Method(93, "AssetConversion", 0, "create_pool", byteArray.ToArray());
        }
        ...
        public static Method AddLiquidity(Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset1, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset2, Substrate.NetApi.Model.Types.Primitive.U128 amount1_desired, Substrate.NetApi.Model.Types.Primitive.U128 amount2_desired, Substrate.NetApi.Model.Types.Primitive.U128 amount1_min, Substrate.NetApi.Model.Types.Primitive.U128 amount2_min, Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 mint_to)
        {
            ...
            return new Method(93, "AssetConversion", 1, "add_liquidity", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method RemoveLiquidity(Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset1, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset2, Substrate.NetApi.Model.Types.Primitive.U128 lp_token_burn, Substrate.NetApi.Model.Types.Primitive.U128 amount1_min_receive, Substrate.NetApi.Model.Types.Primitive.U128 amount2_min_receive, Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 withdraw_to)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            ...
            return new Method(93, "AssetConversion", 2, "remove_liquidity", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method SwapExactTokensForTokens(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId> path, Substrate.NetApi.Model.Types.Primitive.U128 amount_in, Substrate.NetApi.Model.Types.Primitive.U128 amount_out_min, Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 send_to, Substrate.NetApi.Model.Types.Primitive.Bool keep_alive)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            ...
            return new Method(93, "AssetConversion", 3, "swap_exact_tokens_for_tokens", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method SwapTokensForExactTokens(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId> path, Substrate.NetApi.Model.Types.Primitive.U128 amount_out, Substrate.NetApi.Model.Types.Primitive.U128 amount_in_max, Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 send_to, Substrate.NetApi.Model.Types.Primitive.Bool keep_alive)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(path.Encode());
            ...
            byteArray.AddRange(send_to.Encode());
            byteArray.AddRange(keep_alive.Encode());
            return new Method(93, "AssetConversion", 4, "swap_tokens_for_exact_tokens", byteArray.ToArray());
        }
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method Touch(Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset1, Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId asset2)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
            return new Method(93, "AssetConversion", 5, "touch", byteArray.ToArray());
        }
    }
    ...
    public sealed class AssetConversionConstants
    {
        ...
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId PoolSetupFeeAsset()
        {
            var result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.traits.tokens.fungible.union_of.EnumNativeOrWithId();
            result.Create("0x00");
            return result;
        }
        ...
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill LiquidityWithdrawalFee()
        {
            var result = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
