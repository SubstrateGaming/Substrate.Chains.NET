...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.staging_xcm.v4
{
    ...
    /// <summary>
    /// >> 99 - Composite[staging_xcm.v4.QueryResponseInfo]
    /// </summary>
    ...
    public sealed class QueryResponseInfo : BaseType
    {
        ...
        /// >> destination
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location Destination { get; set; }
        /// <summary>
        /// >> query_id
        /// </summary>
        ...
        {
            var start = p;
            Destination = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location();
            ...
            MaxWeight = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
