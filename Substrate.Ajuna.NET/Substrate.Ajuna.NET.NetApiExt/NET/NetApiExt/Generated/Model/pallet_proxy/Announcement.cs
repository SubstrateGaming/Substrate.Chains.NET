...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_proxy
{
    ...
    /// <summary>
    /// >> 287 - Composite[pallet_proxy.Announcement]
    /// </summary>
    ...
    public sealed class Announcement : BaseType
    {
        ...
        {
            var start = p;
            Real = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256();
