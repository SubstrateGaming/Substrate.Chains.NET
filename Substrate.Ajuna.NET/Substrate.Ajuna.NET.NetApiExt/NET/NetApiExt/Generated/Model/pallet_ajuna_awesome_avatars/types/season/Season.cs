...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.season
{
    
    
    /// <summary>
    /// >> 150 - Composite[pallet_ajuna_awesome_avatars.types.season.Season]
    /// </summary>
    ...
    public sealed class Season : BaseType
    {
        ...
        /// >> tiers
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5 Tiers { get; set; }
        /// <summary>
        /// >> single_mint_probs
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 SingleMintProbs { get; set; }
        /// <summary>
        /// >> batch_mint_probs
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6 BatchMintProbs { get; set; }
        /// <summary>
        /// >> base_prob
        /// </summary>
        ...
        /// >> fee
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee Fee { get; set; }
        /// <summary>
        /// >> mint_logic
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration MintLogic { get; set; }
        /// <summary>
        /// >> forge_logic
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration ForgeLogic { get; set; }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Tiers = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            Tiers.Decode(byteArray, ref p);
            SingleMintProbs = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            SingleMintProbs.Decode(byteArray, ref p);
            BatchMintProbs = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6();
            ...
            Fee = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.fee.Fee();
            Fee.Decode(byteArray, ref p);
            MintLogic = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
            MintLogic.Decode(byteArray, ref p);
            ForgeLogic = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.avatar.EnumLogicGeneration();
