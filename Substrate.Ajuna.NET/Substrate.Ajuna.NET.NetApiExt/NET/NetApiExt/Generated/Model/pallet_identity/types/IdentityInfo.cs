...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 186 - Composite[pallet_identity.types.IdentityInfo]
    /// </summary>
    ...
    public sealed class IdentityInfo : BaseType
    {
        ...
        {
            var start = p;
            Additional = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT5();
            ...
            Legal = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
            Legal.Decode(byteArray, ref p);
            Web = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
            Web.Decode(byteArray, ref p);
            Riot = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
            Riot.Decode(byteArray, ref p);
            Email = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
            Email.Decode(byteArray, ref p);
            PgpFingerprint = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Ajuna.NET.NetApiExt.Generated.Types.Base.Arr20U8>();
            PgpFingerprint.Decode(byteArray, ref p);
            Image = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
            Image.Decode(byteArray, ref p);
            Twitter = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_identity.types.EnumData();
