...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.polkadot_primitives.v4
{
    ...
    /// <summary>
    /// >> 139 - Composite[polkadot_primitives.v4.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        {
            var start = p;
            ParentHead = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
