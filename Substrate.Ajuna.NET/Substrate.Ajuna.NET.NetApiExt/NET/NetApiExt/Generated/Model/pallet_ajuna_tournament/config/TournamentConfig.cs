...
namespace Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config
{
    
    
    /// <summary>
    /// >> 411 - Composite[pallet_ajuna_tournament.config.TournamentConfig]
    /// </summary>
    ...
    public sealed class TournamentConfig : BaseType
    {
        ...
        /// >> reward_distribution
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20 RewardDistribution { get; set; }
        /// <summary>
        /// >> golden_duck_config
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumGoldenDuckConfig GoldenDuckConfig { get; set; }
        /// <summary>
        /// >> max_players
        /// </summary>
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            RewardDistribution = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT20();
            RewardDistribution.Decode(byteArray, ref p);
            GoldenDuckConfig = new Substrate.Ajuna.NET.NetApiExt.Generated.Model.pallet_ajuna_tournament.config.EnumGoldenDuckConfig();
