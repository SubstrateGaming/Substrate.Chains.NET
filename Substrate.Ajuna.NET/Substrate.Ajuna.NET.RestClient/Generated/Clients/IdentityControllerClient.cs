...
namespace Substrate.Ajuna.NET.RestClient.Generated.Clients
{
   ...
   public sealed class IdentityControllerClient : BaseClient, IIdentityControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseTuple<U128, BoundedVecT23>>(_httpClient, "identity/subsof", Substrate.Ajuna.NET.NetApiExt.Generated.Storage.IdentityStorage.SubsOfParams(key));
      }
