...
namespace Substrate.Ajuna.NET.RestClient.Generated.Clients
{
   ...
   public sealed class VestingControllerClient : BaseClient, IVestingControllerClient
   {
      ...
      public async Task<BoundedVecT16> GetVestingSchedules(Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT16>(_httpClient, "vesting/vestingschedules", Substrate.Ajuna.NET.NetApiExt.Generated.Storage.VestingStorage.VestingSchedulesParams(key));
      }
