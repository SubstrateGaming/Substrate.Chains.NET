...
namespace Substrate.Ajuna.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerClient
   {
      ...
      Task<U32> GetAssetTraps(Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeAssetTraps(Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<U32> GetSafeXcmVersion();
      Task<bool> SubscribeSafeXcmVersion();
      Task<U32> GetSupportedVersion(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SubscribeSupportedVersion(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<U64> GetVersionNotifiers(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SubscribeVersionNotifiers(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<BaseTuple<U64, Weight, U32>> GetVersionNotifyTargets(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SubscribeVersionNotifyTargets(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<BoundedVecT20> GetVersionDiscoveryQueue();
      ...
      Task<BoundedVecT21> GetLockedFungibles(Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
