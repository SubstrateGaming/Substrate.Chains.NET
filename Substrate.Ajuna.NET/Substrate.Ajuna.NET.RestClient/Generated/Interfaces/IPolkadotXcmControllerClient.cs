...
namespace Substrate.Ajuna.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerClient
   {
      ...
      Task<U32> GetSupportedVersion(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<bool> SubscribeSupportedVersion(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<U64> GetVersionNotifiers(BaseTuple<U32, Substrate.Ajuna.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      ...
      Task<BoundedVecT40> GetLockedFungibles(Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
