...
namespace Substrate.Ajuna.NET.RestService.Generated.Storage
{
    ...
    public interface IAuraStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.storage.weak_bounded_vec.WeakBoundedVecT2 GetAuthorities();
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot();
    }
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.storage.weak_bounded_vec.WeakBoundedVecT2> _authoritiesTypedStorage;
        
        /// <summary>
        /// _currentSlotTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> _currentSlotTypedStorage;
        ...
        {
            this.AuthoritiesTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.storage.weak_bounded_vec.WeakBoundedVecT2>("Aura.Authorities", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.storage.weak_bounded_vec.WeakBoundedVecT2> AuthoritiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlotTypedStorage
        {
            get
            {
        ...
        ///  The current authority set.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.storage.weak_bounded_vec.WeakBoundedVecT2 GetAuthorities()
        {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot()
        {
