...
namespace Substrate.Ajuna.NET.RestService.Generated.Storage
{
    ...
    public interface ISystemStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key);
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1 GetBlockWeight();
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key);
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash();
        
        /// <summary>
        /// >> Digest
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest();
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents();
        ...
        /// </summary>
        Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade();
    ...
    public sealed class SystemStorage : ISystemStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> _accountTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1> _blockWeightTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256> _blockHashTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256> _parentHashTypedStorage;
        
        /// <summary>
        /// _digestTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> _digestTypedStorage;
        
        /// <summary>
        /// _eventsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> _eventsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> _lastRuntimeUpgradeTypedStorage;
        ...
        public SystemStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.BlockWeightTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1>("System.BlockWeight", storageDataProvider, storageChangeDelegates);
            ...
            this.ParentHashTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256>("System.ParentHash", storageDataProvider, storageChangeDelegates);
            this.DigestTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>("System.Digest", storageDataProvider, storageChangeDelegates);
            this.EventsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>("System.Events", storageDataProvider, storageChangeDelegates);
            ...
            this.LastRuntimeUpgradeTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>("System.LastRuntimeUpgrade", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1> BlockWeightTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHashTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> DigestTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> EventsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgradeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhaseTypedStorage
        {
            get
            {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.AccountInfo GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.AccountInfo result))
            {
                return result;
            }
            else
        ...
        ///  The current weight for the block.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_support.weights.PerDispatchClassT1 GetBlockWeight()
        {
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 GetBlockHash(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (BlockHashTypedStorage.Dictionary.TryGetValue(key, out Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
        ...
        ///  Hash of the previous block.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.primitive_types.H256 GetParentHash()
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest GetDigest()
        {
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.EventRecord> GetEvents()
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public Substrate.Ajuna.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo GetLastRuntimeUpgrade()
        {
