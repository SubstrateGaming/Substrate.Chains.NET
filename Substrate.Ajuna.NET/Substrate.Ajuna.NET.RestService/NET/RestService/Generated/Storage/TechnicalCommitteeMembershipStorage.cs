...
namespace Substrate.Ajuna.NET.RestService.Generated.Storage
{
    ...
    public sealed class TechnicalCommitteeMembershipStorage : ITechnicalCommitteeMembershipStorage
    {
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Substrate.Ajuna.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT32>("TechnicalCommitteeMembership.Members", storageDataProvider, storageChangeDelegates);
