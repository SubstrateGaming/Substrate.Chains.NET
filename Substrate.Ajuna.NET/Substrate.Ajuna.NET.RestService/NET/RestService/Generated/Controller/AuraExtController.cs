...
namespace Substrate.Ajuna.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraExtController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("SlotInfo")]
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Ajuna.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot, Substrate.NetApi.Model.Types.Primitive.U32>), 200)]
        [StorageKeyBuilder(typeof(Substrate.Ajuna.NET.NetApiExt.Generated.Storage.AuraExtStorage), "SlotInfoParams")]
