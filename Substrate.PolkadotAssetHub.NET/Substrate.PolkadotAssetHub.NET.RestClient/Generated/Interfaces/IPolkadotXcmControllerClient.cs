...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerClient
   {
      ...
      Task<U32> GetSupportedVersion(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<bool> SubscribeSupportedVersion(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
      Task<U64> GetVersionNotifiers(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key);
