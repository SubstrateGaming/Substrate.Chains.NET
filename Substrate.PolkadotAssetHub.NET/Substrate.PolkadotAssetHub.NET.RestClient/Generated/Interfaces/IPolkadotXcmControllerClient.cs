...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IPolkadotXcmControllerClient
   {
      ...
      Task<U32> GetAssetTraps(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<bool> SubscribeAssetTraps(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.primitive_types.H256 key);
      Task<U32> GetSafeXcmVersion();
      Task<bool> SubscribeSafeXcmVersion();
      Task<U32> GetSupportedVersion(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<bool> SubscribeSupportedVersion(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<U64> GetVersionNotifiers(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<bool> SubscribeVersionNotifiers(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<BaseTuple<U64, Weight, U32>> GetVersionNotifyTargets(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<bool> SubscribeVersionNotifyTargets(BaseTuple<U32, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation> key);
      Task<BoundedVecT18> GetVersionDiscoveryQueue();
      ...
      Task<BoundedVecT20> GetLockedFungibles(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
