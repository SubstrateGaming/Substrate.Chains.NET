...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Generated.Interfaces
{
   ...
   public interface IUniquesControllerClient
   {
      ...
      Task<BaseTuple> GetClassAccount(BaseTuple<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
      Task<bool> SubscribeClassAccount(BaseTuple<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, U32> key);
