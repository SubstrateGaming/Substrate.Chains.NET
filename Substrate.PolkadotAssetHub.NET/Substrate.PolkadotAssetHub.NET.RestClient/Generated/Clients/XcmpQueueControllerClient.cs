...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmpQueueControllerClient : BaseClient, IXcmpQueueControllerClient
   {
      ...
      public async Task<FixedU128> GetDeliveryFeeFactor(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key)
      {
         return await SendRequestAsync<FixedU128>(_httpClient, "xcmpqueue/deliveryfeefactor", Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.DeliveryFeeFactorParams(key));
      }
      public async Task<bool> SubscribeDeliveryFeeFactor(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.DeliveryFeeFactor", Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.DeliveryFeeFactorParams(key));
      }
   }
}
