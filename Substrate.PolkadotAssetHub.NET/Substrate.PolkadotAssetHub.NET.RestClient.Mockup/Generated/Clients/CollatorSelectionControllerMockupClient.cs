...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class CollatorSelectionControllerMockupClient : MockupBaseClient, ICollatorSelectionControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "CollatorSelection/LastAuthoredBlock", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
      public async Task<bool> SetDesiredCandidates(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "CollatorSelection/DesiredCandidates", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.DesiredCandidatesParams());
      }
      public async Task<bool> SetCandidacyBond(U128 value)
      {
         return await SendMockupRequestAsync(_httpClient, "CollatorSelection/CandidacyBond", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.CandidacyBondParams());
      }
   }
}
