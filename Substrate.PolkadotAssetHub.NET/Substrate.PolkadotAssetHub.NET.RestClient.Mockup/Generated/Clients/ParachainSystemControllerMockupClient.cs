...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParachainSystemControllerMockupClient : MockupBaseClient, IParachainSystemControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/PendingValidationCode", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.PendingValidationCodeParams());
      }
      public async Task<bool> SetNewValidationCode(BaseVec<U8> value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/NewValidationCode", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.NewValidationCodeParams());
      }
      public async Task<bool> SetValidationData(PersistedValidationData value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/ValidationData", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.ValidationDataParams());
      }
      public async Task<bool> SetDidSetValidationCode(Bool value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/DidSetValidationCode", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.DidSetValidationCodeParams());
      }
      public async Task<bool> SetLastRelayChainBlockNumber(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/LastRelayChainBlockNumber", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.LastRelayChainBlockNumberParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/RelevantMessagingState", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.RelevantMessagingStateParams());
      }
      public async Task<bool> SetHostConfiguration(AbridgedHostConfiguration value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/HostConfiguration", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.HostConfigurationParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/ProcessedDownwardMessages", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.ProcessedDownwardMessagesParams());
      }
      public async Task<bool> SetHrmpWatermark(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/HrmpWatermark", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.HrmpWatermarkParams());
      }
      public async Task<bool> SetHrmpOutboundMessages(BaseVec<OutboundHrmpMessage> value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/HrmpOutboundMessages", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.HrmpOutboundMessagesParams());
      }
      public async Task<bool> SetUpwardMessages(BaseVec<BaseVec<U8>> value)
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/UpwardMessages", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.UpwardMessagesParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/ReservedXcmpWeightOverride", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.ReservedXcmpWeightOverrideParams());
      }
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainSystem/CustomValidationHeadData", value.Encode(), Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage.ParachainSystemStorage.CustomValidationHeadDataParams());
      }
   }
}
