...
namespace Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_assets.types
{
    ...
    public sealed class EnumExistenceReason : BaseEnumRust<ExistenceReason>
    {
        ...
        public EnumExistenceReason()
        {
				...
				AddTypeDecoder<BaseTuple<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>(ExistenceReason.DepositFrom);
        }
    }
}
