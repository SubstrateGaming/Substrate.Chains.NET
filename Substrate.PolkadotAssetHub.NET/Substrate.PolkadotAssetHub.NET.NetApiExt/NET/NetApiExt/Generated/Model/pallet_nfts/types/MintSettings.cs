...
namespace Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_nfts.types
{
    ...
    /// <summary>
    /// >> 362 - Composite[pallet_nfts.types.MintSettings]
    /// </summary>
    ...
    public sealed class MintSettings : BaseType
    {
        ...
        {
            var start = p;
            MintType = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_nfts.types.EnumMintType();
            ...
            DefaultItemSettings = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_nfts.types.BitFlagsT2();
