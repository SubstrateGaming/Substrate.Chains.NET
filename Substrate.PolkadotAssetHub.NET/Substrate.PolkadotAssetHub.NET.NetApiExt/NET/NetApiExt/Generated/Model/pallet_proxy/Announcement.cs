...
namespace Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_proxy
{
    ...
    /// <summary>
    /// >> 399 - Composite[pallet_proxy.Announcement]
    /// </summary>
    ...
    public sealed class Announcement : BaseType
    {
        ...
        {
            var start = p;
            Real = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.primitive_types.H256();
