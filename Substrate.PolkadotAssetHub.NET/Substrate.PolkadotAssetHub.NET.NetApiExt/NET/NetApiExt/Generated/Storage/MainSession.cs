...
namespace Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SessionStorage
    {
        ...
        public SessionStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.statemint_runtime.SessionKeys)));
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.statemint_runtime.SessionKeys> NextKeys(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            var result = await _client.GetStorageAsync<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.statemint_runtime.SessionKeys>(parameters, token);
            return result;
        }
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.statemint_runtime.SessionKeys keys, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> proof)
        {
