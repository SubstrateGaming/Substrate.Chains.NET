...
namespace Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AssetConversionStorage
    {
        ...
        /// </summary>
        public static string PoolsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> key)
        {
        ...
        ///  created rather than people sending tokens directly to a pool's public account.
        /// </summary>
        public async Task<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo> Pools(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> key, string blockhash, CancellationToken token)
        {
            string parameters = AssetConversionStorage.PoolsParams(key);
            var result = await _client.GetStorageAsync<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_asset_conversion.types.PoolInfo>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class AssetConversionCalls
    {
        ...
        /// </summary>
        public static Method CreatePool(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset1, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset2)
        {
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method RemoveLiquidity(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset1, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset2, Substrate.NetApi.Model.Types.Primitive.U128 lp_token_burn, Substrate.NetApi.Model.Types.Primitive.U128 amount1_min_receive, Substrate.NetApi.Model.Types.Primitive.U128 amount2_min_receive, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 withdraw_to)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method SwapExactTokensForTokens(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location> path, Substrate.NetApi.Model.Types.Primitive.U128 amount_in, Substrate.NetApi.Model.Types.Primitive.U128 amount_out_min, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 send_to, Substrate.NetApi.Model.Types.Primitive.Bool keep_alive)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Pallet's callable functions.
        /// </summary>
        public static Method Touch(Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset1, Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location asset2)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset1.Encode());
            byteArray.AddRange(asset2.Encode());
    ...
    public sealed class AssetConversionConstants
    {
        ...
        /// </summary>
        public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location PoolSetupFeeAsset()
        {
            var result = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.staging_xcm.v4.location.Location();
        ...
        /// </summary>
        public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill LiquidityWithdrawalFee()
        {
            var result = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.frame_support.PalletId PalletId()
        {
            var result = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.frame_support.PalletId();
