...
namespace Substrate.PolkadotAssetHub.NET.RestClient.Test.Generated
{
   ...
   public class MessageQueueControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.BookState GetTestValue2()
      {
         Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.BookState result;
         result = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.BookState();
         result.Begin = this.GetTestValueU32();
         result.End = this.GetTestValueU32();
         result.Count = this.GetTestValueU32();
         result.ReadyNeighbours = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.Neighbours>();
         result.ReadyNeighbours.Create(this.GetTestValue3());
         result.MessageCount = this.GetTestValueU64();
         result.Size = this.GetTestValueU64();
         return result;
      }
      public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.Neighbours GetTestValue3()
      {
      ...
      public async System.Threading.Tasks.Task TestBookStateFor()
      {
         ...
         Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.BookState rpcResult = await rpcClient.GetBookStateFor(mockupKey);
      ...
      public async System.Threading.Tasks.Task TestServiceHead()
      {
         ...
         Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.cumulus_primitives_core.EnumAggregateMessageOrigin rpcResult = await rpcClient.GetServiceHead();
      ...
      public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.Page GetTestValue10()
      {
         ...
         result.Heap = new Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21();
         result.Heap = this.GetTestValue11();
         return result;
      }
      public Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetTestValue11()
      {
      ...
      public async System.Threading.Tasks.Task TestPages()
      {
         ...
         Substrate.PolkadotAssetHub.NET.NetApiExt.Generated.Model.pallet_message_queue.Page rpcResult = await rpcClient.GetPages(mockupKey);
