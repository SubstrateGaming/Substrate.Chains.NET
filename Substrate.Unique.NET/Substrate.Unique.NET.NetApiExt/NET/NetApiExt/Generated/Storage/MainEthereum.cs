...
namespace Substrate.Unique.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class EthereumStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "Pending"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.EnumTransactionV2, Substrate.Unique.NET.NetApiExt.Generated.Model.fp_rpc.TransactionStatus, Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.receipt.EnumReceiptV3>>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "CurrentBlock"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.block.Block)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "CurrentReceipts"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.receipt.EnumReceiptV3>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "CurrentTransactionStatuses"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Unique.NET.NetApiExt.Generated.Model.fp_rpc.TransactionStatus>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "BlockHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256), typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Ethereum", "InjectedNonce"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256)));
        }
        ...
        /// >> BlockHashParams
        /// </summary>
        public static string BlockHashParams(Substrate.Unique.NET.NetApiExt.Generated.Model.primitive_types.U256 key)
        {
