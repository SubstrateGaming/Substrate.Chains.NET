...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction
{
    ...
    /// <summary>
    /// >> 315 - Composite[ethereum.transaction.TransactionSignature]
    /// </summary>
    ...
    public sealed class TransactionSignature : BaseType
    {
        ...
        {
            var start = p;
            V = new Substrate.Unique.NET.NetApiExt.Generated.Model.ethereum.transaction.TransactionRecoveryId();
