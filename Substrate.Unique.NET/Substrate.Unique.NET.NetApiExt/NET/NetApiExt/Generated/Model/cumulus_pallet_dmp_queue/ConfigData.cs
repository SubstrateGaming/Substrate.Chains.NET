...
namespace Substrate.Unique.NET.NetApiExt.Generated.Model.cumulus_pallet_dmp_queue
{
    
    
    /// <summary>
    /// >> 376 - Composite[cumulus_pallet_dmp_queue.ConfigData]
    /// </summary>
    ...
    public sealed class ConfigData : BaseType
    {
        ...
        {
            var start = p;
            MaxIndividual = new Substrate.Unique.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
