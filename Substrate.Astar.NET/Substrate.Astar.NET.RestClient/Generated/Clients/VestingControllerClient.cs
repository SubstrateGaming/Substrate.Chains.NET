...
namespace Substrate.Astar.NET.RestClient.Generated.Clients
{
   ...
   public sealed class VestingControllerClient : BaseClient, IVestingControllerClient
   {
      ...
      public async Task<BoundedVecT7> GetVesting(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<BoundedVecT7>(_httpClient, "vesting/vesting", Substrate.Astar.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
      public async Task<bool> SubscribeVesting(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("Vesting.Vesting", Substrate.Astar.NET.NetApiExt.Generated.Storage.VestingStorage.VestingParams(key));
      }
