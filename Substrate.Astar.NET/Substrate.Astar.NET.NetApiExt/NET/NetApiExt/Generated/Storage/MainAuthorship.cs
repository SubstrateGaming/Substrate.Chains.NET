...
namespace Substrate.Astar.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorshipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Uncles"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT9)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Authorship", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        ...
        ///  Uncles
        /// </summary>
        public async Task<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT9> Uncles(CancellationToken token)
        {
            string parameters = AuthorshipStorage.UnclesParams();
            var result = await _client.GetStorageAsync<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT9>(parameters, token);
            return result;
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
    ...
    public sealed class AuthorshipCalls
    {
        ...
        /// </summary>
        public static Method SetUncles(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_runtime.generic.header.Header> new_uncles)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_uncles.Encode());
            return new Method(40, "Authorship", 0, "set_uncles", byteArray.ToArray());
        }
    }
