...
namespace Substrate.Astar.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class XcAssetConfigStorage
    {
        ...
        public XcAssetConfigStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcAssetConfig", "AssetIdToLocation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U128), typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcAssetConfig", "AssetLocationToId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation), typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
        ...
        ///  like transferring an asset from this chain to another.
        /// </summary>
        public async Task<Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> AssetIdToLocation(Substrate.NetApi.Model.Types.Primitive.U128 key, CancellationToken token)
        {
            string parameters = XcAssetConfigStorage.AssetIdToLocationParams(key);
            var result = await _client.GetStorageAsync<Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string AssetLocationToIdParams(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation key)
        {
        ...
        ///  the corresponding asset in which tokens should me minted.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> AssetLocationToId(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string AssetLocationUnitsPerSecondParams(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation key)
        {
        ...
        ///  Not all asset types are supported for payment. If value exists here, it means it is supported.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> AssetLocationUnitsPerSecond(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation key, CancellationToken token)
        {
    ...
    public sealed class XcAssetConfigCalls
    {
        ...
        /// </summary>
        public static Method RegisterAssetLocation(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation asset_location, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> asset_id)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetAssetUnitsPerSecond(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation asset_location, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> units_per_second)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_location.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ChangeExistingAssetLocation(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation new_asset_location, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> asset_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RemovePaymentAsset(Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation asset_location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(asset_location.Encode());
