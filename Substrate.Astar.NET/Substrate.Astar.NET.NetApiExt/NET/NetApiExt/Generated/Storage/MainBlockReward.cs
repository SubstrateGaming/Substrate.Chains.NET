...
namespace Substrate.Astar.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class BlockRewardStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BlockReward", "RewardDistributionConfigStorage"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_block_reward.RewardDistributionConfig)));
        }
        ...
        /// </summary>
        public async Task<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_block_reward.RewardDistributionConfig> RewardDistributionConfigStorage(CancellationToken token)
        {
            string parameters = BlockRewardStorage.RewardDistributionConfigStorageParams();
            var result = await _client.GetStorageAsync<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_block_reward.RewardDistributionConfig>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class BlockRewardCalls
    {
        ...
        /// </summary>
        public static Method SetConfiguration(Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_block_reward.RewardDistributionConfig reward_distro_params)
        {
    ...
    public sealed class BlockRewardConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Primitive.U128 RewardAmount()
        {
            ...
            result.Create("0x0000DCEB1FC730B80D00000000000000");
            return result;
        }
    }
