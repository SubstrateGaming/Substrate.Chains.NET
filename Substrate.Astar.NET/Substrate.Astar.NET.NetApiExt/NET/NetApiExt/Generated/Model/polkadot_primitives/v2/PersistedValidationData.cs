...
namespace Substrate.Astar.NET.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    
    
    /// <summary>
    /// >> 189 - Composite[polkadot_primitives.v2.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        /// >> parent_head
        /// </summary>
        private Substrate.Astar.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData _parentHead;
        ...
        /// </summary>
        private Substrate.Astar.NET.NetApiExt.Generated.Model.primitive_types.H256 _relayParentStorageRoot;
        ...
        public Substrate.Astar.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData ParentHead
        {
            get
            {
        ...
        public Substrate.Astar.NET.NetApiExt.Generated.Model.primitive_types.H256 RelayParentStorageRoot
        {
            get
            {
        ...
        {
            var start = p;
            ParentHead = new Substrate.Astar.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
            ...
            RelayParentStorageRoot = new Substrate.Astar.NET.NetApiExt.Generated.Model.primitive_types.H256();
