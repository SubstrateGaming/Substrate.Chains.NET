...
namespace Substrate.Astar.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraExtControllerMockupClient : MockupBaseClient, IAuraExtControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/Authorities", value.Encode(), Substrate.Astar.NET.NetApiExt.Generated.Storage.AuraExtStorage.AuthoritiesParams());
      }
   }
}
