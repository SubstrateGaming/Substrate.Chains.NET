...
namespace Substrate.Astar.NET.RestService.Generated.Storage
{
    ...
    public interface ICollatorSelectionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetInvulnerables();
        
        /// <summary>
        /// >> Candidates
        ///  The (community, limited) collation candidates.
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo> GetCandidates();
        ...
        /// </summary>
        Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetSlashDestination();
    }
    ...
    public sealed class CollatorSelectionStorage : ICollatorSelectionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> _invulnerablesTypedStorage;
        
        /// <summary>
        /// _candidatesTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>> _candidatesTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _slashDestinationTypedStorage;
        ...
        {
            this.InvulnerablesTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>("CollatorSelection.Invulnerables", storageDataProvider, storageChangeDelegates);
            this.CandidatesTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>>("CollatorSelection.Candidates", storageDataProvider, storageChangeDelegates);
            ...
            this.SlashDestinationTypedStorage = new TypedStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("CollatorSelection.SlashDestination", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _invulnerablesTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> InvulnerablesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>> CandidatesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> SlashDestinationTypedStorage
        {
            get
            {
        ...
        ///  The invulnerable, fixed collators.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetInvulnerables()
        {
        ...
        ///  The (community, limited) collation candidates.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo> GetCandidates()
        {
        ...
        ///  Destination account for slashed amount.
        /// </summary>
        public Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetSlashDestination()
        {
