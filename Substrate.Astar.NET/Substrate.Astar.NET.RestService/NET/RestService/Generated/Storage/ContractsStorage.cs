...
namespace Substrate.Astar.NET.RestService.Generated.Storage
{
    ...
    public interface IContractsStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.PrefabWasmModule GetCodeStorage(string key);
        
        /// <summary>
        /// >> OwnerInfoOf
        ///  A mapping between an original code hash and its owner information.
        /// </summary>
        Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.OwnerInfo GetOwnerInfoOf(string key);
        ...
        /// </summary>
        Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.storage.ContractInfo GetContractInfoOf(string key);
    ...
    public sealed class ContractsStorage : IContractsStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.PrefabWasmModule> _codeStorageTypedStorage;
        
        /// <summary>
        /// _ownerInfoOfTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.OwnerInfo> _ownerInfoOfTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.storage.ContractInfo> _contractInfoOfTypedStorage;
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.PrefabWasmModule> CodeStorageTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.OwnerInfo> OwnerInfoOfTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.storage.ContractInfo> ContractInfoOfTypedStorage
        {
            get
            {
        ...
        ///  A mapping between an original code hash and instrumented wasm code, ready for execution.
        /// </summary>
        public Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.PrefabWasmModule GetCodeStorage(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (CodeStorageTypedStorage.Dictionary.TryGetValue(key, out Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.PrefabWasmModule result))
            {
                return result;
            }
            else
        ...
        ///  A mapping between an original code hash and its owner information.
        /// </summary>
        public Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.OwnerInfo GetOwnerInfoOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (OwnerInfoOfTypedStorage.Dictionary.TryGetValue(key, out Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.wasm.OwnerInfo result))
            {
                return result;
            }
            else
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.storage.ContractInfo GetContractInfoOf(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ContractInfoOfTypedStorage.Dictionary.TryGetValue(key, out Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_contracts.storage.ContractInfo result))
            {
                return result;
            }
            else
