...
namespace Substrate.Astar.NET.RestService.Generated.Storage
{
    ...
    public interface IXcAssetConfigStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation GetAssetIdToLocation(string key);
    ...
    public sealed class XcAssetConfigStorage : IXcAssetConfigStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> _assetIdToLocationTypedStorage;
        ...
        {
            this.AssetIdToLocationTypedStorage = new TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>("XcAssetConfig.AssetIdToLocation", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> AssetIdToLocationTypedStorage
        {
            get
            {
        ...
        ///  like transferring an asset from this chain to another.
        /// </summary>
        public Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation GetAssetIdToLocation(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetIdToLocationTypedStorage.Dictionary.TryGetValue(key, out Substrate.Astar.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation result))
            {
                return result;
            }
            else
