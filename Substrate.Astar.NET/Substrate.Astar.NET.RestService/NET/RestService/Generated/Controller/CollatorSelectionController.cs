...
namespace Substrate.Astar.NET.RestService.Generated.Controller
{
    ...
    public sealed class CollatorSelectionController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "InvulnerablesParams")]
        ...
        /// </summary>
        [HttpGet("Candidates")]
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Astar.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo>), 200)]
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "LastAuthoredBlockParams", typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32))]
        ...
        [ProducesResponseType(typeof(Substrate.NetApi.Model.Types.Primitive.U32), 200)]
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "DesiredCandidatesParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidacyBondParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "SlashDestinationParams")]
