...
namespace Substrate.Astar.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("CurrentSlot")]
        [ProducesResponseType(typeof(Substrate.Astar.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot), 200)]
        [StorageKeyBuilder(typeof(Substrate.Astar.NET.NetApiExt.Generated.Storage.AuraStorage), "CurrentSlotParams")]
