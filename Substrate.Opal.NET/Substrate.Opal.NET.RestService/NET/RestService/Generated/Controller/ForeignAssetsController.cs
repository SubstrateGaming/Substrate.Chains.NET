...
namespace Substrate.Opal.NET.RestService.Generated.Controller
{
    ...
    public sealed class ForeignAssetsController : ControllerBase
    {
        ...
        [StorageKeyBuilder(typeof(Substrate.Opal.NET.NetApiExt.Generated.Storage.ForeignAssetsStorage), "ForeignAssetToCollectionParams", typeof(Substrate.Opal.NET.NetApiExt.Generated.Model.xcm.v3.multiasset.EnumAssetId))]
        ...
        [ProducesResponseType(typeof(Substrate.Opal.NET.NetApiExt.Generated.Model.xcm.v3.multiasset.EnumAssetId), 200)]
        [StorageKeyBuilder(typeof(Substrate.Opal.NET.NetApiExt.Generated.Storage.ForeignAssetsStorage), "CollectionToForeignAssetParams", typeof(Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.CollectionId))]
        ...
        [ProducesResponseType(typeof(Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.TokenId), 200)]
        [StorageKeyBuilder(typeof(Substrate.Opal.NET.NetApiExt.Generated.Storage.ForeignAssetsStorage), "ForeignReserveAssetInstanceToTokenIdParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.CollectionId, Substrate.Opal.NET.NetApiExt.Generated.Model.xcm.v3.multiasset.EnumAssetInstance>))]
        ...
        [ProducesResponseType(typeof(Substrate.Opal.NET.NetApiExt.Generated.Model.xcm.v3.multiasset.EnumAssetInstance), 200)]
        [StorageKeyBuilder(typeof(Substrate.Opal.NET.NetApiExt.Generated.Storage.ForeignAssetsStorage), "TokenIdToForeignReserveAssetInstanceParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.CollectionId, Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.TokenId>))]
