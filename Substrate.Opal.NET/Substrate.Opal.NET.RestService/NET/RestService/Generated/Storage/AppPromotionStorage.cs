...
namespace Substrate.Opal.NET.RestService.Generated.Storage
{
    ...
    public interface IAppPromotionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAdmin();
        ...
        ///  * **Value** - Amount of stakes.
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 GetPendingUnstake(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> GetPreviousCalculatedRecord();
    }
    ...
    public sealed class AppPromotionStorage : IAppPromotionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _adminTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42> _pendingUnstakeTypedStorage;
        
        /// <summary>
        /// _previousCalculatedRecordTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>> _previousCalculatedRecordTypedStorage;
        ...
        public AppPromotionStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AdminTypedStorage = new TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("AppPromotion.Admin", storageDataProvider, storageChangeDelegates);
            ...
            this.PendingUnstakeTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42>("AppPromotion.PendingUnstake", storageDataProvider, storageChangeDelegates);
            this.PreviousCalculatedRecordTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>>("AppPromotion.PreviousCalculatedRecord", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> AdminTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42> PendingUnstakeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32>> PreviousCalculatedRecordTypedStorage
        {
            get
            {
        ...
        ///  Stores the `admin` account. Some extrinsics can only be executed if they were signed by `admin`.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetAdmin()
        {
        ...
        ///  * **Value** - Amount of stakes.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 GetPendingUnstake(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (PendingUnstakeTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT42 result))
            {
                return result;
            }
            else
        ...
        ///  If `None`, then recalculation has not yet been performed or calculations have been completed for all stakers.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U32> GetPreviousCalculatedRecord()
        {
