...
namespace Substrate.Opal.NET.RestService.Generated.Storage
{
    ...
    public interface ITechnicalCommitteeMembershipStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetMembers();
    ...
    public sealed class TechnicalCommitteeMembershipStorage : ITechnicalCommitteeMembershipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> _membersTypedStorage;
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34>("TechnicalCommitteeMembership.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("TechnicalCommitteeMembership.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _membersTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34> MembersTypedStorage
        {
            get
            {
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT34 GetMembers()
        {
