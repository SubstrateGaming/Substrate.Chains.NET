...
namespace Substrate.Opal.NET.RestService.Generated.Storage
{
    ...
    public interface IEVMStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata GetAccountCodesMetadata(string key);
        
        /// <summary>
        /// >> AccountStorages
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Opal.NET.NetApiExt.Generated.Model.ethereum.log.Log> GetCurrentLogs();
    }
    ...
    public sealed class EVMStorage : IEVMStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata> _accountCodesMetadataTypedStorage;
        
        /// <summary>
        /// _accountStoragesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256> _accountStoragesTypedStorage;
        
        /// <summary>
        /// _currentLogsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Opal.NET.NetApiExt.Generated.Model.ethereum.log.Log>> _currentLogsTypedStorage;
        ...
        public EVMStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountCodesMetadataTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata>("EVM.AccountCodesMetadata", storageDataProvider, storageChangeDelegates);
            this.AccountStoragesTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256>("EVM.AccountStorages", storageDataProvider, storageChangeDelegates);
            this.CurrentLogsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Opal.NET.NetApiExt.Generated.Model.ethereum.log.Log>>("EVM.CurrentLogs", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata> AccountCodesMetadataTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256> AccountStoragesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Opal.NET.NetApiExt.Generated.Model.ethereum.log.Log>> CurrentLogsTypedStorage
        {
            get
            {
        ...
        /// >> AccountCodesMetadata
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata GetAccountCodesMetadata(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountCodesMetadataTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.CodeMetadata result))
            {
                return result;
            }
            else
        ...
        /// >> AccountStorages
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountStoragesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
        ...
        ///  Should be empty between transactions
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Opal.NET.NetApiExt.Generated.Model.ethereum.log.Log> GetCurrentLogs()
        {
