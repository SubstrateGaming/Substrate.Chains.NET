...
namespace Substrate.Opal.NET.RestService.Generated.Storage
{
    ...
    public interface INonfungibleStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData GetTokenData(string key);
        ...
        ///  Currently unused.
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 GetTokenAuxProperties(string key);
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr GetAllowance(string key);
    ...
    public sealed class NonfungibleStorage : INonfungibleStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData> _tokenDataTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41> _tokenAuxPropertiesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr> _allowanceTypedStorage;
        ...
        public NonfungibleStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.TokenDataTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData>("Nonfungible.TokenData", storageDataProvider, storageChangeDelegates);
            this.TokenPropertiesTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.PropertiesT2>("Nonfungible.TokenProperties", storageDataProvider, storageChangeDelegates);
            this.TokenAuxPropertiesTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41>("Nonfungible.TokenAuxProperties", storageDataProvider, storageChangeDelegates);
            ...
            this.AllowanceTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr>("Nonfungible.Allowance", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData> TokenDataTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41> TokenAuxPropertiesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr> AllowanceTypedStorage
        {
            get
            {
        ...
        ///  Token data, used to partially describe a token.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData GetTokenData(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TokenDataTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_nonfungible.ItemData result))
            {
                return result;
            }
            else
        ...
        ///  Currently unused.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 GetTokenAuxProperties(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (TokenAuxPropertiesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT41 result))
            {
                return result;
            }
            else
        ...
        ///  Allowance set by a token owner for another user to perform one of certain transactions on a token.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr GetAllowance(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AllowanceTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm.account.EnumBasicCrossAccountIdRepr result))
            {
                return result;
            }
            else
