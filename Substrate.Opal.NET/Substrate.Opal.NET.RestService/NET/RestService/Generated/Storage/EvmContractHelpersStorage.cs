...
namespace Substrate.Opal.NET.RestService.Generated.Storage
{
    ...
    public interface IEvmContractHelpersStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160 GetOwner(string key);
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState GetSponsoring(string key);
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT GetSponsoringMode(string key);
        ...
        /// </summary>
        Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4 GetSponsoringFeeLimit(string key);
    ...
    public sealed class EvmContractHelpersStorage : IEvmContractHelpersStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160> _ownerTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState> _sponsoringTypedStorage;
        
        /// <summary>
        /// _sponsoringModeTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT> _sponsoringModeTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4> _sponsoringFeeLimitTypedStorage;
        ...
        {
            this.OwnerTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160>("EvmContractHelpers.Owner", storageDataProvider, storageChangeDelegates);
            ...
            this.SponsoringTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState>("EvmContractHelpers.Sponsoring", storageDataProvider, storageChangeDelegates);
            this.SponsoringModeTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT>("EvmContractHelpers.SponsoringMode", storageDataProvider, storageChangeDelegates);
            ...
            this.SponsoringFeeLimitTypedStorage = new TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4>("EvmContractHelpers.SponsoringFeeLimit", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160> OwnerTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState> SponsoringTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT> SponsoringModeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4> SponsoringFeeLimitTypedStorage
        {
            get
            {
        ...
        ///  * **Value** - owner for contract.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160 GetOwner(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (OwnerTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160 result))
            {
                return result;
            }
            else
        ...
        ///  * **Value** - sponsorship state.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState GetSponsoring(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SponsoringTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.up_data_structs.EnumSponsorshipState result))
            {
                return result;
            }
            else
        ...
        ///  * **Value** - [`sponsoring mode`](SponsoringModeT).
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT GetSponsoringMode(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SponsoringModeTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.pallet_evm_contract_helpers.EnumSponsoringModeT result))
            {
                return result;
            }
            else
        ...
        ///  * **Value** - last sponsored block number.
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4 GetSponsoringFeeLimit(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (SponsoringFeeLimitTypedStorage.Dictionary.TryGetValue(key, out Substrate.Opal.NET.NetApiExt.Generated.Model.bounded_collections.bounded_btree_map.BoundedBTreeMapT4 result))
            {
                return result;
            }
            else
