...
namespace Substrate.Opal.NET.NetApiExt.Generated.Model.fp_rpc
{
    ...
    public sealed class TransactionStatus : BaseType
    {
        ...
        /// >> transaction_hash
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256 TransactionHash { get; set; }
        /// <summary>
        /// >> transaction_index
        /// </summary>
        ...
        /// >> from
        /// </summary>
        public Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160 From { get; set; }
        /// <summary>
        /// >> to
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160> To { get; set; }
        /// <summary>
        /// >> contract_address
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160> ContractAddress { get; set; }
        /// <summary>
        /// >> logs
        /// </summary>
        ...
        {
            var start = p;
            TransactionHash = new Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H256();
            ...
            From = new Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160();
            From.Decode(byteArray, ref p);
            To = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160>();
            To.Decode(byteArray, ref p);
            ContractAddress = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Opal.NET.NetApiExt.Generated.Model.primitive_types.H160>();
