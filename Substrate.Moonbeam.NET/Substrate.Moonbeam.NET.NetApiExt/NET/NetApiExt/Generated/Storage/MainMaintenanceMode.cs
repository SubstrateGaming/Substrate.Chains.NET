...
namespace Substrate.Moonbeam.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class MaintenanceModeCalls
    {
        ...
        public static Method EnterMaintenanceMode()
        {
            ...
            return new Method(32, "MaintenanceMode", 0, "enter_maintenance_mode", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(32, "MaintenanceMode", 1, "resume_normal_operation", byteArray.ToArray());
        }
    }
