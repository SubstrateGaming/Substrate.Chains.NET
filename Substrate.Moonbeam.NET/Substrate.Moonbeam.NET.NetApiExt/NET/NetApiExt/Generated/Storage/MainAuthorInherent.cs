...
namespace Substrate.Moonbeam.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorInherentStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AuthorInherent", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20)));
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20> Author(CancellationToken token)
        {
    ...
    public sealed class AuthorInherentCalls
    {
        ...
        public static Method KickOffAuthorshipValidation()
        {
            ...
            return new Method(21, "AuthorInherent", 0, "kick_off_authorship_validation", byteArray.ToArray());
        }
    }
