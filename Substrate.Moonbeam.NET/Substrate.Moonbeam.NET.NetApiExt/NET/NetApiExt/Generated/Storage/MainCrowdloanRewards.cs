...
namespace Substrate.Moonbeam.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class CrowdloanRewardsStorage
    {
        ...
        public CrowdloanRewardsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CrowdloanRewards", "AccountsPayable"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20), typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_crowdloan_rewards.pallet.RewardInfo)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CrowdloanRewards", "ClaimedRelayChainIds"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CrowdloanRewards", "UnassociatedContributions"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8), typeof(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_crowdloan_rewards.pallet.RewardInfo)));
        ...
        /// </summary>
        public static string AccountsPayableParams(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 key)
        {
        ...
        /// >> AccountsPayable
        /// </summary>
        public async Task<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_crowdloan_rewards.pallet.RewardInfo> AccountsPayable(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 key, CancellationToken token)
        {
            string parameters = CrowdloanRewardsStorage.AccountsPayableParams(key);
            var result = await _client.GetStorageAsync<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_crowdloan_rewards.pallet.RewardInfo>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string ClaimedRelayChainIdsParams(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8 key)
        {
        ...
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> ClaimedRelayChainIds(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string UnassociatedContributionsParams(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8 key)
        {
        ...
        /// </summary>
        public async Task<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_crowdloan_rewards.pallet.RewardInfo> UnassociatedContributions(Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8 key, CancellationToken token)
        {
    ...
    public sealed class CrowdloanRewardsCalls
    {
        ...
        /// </summary>
        public static Method AssociateNativeIdentity(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 reward_account, Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8 relay_account, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_runtime.EnumMultiSignature proof)
        {
            ...
            return new Method(90, "CrowdloanRewards", 0, "associate_native_identity", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ChangeAssociationWithRelayKeys(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 reward_account, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 previous_account, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_runtime.EnumMultiSignature>> proofs)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(reward_account.Encode());
            byteArray.AddRange(previous_account.Encode());
            byteArray.AddRange(proofs.Encode());
            return new Method(90, "CrowdloanRewards", 1, "change_association_with_relay_keys", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(90, "CrowdloanRewards", 2, "claim", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UpdateRewardAddress(Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20 new_reward_account)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_reward_account.Encode());
            return new Method(90, "CrowdloanRewards", 3, "update_reward_address", byteArray.ToArray());
        }
        ...
        public static Method CompleteInitialization(Substrate.NetApi.Model.Types.Primitive.U32 lease_ending_block)
        {
            ...
            return new Method(90, "CrowdloanRewards", 4, "complete_initialization", byteArray.ToArray());
        }
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method InitializeRewardVec(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Moonbeam.NET.NetApiExt.Generated.Types.Base.Arr32U8, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20>, Substrate.NetApi.Model.Types.Primitive.U128>> rewards)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(rewards.Encode());
            return new Method(90, "CrowdloanRewards", 5, "initialize_reward_vec", byteArray.ToArray());
        }
    }
    ...
    public sealed class CrowdloanRewardsConstants
    {
        ...
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill InitializationPayment()
        {
            var result = new Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
        ...
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill RewardAddressRelayVoteThreshold()
        {
            var result = new Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> SignatureNetworkIdentifier()
        {
            ...
            result.Create("0x246D6F6F6E6265616D2D");
            return result;
        }
    }
