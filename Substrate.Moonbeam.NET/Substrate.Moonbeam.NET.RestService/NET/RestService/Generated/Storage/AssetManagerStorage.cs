...
namespace Substrate.Moonbeam.NET.RestService.Generated.Storage
{
    ...
    public interface IAssetManagerStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType GetAssetIdType(string key);
        ...
        ///  the deposit amount
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo GetLocalAssetDeposit(string key);
        
        /// <summary>
        /// >> SupportedFeePaymentAssets
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType> GetSupportedFeePaymentAssets();
    }
    ...
    public sealed class AssetManagerStorage : IAssetManagerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType> _assetIdTypeTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo> _localAssetDepositTypedStorage;
        
        /// <summary>
        /// _supportedFeePaymentAssetsTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType>> _supportedFeePaymentAssetsTypedStorage;
        ...
        {
            this.AssetIdTypeTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType>("AssetManager.AssetIdType", storageDataProvider, storageChangeDelegates);
            ...
            this.LocalAssetDepositTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo>("AssetManager.LocalAssetDeposit", storageDataProvider, storageChangeDelegates);
            this.SupportedFeePaymentAssetsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType>>("AssetManager.SupportedFeePaymentAssets", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _assetIdTypeTypedStorage property
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType> AssetIdTypeTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo> LocalAssetDepositTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType>> SupportedFeePaymentAssetsTypedStorage
        {
            get
            {
        ...
        ///  like transferring an asset from this chain to another.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType GetAssetIdType(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AssetIdTypeTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType result))
            {
                return result;
            }
            else
        ...
        ///  the deposit amount
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo GetLocalAssetDeposit(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LocalAssetDepositTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_asset_manager.pallet.AssetInfo result))
            {
                return result;
            }
            else
        ...
        /// >> SupportedFeePaymentAssets
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.xcm_config.EnumAssetType> GetSupportedFeePaymentAssets()
        {
