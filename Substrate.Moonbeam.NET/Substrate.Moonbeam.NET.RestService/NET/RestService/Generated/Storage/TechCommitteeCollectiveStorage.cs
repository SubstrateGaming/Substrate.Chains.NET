...
namespace Substrate.Moonbeam.NET.RestService.Generated.Storage
{
    ...
    /// <summary>
    /// ITechCommitteeCollectiveStorage interface definition.
    /// </summary>
    public interface ITechCommitteeCollectiveStorage : IStorage
    {
    ...
    /// <summary>
    /// TechCommitteeCollectiveStorage class definition.
    /// </summary>
    public sealed class TechCommitteeCollectiveStorage : ITechCommitteeCollectiveStorage
    {
        ...
        /// <summary>
        /// TechCommitteeCollectiveStorage constructor.
        /// </summary>
        public TechCommitteeCollectiveStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            this.ProposalsTypedStorage = new TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT13>("TechCommitteeCollective.Proposals", storageDataProvider, storageChangeDelegates);
            this.ProposalOfTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.moonbeam_runtime.EnumRuntimeCall>("TechCommitteeCollective.ProposalOf", storageDataProvider, storageChangeDelegates);
            this.VotingTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_collective.Votes>("TechCommitteeCollective.Voting", storageDataProvider, storageChangeDelegates);
            this.ProposalCountTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Primitive.U32>("TechCommitteeCollective.ProposalCount", storageDataProvider, storageChangeDelegates);
            this.MembersTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20>>("TechCommitteeCollective.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.account.AccountId20>("TechCommitteeCollective.Prime", storageDataProvider, storageChangeDelegates);
        }
        ...
        {
            await ProposalsTypedStorage.InitializeAsync("TechCommitteeCollective", "Proposals");
            await ProposalOfTypedStorage.InitializeAsync("TechCommitteeCollective", "ProposalOf");
            await VotingTypedStorage.InitializeAsync("TechCommitteeCollective", "Voting");
            await ProposalCountTypedStorage.InitializeAsync("TechCommitteeCollective", "ProposalCount");
            await MembersTypedStorage.InitializeAsync("TechCommitteeCollective", "Members");
            await PrimeTypedStorage.InitializeAsync("TechCommitteeCollective", "Prime");
        }
        
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.Proposals
        /// </summary>
        [StorageChange("TechCommitteeCollective", "Proposals")]
        ...
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.ProposalOf
        /// </summary>
        [StorageChange("TechCommitteeCollective", "ProposalOf")]
        ...
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.Voting
        /// </summary>
        [StorageChange("TechCommitteeCollective", "Voting")]
        ...
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.ProposalCount
        /// </summary>
        [StorageChange("TechCommitteeCollective", "ProposalCount")]
        ...
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.Members
        /// </summary>
        [StorageChange("TechCommitteeCollective", "Members")]
        ...
        /// <summary>
        /// Implements any storage change for TechCommitteeCollective.Prime
        /// </summary>
        [StorageChange("TechCommitteeCollective", "Prime")]
