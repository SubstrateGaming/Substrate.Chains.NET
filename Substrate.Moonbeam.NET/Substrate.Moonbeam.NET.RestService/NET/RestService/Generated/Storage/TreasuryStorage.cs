...
namespace Substrate.Moonbeam.NET.RestService.Generated.Storage
{
    ...
    public interface ITreasuryStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key);
        ...
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 GetApprovals();
    }
    ...
    public sealed class TreasuryStorage : ITreasuryStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> _proposalsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15> _approvalsTypedStorage;
        ...
        public TreasuryStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ProposalsTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>("Treasury.Proposals", storageDataProvider, storageChangeDelegates);
            ...
            this.ApprovalsTypedStorage = new TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15>("Treasury.Approvals", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> ProposalsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15> ApprovalsTypedStorage
        {
            get
            {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal GetProposals(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ProposalsTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal result))
            {
                return result;
            }
            else
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT15 GetApprovals()
        {
