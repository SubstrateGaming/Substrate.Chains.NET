...
namespace Substrate.Moonbeam.NET.RestService.Generated.Storage
{
    ...
    public interface IEVMStorage : IStorage
    {
        ...
        /// >> AccountStorages
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key);
    }
    ...
    public sealed class EVMStorage : IEVMStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256> _accountStoragesTypedStorage;
        ...
        public EVMStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountStoragesTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256>("EVM.AccountStorages", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256> AccountStoragesTypedStorage
        {
            get
            {
        ...
        /// >> AccountStorages
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256 GetAccountStorages(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountStoragesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.primitive_types.H256 result))
            {
                return result;
            }
            else
