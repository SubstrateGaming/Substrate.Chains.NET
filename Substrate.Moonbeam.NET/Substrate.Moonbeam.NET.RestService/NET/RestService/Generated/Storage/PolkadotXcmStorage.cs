...
namespace Substrate.Moonbeam.NET.RestService.Generated.Storage
{
    ...
    public interface IPolkadotXcmStorage : IStorage
    {
        ...
        ///  The ongoing queries.
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus GetQueries(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> GetVersionNotifyTargets(string key);
        ...
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT16 GetVersionDiscoveryQueue();
        
        /// <summary>
        /// >> CurrentMigration
        ///  The current migration's stage, if any.
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage GetCurrentMigration();
        
        /// <summary>
        /// >> RemoteLockedFungibles
        ///  Fungible assets which we know are locked on a remote chain.
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord GetRemoteLockedFungibles(string key);
        
        /// <summary>
        /// >> LockedFungibles
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 GetLockedFungibles(string key);
    }
    ...
    public sealed class PolkadotXcmStorage : IPolkadotXcmStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> _queriesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>> _versionNotifyTargetsTypedStorage;
        
        /// <summary>
        /// _versionDiscoveryQueueTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT16> _versionDiscoveryQueueTypedStorage;
        
        /// <summary>
        /// _currentMigrationTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> _currentMigrationTypedStorage;
        
        /// <summary>
        /// _remoteLockedFungiblesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord> _remoteLockedFungiblesTypedStorage;
        
        /// <summary>
        /// _lockedFungiblesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17> _lockedFungiblesTypedStorage;
        ...
        public PolkadotXcmStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.QueriesTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus>("PolkadotXcm.Queries", storageDataProvider, storageChangeDelegates);
            ...
            this.VersionNotifyTargetsTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>>("PolkadotXcm.VersionNotifyTargets", storageDataProvider, storageChangeDelegates);
            this.VersionDiscoveryQueueTypedStorage = new TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT16>("PolkadotXcm.VersionDiscoveryQueue", storageDataProvider, storageChangeDelegates);
            this.CurrentMigrationTypedStorage = new TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage>("PolkadotXcm.CurrentMigration", storageDataProvider, storageChangeDelegates);
            this.RemoteLockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord>("PolkadotXcm.RemoteLockedFungibles", storageDataProvider, storageChangeDelegates);
            this.LockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17>("PolkadotXcm.LockedFungibles", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> QueriesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>> VersionNotifyTargetsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT16> VersionDiscoveryQueueTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> CurrentMigrationTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord> RemoteLockedFungiblesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17> LockedFungiblesTypedStorage
        {
            get
            {
        ...
        ///  The ongoing queries.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus GetQueries(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (QueriesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus result))
            {
                return result;
            }
            else
        ...
        ///  of our versions we informed them of.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> GetVersionNotifyTargets(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VersionNotifyTargetsTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> result))
            {
                return result;
            }
            else
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT16 GetVersionDiscoveryQueue()
        {
        ...
        ///  The current migration's stage, if any.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage GetCurrentMigration()
        {
        ...
        ///  Fungible assets which we know are locked on a remote chain.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord GetRemoteLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RemoteLockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord result))
            {
                return result;
            }
            else
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 GetLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Moonbeam.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT17 result))
            {
                return result;
            }
            else
