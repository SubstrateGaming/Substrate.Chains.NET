...
namespace Substrate.Statemint.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CollatorSelectionControllerClient : BaseClient, ICollatorSelectionControllerClient
   {
      ...
      public async Task<U32> GetLastAuthoredBlock(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "collatorselection/lastauthoredblock", Substrate.Statemint.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
      public async Task<bool> SubscribeLastAuthoredBlock(Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("CollatorSelection.LastAuthoredBlock", Substrate.Statemint.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
