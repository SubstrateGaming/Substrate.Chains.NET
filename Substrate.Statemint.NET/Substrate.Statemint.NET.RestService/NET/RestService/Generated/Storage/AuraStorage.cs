...
namespace Substrate.Statemint.NET.RestService.Generated.Storage
{
    ...
    public interface IAuraStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot();
    }
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> _currentSlotTypedStorage;
        ...
        /// </summary>
        public TypedStorage<Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlotTypedStorage
        {
            get
            {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot()
        {
