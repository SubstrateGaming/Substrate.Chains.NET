...
namespace Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    public sealed class OutboundChannelDetails : BaseType
    {
        ...
        /// >> recipient
        /// </summary>
        private Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id _recipient;
        
        /// <summary>
        /// >> state
        /// </summary>
        private Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState _state;
        ...
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id Recipient
        {
            get
            {
        ...
        public Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState State
        {
            get
            {
                return this._state;
        ...
        {
            var start = p;
            Recipient = new Substrate.Statemint.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id();
            Recipient.Decode(byteArray, ref p);
            State = new Substrate.Statemint.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue.EnumOutboundState();
