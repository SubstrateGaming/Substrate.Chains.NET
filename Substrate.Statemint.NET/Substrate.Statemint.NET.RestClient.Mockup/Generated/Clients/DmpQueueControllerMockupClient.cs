...
namespace Substrate.Statemint.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class DmpQueueControllerMockupClient : MockupBaseClient, IDmpQueueControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "DmpQueue/Configuration", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.DmpQueueStorage.ConfigurationParams());
      }
      public async Task<bool> SetPageIndex(PageIndexData value)
      {
         return await SendMockupRequestAsync(_httpClient, "DmpQueue/PageIndex", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.DmpQueueStorage.PageIndexParams());
      }
      public async Task<bool> SetPages(BaseVec<BaseTuple<U32, BaseVec<U8>>> value, U32 key)
      {
         return await SendMockupRequestAsync(_httpClient, "DmpQueue/Pages", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.DmpQueueStorage.PagesParams(key));
      }
