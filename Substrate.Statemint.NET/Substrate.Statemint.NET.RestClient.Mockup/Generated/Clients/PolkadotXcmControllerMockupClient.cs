...
namespace Substrate.Statemint.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class PolkadotXcmControllerMockupClient : MockupBaseClient, IPolkadotXcmControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "PolkadotXcm/QueryCounter", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.PolkadotXcmStorage.QueryCounterParams());
      }
      public async Task<bool> SetQueries(EnumQueryStatus value, U64 key)
      {
         return await SendMockupRequestAsync(_httpClient, "PolkadotXcm/Queries", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.PolkadotXcmStorage.QueriesParams(key));
      }
      public async Task<bool> SetAssetTraps(U32 value, Substrate.Statemint.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
      {
         return await SendMockupRequestAsync(_httpClient, "PolkadotXcm/AssetTraps", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.PolkadotXcmStorage.AssetTrapsParams(key));
      }
      public async Task<bool> SetSafeXcmVersion(U32 value)
      {
         return await SendMockupRequestAsync(_httpClient, "PolkadotXcm/SafeXcmVersion", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.PolkadotXcmStorage.SafeXcmVersionParams());
      }
      public async Task<bool> SetSupportedVersion(U32 value, BaseTuple<U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key)
      {
         return await SendMockupRequestAsync(_httpClient, "PolkadotXcm/SupportedVersion", value.Encode(), Substrate.Statemint.NET.NetApiExt.Generated.Storage.PolkadotXcmStorage.SupportedVersionParams(key));
      }
      public async Task<bool> SetVersionNotifiers(U64 value, BaseTuple<U32, Substrate.Statemint.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key)
      {
