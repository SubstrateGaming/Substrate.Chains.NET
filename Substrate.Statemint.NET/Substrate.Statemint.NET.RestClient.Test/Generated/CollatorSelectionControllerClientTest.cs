...
namespace Substrate.Statemint.NET.RestClient.Test.Generated
{
   ...
   public class CollatorSelectionControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo GetTestValue6()
      {
         Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo result;
         result = new Substrate.Statemint.NET.NetApiExt.Generated.Model.pallet_collator_selection.pallet.CandidateInfo();
         result.Who = new Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Who = this.GetTestValue7();
         result.Deposit = this.GetTestValueU128();
         return result;
      }
      public Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetTestValue7()
      {
         Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result;
         result = new Substrate.Statemint.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
         result.Value = new Substrate.Statemint.NET.NetApiExt.Generated.Types.Base.Arr32U8();
