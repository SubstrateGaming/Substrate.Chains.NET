...
namespace Substrate.PolkadotBridgeHub.NET.RestClient
{
   ...
   public sealed class Client
   {
      ...
      public IBridgeKusamaGrandpaControllerClient BridgeKusamaGrandpaControllerClient;
      public IBridgeKusamaMessagesControllerClient BridgeKusamaMessagesControllerClient;
      public IBridgeKusamaParachainsControllerClient BridgeKusamaParachainsControllerClient;
      public IBridgeRelayersControllerClient BridgeRelayersControllerClient;
      public ICollatorSelectionControllerClient CollatorSelectionControllerClient;
      public IEthereumBeaconClientControllerClient EthereumBeaconClientControllerClient;
      public IEthereumInboundQueueControllerClient EthereumInboundQueueControllerClient;
      public IEthereumOutboundQueueControllerClient EthereumOutboundQueueControllerClient;
      public IEthereumSystemControllerClient EthereumSystemControllerClient;
      ...
      public Client(HttpClient httpClient, BaseSubscriptionClient subscriptionClient)
      {
         ...
         BridgeKusamaGrandpaControllerClient = new BridgeKusamaGrandpaControllerClient(_httpClient, _subscriptionClient);
         BridgeKusamaMessagesControllerClient = new BridgeKusamaMessagesControllerClient(_httpClient, _subscriptionClient);
         BridgeKusamaParachainsControllerClient = new BridgeKusamaParachainsControllerClient(_httpClient, _subscriptionClient);
         BridgeRelayersControllerClient = new BridgeRelayersControllerClient(_httpClient, _subscriptionClient);
         CollatorSelectionControllerClient = new CollatorSelectionControllerClient(_httpClient, _subscriptionClient);
         EthereumBeaconClientControllerClient = new EthereumBeaconClientControllerClient(_httpClient, _subscriptionClient);
         EthereumInboundQueueControllerClient = new EthereumInboundQueueControllerClient(_httpClient, _subscriptionClient);
         EthereumOutboundQueueControllerClient = new EthereumOutboundQueueControllerClient(_httpClient, _subscriptionClient);
         EthereumSystemControllerClient = new EthereumSystemControllerClient(_httpClient, _subscriptionClient);
