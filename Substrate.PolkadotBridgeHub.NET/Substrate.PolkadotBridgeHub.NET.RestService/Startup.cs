...
using Substrate.PolkadotBridgeHub.NET.RestService.Formatters;
...
namespace Substrate.PolkadotBridgeHub.NET.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         else
         {
            ...
            _storageDataProvider = new SubstrateDataProvider(Environment.GetEnvironmentVariable("SUBSTRATE_WEBSOCKET_ENDPOINT") ?? "wss://polkadot-bridge-hub-rpc.polkadot.io");
         }
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Substrate.PolkadotBridgeHub.NET.RestService", Version = "v1" });
         });
      }
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Substrate.PolkadotBridgeHub.NET.RestService v1");
             }
         );
