...
namespace Substrate.PolkadotBridgeHub.NET.RestService.Generated.Storage
{
    ...
    public interface IAuraStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot();
    }
    ...
    public sealed class AuraStorage : IAuraStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> _currentSlotTypedStorage;
        ...
        /// </summary>
        public TypedStorage<Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlotTypedStorage
        {
            get
            {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot GetCurrentSlot()
        {
