...
namespace Substrate.PolkadotBridgeHub.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class ParachainInfoControllerMockupClient : MockupBaseClient, IParachainInfoControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "ParachainInfo/ParachainId", value.Encode(), Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Storage.ParachainInfoStorage.ParachainIdParams());
      }
   }
}
