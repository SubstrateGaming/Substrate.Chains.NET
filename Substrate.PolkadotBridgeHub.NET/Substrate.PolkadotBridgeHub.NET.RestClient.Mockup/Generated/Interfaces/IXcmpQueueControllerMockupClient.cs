...
namespace Substrate.PolkadotBridgeHub.NET.RestClient.Mockup.Generated.Interfaces
{
   ...
   public interface IXcmpQueueControllerMockupClient
   {
      ...
      Task<bool> SetOutboundXcmpMessages(BaseVec<U8> value, BaseTuple<Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id, U16> key);
      Task<bool> SetSignalMessages(BaseVec<U8> value, Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.polkadot_parachain_primitives.primitives.Id key);
