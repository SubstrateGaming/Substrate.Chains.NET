...
namespace Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.frame_system.limits
{
    ...
    /// <summary>
    /// >> 182 - Composite[frame_system.limits.BlockWeights]
    /// </summary>
    ...
    public sealed class BlockWeights : BaseType
    {
        ...
        {
            var start = p;
            BaseBlock = new Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            BaseBlock.Decode(byteArray, ref p);
            MaxBlock = new Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            MaxBlock.Decode(byteArray, ref p);
            PerClass = new Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT2();
