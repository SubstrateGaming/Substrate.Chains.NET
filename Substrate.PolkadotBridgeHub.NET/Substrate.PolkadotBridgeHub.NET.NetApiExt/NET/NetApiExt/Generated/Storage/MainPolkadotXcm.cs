...
namespace Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class PolkadotXcmCalls
    {
        ...
        /// </summary>
        public static Method Send(Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedXcm message)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceXcmVersion(Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.v3.multilocation.MultiLocation location, Substrate.NetApi.Model.Types.Primitive.U32 xcm_version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceSubscribeVersionNotify(Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceUnsubscribeVersionNotify(Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method LimitedReserveTransferAssets(Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation beneficiary, Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.EnumVersionedMultiAssets assets, Substrate.NetApi.Model.Types.Primitive.U32 fee_asset_item, Substrate.PolkadotBridgeHub.NET.NetApiExt.Generated.Model.xcm.v3.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
