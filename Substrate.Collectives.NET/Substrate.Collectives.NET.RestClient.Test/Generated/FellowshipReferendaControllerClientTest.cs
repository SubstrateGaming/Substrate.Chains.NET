...
namespace Substrate.Collectives.NET.RestClient.Test.Generated
{
   ...
   public class FellowshipReferendaControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.EnumReferendumInfo GetTestValue3()
      {
         ...
         result.Create(this.GetTestValueEnum<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.ReferendumInfo>(), this.GetTestValue4());
         return result;
      }
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.ReferendumStatus GetTestValue4()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.ReferendumStatus result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.ReferendumStatus();
         ...
         result.Origin.Create(this.GetTestValueEnum<Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.OriginCaller>(), this.GetTestValue5());
         result.Proposal = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         result.Proposal.Create(this.GetTestValueEnum<Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.Bounded>(), this.GetTestValue6());
         result.Enactment = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime();
         result.Enactment.Create(this.GetTestValueEnum<Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.DispatchTime>(), this.GetTestValueU32());
         result.Submitted = this.GetTestValueU32();
         result.SubmissionDeposit = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit();
         result.SubmissionDeposit = this.GetTestValue7();
         result.DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit>();
         result.DecisionDeposit.Create(this.GetTestValue9());
         result.Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.DecidingStatus>();
         result.Deciding.Create(this.GetTestValue11());
         result.Tally = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumRawOrigin GetTestValue5()
      {
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit GetTestValue7()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetTestValue8()
      {
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit GetTestValue9()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.Deposit();
         result.Who = new Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.DecidingStatus GetTestValue11()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.DecidingStatus result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.DecidingStatus();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally GetTestValue12()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_ranked_collective.Tally();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetTestValue16()
      {
      ...
      public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> GetTestValue17()
      {
         Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> result;
         result = new Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>();
         result.Create(this.GetTestValueU32(), this.GetTestValueU32());
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         FellowshipReferendaControllerClient rpcClient = new FellowshipReferendaControllerClient(_httpClient, subscriptionClient);
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 mockupValue = this.GetTestValue16();
         ...
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
