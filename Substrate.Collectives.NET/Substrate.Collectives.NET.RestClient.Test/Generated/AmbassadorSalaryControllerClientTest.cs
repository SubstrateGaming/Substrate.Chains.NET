...
namespace Substrate.Collectives.NET.RestClient.Test.Generated
{
   ...
   public class AmbassadorSalaryControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestStatus()
      {
         ...
         AmbassadorSalaryControllerMockupClient mockupClient = new AmbassadorSalaryControllerMockupClient(_httpClient);

         // Construct new subscription client to test with.
         var subscriptionClient = CreateSubscriptionClient();

         // Construct new RPC client to test with.
         AmbassadorSalaryControllerClient rpcClient = new AmbassadorSalaryControllerClient(_httpClient, subscriptionClient);
