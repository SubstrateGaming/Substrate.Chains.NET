...
namespace Substrate.Collectives.NET.RestClient.Test.Generated
{
   ...
   public class AmbassadorReferendaControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestReferendumCount()
      {
         ...
         AmbassadorReferendaControllerMockupClient mockupClient = new AmbassadorReferendaControllerMockupClient(_httpClient);

         // Construct new subscription client to test with.
         var subscriptionClient = CreateSubscriptionClient();

         // Construct new RPC client to test with.
         AmbassadorReferendaControllerClient rpcClient = new AmbassadorReferendaControllerClient(_httpClient, subscriptionClient);
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 GetTestValue5()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37();
      ...
      public async System.Threading.Tasks.Task TestTrackQueue()
      {
         ...
         // Construct new RPC client to test with.
         AmbassadorReferendaControllerClient rpcClient = new AmbassadorReferendaControllerClient(_httpClient, subscriptionClient);
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 mockupValue = this.GetTestValue5();
         ...
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37 rpcResult = await rpcClient.GetTrackQueue(mockupKey);
