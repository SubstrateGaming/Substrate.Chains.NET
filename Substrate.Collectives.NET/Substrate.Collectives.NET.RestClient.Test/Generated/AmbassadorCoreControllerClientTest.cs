...
namespace Substrate.Collectives.NET.RestClient.Test.Generated
{
   ...
   public class AmbassadorCoreControllerClientTest : ClientTestBase
   {
      ...
      public async System.Threading.Tasks.Task TestParams()
      {
         ...
         AmbassadorCoreControllerMockupClient mockupClient = new AmbassadorCoreControllerMockupClient(_httpClient);

         // Construct new subscription client to test with.
         var subscriptionClient = CreateSubscriptionClient();

         // Construct new RPC client to test with.
         AmbassadorCoreControllerClient rpcClient = new AmbassadorCoreControllerClient(_httpClient, subscriptionClient);
