...
namespace Substrate.Collectives.NET.RestClient.Test.Generated
{
   ...
   public class SchedulerControllerClientTest : ClientTestBase
   {
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 GetTestValue3()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29();
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded GetTestValue7()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
         // NOT IMPLEMENTED >> Initialize Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded
         return result;
      }
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumOriginCaller GetTestValue9()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumOriginCaller result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumOriginCaller();
         // NOT IMPLEMENTED >> Initialize Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumOriginCaller
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestAgenda()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 mockupValue = this.GetTestValue3();
         ...
         Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT29 rpcResult = await rpcClient.GetAgenda(mockupKey);

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig GetTestValue11()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig();
      ...
      public async System.Threading.Tasks.Task TestRetries()
      {
         ...
         // Construct new RPC client to test with.
         SchedulerControllerClient rpcClient = new SchedulerControllerClient(_httpClient, subscriptionClient);
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig mockupValue = this.GetTestValue11();
         ...
         Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_scheduler.RetryConfig rpcResult = await rpcClient.GetRetries(mockupKey);
      ...
      public Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8 GetTestValue15()
      {
         Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8 result;
         result = new Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8();
         result.Create(new Substrate.NetApi.Model.Types.Primitive.U8[] {
      ...
      public async System.Threading.Tasks.Task TestLookup()
      {
         ...
         Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8 mockupKey = this.GetTestValue15();
