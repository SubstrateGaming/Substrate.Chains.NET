...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_system
{
    ...
    public sealed class EventRecord : BaseType
    {
        ...
        {
            var start = p;
            Phase = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_system.EnumPhase();
            Phase.Decode(byteArray, ref p);
            Event = new Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumRuntimeEvent();
            Event.Decode(byteArray, ref p);
            Topics = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Collectives.NET.NetApiExt.Generated.Model.primitive_types.H256>();
