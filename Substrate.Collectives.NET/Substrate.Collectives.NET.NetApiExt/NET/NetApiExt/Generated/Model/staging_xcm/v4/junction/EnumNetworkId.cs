...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.junction
{
    ...
    public sealed class EnumNetworkId : BaseEnumRust<NetworkId>
    {
        ...
        {
				AddTypeDecoder<Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8>(NetworkId.ByGenesis);
				AddTypeDecoder<BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Types.Base.Arr32U8>>(NetworkId.ByFork);
