...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types
{
    ...
    public sealed class TrackInfo : BaseType
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            MinApproval = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.EnumCurve();
            MinApproval.Decode(byteArray, ref p);
            MinSupport = new Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.EnumCurve();
