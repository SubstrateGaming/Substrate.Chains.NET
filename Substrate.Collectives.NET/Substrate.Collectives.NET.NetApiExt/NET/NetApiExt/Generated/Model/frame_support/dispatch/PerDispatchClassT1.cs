...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.dispatch
{
    ...
    public sealed class PerDispatchClassT1 : BaseType
    {
        ...
        {
            var start = p;
            Normal = new Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            Normal.Decode(byteArray, ref p);
            Operational = new Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
