...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.dispatch
{
    ...
    public sealed class DispatchInfo : BaseType
    {
        ...
        {
            var start = p;
            Weight = new Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            Weight.Decode(byteArray, ref p);
            Class = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumDispatchClass();
            Class.Decode(byteArray, ref p);
            PaysFee = new Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.dispatch.EnumPays();
