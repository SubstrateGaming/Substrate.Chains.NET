...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> FellowshipTreasuryStorage
    /// </summary>
    public sealed class FellowshipTreasuryStorage
    {
        ...
        /// </summary>
        public FellowshipTreasuryStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FellowshipTreasury", "ProposalCount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "ProposalCount", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = FellowshipTreasuryStorage.ProposalCountParams();
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "Proposals", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = FellowshipTreasuryStorage.ProposalsParams(key);
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "Deactivated", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = FellowshipTreasuryStorage.DeactivatedParams();
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "Approvals", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "SpendCount", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = FellowshipTreasuryStorage.SpendCountParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Primitive.U32>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("FellowshipTreasury", "Spends", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = FellowshipTreasuryStorage.SpendsParams(key);
    ...
    public sealed class FellowshipTreasuryCalls
    {
        ...
        public static Method SpendLocal(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            ...
            byteArray.AddRange(beneficiary.Encode());
            return new Method(65, "FellowshipTreasury", 3, "spend_local", byteArray.ToArray());
        }
        ...
        public static Method RemoveApproval(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> proposal_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(proposal_id.Encode());
            return new Method(65, "FellowshipTreasury", 4, "remove_approval", byteArray.ToArray());
        }
        ...
        public static Method Spend(Substrate.Collectives.NET.NetApiExt.Generated.Model.polkadot_runtime_common.impls.EnumVersionedLocatableAsset asset_kind, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.Collectives.NET.NetApiExt.Generated.Model.xcm.EnumVersionedLocation beneficiary, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U32> valid_from)
        {
            ...
            return new Method(65, "FellowshipTreasury", 5, "spend", byteArray.ToArray());
        }
        ...
        public static Method Payout(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(65, "FellowshipTreasury", 6, "payout", byteArray.ToArray());
        }
        ...
        public static Method CheckStatus(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(65, "FellowshipTreasury", 7, "check_status", byteArray.ToArray());
        }
        ...
        public static Method VoidSpend(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(65, "FellowshipTreasury", 8, "void_spend", byteArray.ToArray());
        }
    }
    
    /// <summary>
    /// >> FellowshipTreasuryConstants
    /// </summary>
    public sealed class FellowshipTreasuryConstants
    {
        ...
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.PalletId PalletId()
        {
            ...
            result.Create("0x70792F66656C7472");
            return result;
        }
