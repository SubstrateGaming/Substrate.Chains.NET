...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> AmbassadorSalaryStorage
    /// </summary>
    public sealed class AmbassadorSalaryStorage
    {
        ...
        /// </summary>
        public AmbassadorSalaryStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorSalary", "Status"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_salary.StatusType)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorSalary", "Claimant"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorSalary", "Status", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = AmbassadorSalaryStorage.StatusParams();
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorSalary", "Claimant", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = AmbassadorSalaryStorage.ClaimantParams(key);
    ...
    /// <summary>
    /// >> AmbassadorSalaryCalls
    /// </summary>
    public sealed class AmbassadorSalaryCalls
    {
        ...
        public static Method Init()
        {
            ...
            return new Method(74, "AmbassadorSalary", 0, "init", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(74, "AmbassadorSalary", 1, "bump", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(74, "AmbassadorSalary", 2, "induct", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(74, "AmbassadorSalary", 3, "register", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(74, "AmbassadorSalary", 4, "payout", byteArray.ToArray());
        }
        ...
        public static Method PayoutOther(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 beneficiary)
        {
            ...
            return new Method(74, "AmbassadorSalary", 5, "payout_other", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(74, "AmbassadorSalary", 6, "check_payment", byteArray.ToArray());
        }
    }
    
    /// <summary>
    /// >> AmbassadorSalaryConstants
    /// </summary>
    public sealed class AmbassadorSalaryConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Primitive.U128 Budget()
        {
            ...
            result.Create("0x00B4F9E4300000000000000000000000");
            return result;
        }
    }
    
    /// <summary>
    /// >> AmbassadorSalaryErrors
    /// </summary>
    public enum AmbassadorSalaryErrors
    {
