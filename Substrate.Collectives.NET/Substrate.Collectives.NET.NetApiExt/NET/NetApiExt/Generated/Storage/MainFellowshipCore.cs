...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> FellowshipCoreStorage
    /// </summary>
    public sealed class FellowshipCoreStorage
    {
        ...
        {
            return RequestGenerator.GetStorage("FellowshipCore", "Params", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            return RequestGenerator.GetStorage("FellowshipCore", "Member", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = FellowshipCoreStorage.MemberParams(key);
        ...
        {
            return RequestGenerator.GetStorage("FellowshipCore", "MemberEvidence", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
    ...
    /// >> FellowshipCoreCalls
    /// </summary>
    public sealed class FellowshipCoreCalls
    {
        ...
        public static Method Bump(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            ...
            return new Method(63, "FellowshipCore", 0, "bump", byteArray.ToArray());
        }
        ...
        public static Method SetParams(Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_core_fellowship.ParamsTypeT1 @params)
        {
            ...
            return new Method(63, "FellowshipCore", 1, "set_params", byteArray.ToArray());
        }
        ...
        public static Method SetActive(Substrate.NetApi.Model.Types.Primitive.Bool is_active)
        {
            ...
            return new Method(63, "FellowshipCore", 2, "set_active", byteArray.ToArray());
        }
        ...
        public static Method Approve(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who, Substrate.NetApi.Model.Types.Primitive.U16 at_rank)
        {
            ...
            return new Method(63, "FellowshipCore", 3, "approve", byteArray.ToArray());
        }
        ...
        public static Method Induct(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(63, "FellowshipCore", 4, "induct", byteArray.ToArray());
        }
        ...
        public static Method Promote(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who, Substrate.NetApi.Model.Types.Primitive.U16 to_rank)
        {
            ...
            return new Method(63, "FellowshipCore", 5, "promote", byteArray.ToArray());
        }
        ...
        public static Method Offboard(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(63, "FellowshipCore", 6, "offboard", byteArray.ToArray());
        }
        ...
        public static Method SubmitEvidence(Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_core_fellowship.EnumWish wish, Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10 evidence)
        {
            ...
            return new Method(63, "FellowshipCore", 7, "submit_evidence", byteArray.ToArray());
        }
    ...
    /// <summary>
    /// >> FellowshipCoreConstants
    /// </summary>
    public sealed class FellowshipCoreConstants
    {
    ...
    /// <summary>
    /// >> FellowshipCoreErrors
    /// </summary>
    public enum FellowshipCoreErrors
    {
