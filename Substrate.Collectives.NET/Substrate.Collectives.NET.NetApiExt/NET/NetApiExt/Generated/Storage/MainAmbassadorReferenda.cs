...
namespace Substrate.Collectives.NET.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> AmbassadorReferendaStorage
    /// </summary>
    public sealed class AmbassadorReferendaStorage
    {
        ...
        /// <summary>
        /// >> AmbassadorReferendaStorage Constructor
        /// </summary>
        public AmbassadorReferendaStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorReferenda", "ReferendumCount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorReferenda", "ReferendumInfoFor"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorReferenda", "TrackQueue"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U16), typeof(Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorReferenda", "DecidingCount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AmbassadorReferenda", "MetadataOf"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorReferenda", "ReferendumCount", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = AmbassadorReferendaStorage.ReferendumCountParams();
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorReferenda", "ReferendumInfoFor", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = AmbassadorReferendaStorage.ReferendumInfoForParams(key);
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorReferenda", "TrackQueue", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        ///  This should be empty if `DecidingCount` is less than `TrackInfo::max_deciding`.
        /// </summary>
        public async Task<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37> TrackQueue(Substrate.NetApi.Model.Types.Primitive.U16 key, string blockhash, CancellationToken token)
        {
            string parameters = AmbassadorReferendaStorage.TrackQueueParams(key);
            var result = await _client.GetStorageAsync<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT37>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorReferenda", "DecidingCount", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = AmbassadorReferendaStorage.DecidingCountParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Primitive.U32>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("AmbassadorReferenda", "MetadataOf", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = AmbassadorReferendaStorage.MetadataOfParams(key);
    ...
    /// <summary>
    /// >> AmbassadorReferendaCalls
    /// </summary>
    public sealed class AmbassadorReferendaCalls
    {
        ...
        public static Method Submit(Substrate.Collectives.NET.NetApiExt.Generated.Model.collectives_polkadot_runtime.EnumOriginCaller proposal_origin, Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded proposal, Substrate.Collectives.NET.NetApiExt.Generated.Model.frame_support.traits.schedule.EnumDispatchTime enactment_moment)
        {
            ...
            return new Method(71, "AmbassadorReferenda", 0, "submit", byteArray.ToArray());
        }
        ...
        public static Method PlaceDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            ...
            return new Method(71, "AmbassadorReferenda", 1, "place_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method RefundDecisionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(71, "AmbassadorReferenda", 2, "refund_decision_deposit", byteArray.ToArray());
        }
        ...
        public static Method Cancel(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(71, "AmbassadorReferenda", 3, "cancel", byteArray.ToArray());
        }
        ...
        public static Method Kill(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(71, "AmbassadorReferenda", 4, "kill", byteArray.ToArray());
        }
        ...
        public static Method NudgeReferendum(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(71, "AmbassadorReferenda", 5, "nudge_referendum", byteArray.ToArray());
        }
        ...
        public static Method OneFewerDeciding(Substrate.NetApi.Model.Types.Primitive.U16 track)
        {
            ...
            return new Method(71, "AmbassadorReferenda", 6, "one_fewer_deciding", byteArray.ToArray());
        }
        ...
        public static Method RefundSubmissionDeposit(Substrate.NetApi.Model.Types.Primitive.U32 index)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(index.Encode());
            return new Method(71, "AmbassadorReferenda", 7, "refund_submission_deposit", byteArray.ToArray());
        }
        ...
        public static Method SetMetadata(Substrate.NetApi.Model.Types.Primitive.U32 index, Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.Collectives.NET.NetApiExt.Generated.Model.primitive_types.H256> maybe_hash)
        {
            ...
            return new Method(71, "AmbassadorReferenda", 8, "set_metadata", byteArray.ToArray());
        }
    }
    
    /// <summary>
    /// >> AmbassadorReferendaConstants
    /// </summary>
    public sealed class AmbassadorReferendaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U16, Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_referenda.types.TrackInfo>> Tracks()
        {
            ...
            result.Create(@"");
            return result;
        }
    }
    
    /// <summary>
    /// >> AmbassadorReferendaErrors
    /// </summary>
    public enum AmbassadorReferendaErrors
    {
