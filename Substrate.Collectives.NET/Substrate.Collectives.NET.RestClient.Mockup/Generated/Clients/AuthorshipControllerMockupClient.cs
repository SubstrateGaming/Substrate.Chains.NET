...
namespace Substrate.Collectives.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuthorshipControllerMockupClient : MockupBaseClient, IAuthorshipControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "Authorship/Author", value.Encode(), Substrate.Collectives.NET.NetApiExt.Generated.Storage.AuthorshipStorage.AuthorParams());
      }
   }
}
