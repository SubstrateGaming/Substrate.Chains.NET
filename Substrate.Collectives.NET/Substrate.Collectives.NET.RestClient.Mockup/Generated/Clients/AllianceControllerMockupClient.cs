...
namespace Substrate.Collectives.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AllianceControllerMockupClient : MockupBaseClient, IAllianceControllerMockupClient
   {
      ...
      public async Task<bool> SetAnnouncements(BoundedVecT19 value)
      {
      ...
      public async Task<bool> SetMembers(BoundedVecT9 value, Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_alliance.EnumMemberRole key)
      {
      ...
      public async Task<bool> SetUnscrupulousAccounts(BoundedVecT9 value)
      {
      ...
      public async Task<bool> SetUnscrupulousWebsites(BoundedVecT20 value)
      {
