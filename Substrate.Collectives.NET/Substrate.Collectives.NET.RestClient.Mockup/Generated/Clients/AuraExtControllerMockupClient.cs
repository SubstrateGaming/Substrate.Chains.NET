...
namespace Substrate.Collectives.NET.RestClient.Mockup.Generated.Clients
{
   ...
   public sealed class AuraExtControllerMockupClient : MockupBaseClient, IAuraExtControllerMockupClient
   {
      ...
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/Authorities", value.Encode(), Substrate.Collectives.NET.NetApiExt.Generated.Storage.AuraExtStorage.AuthoritiesParams());
      }
      public async Task<bool> SetSlotInfo(BaseTuple<Slot, U32> value)
      {
         return await SendMockupRequestAsync(_httpClient, "AuraExt/SlotInfo", value.Encode(), Substrate.Collectives.NET.NetApiExt.Generated.Storage.AuraExtStorage.SlotInfoParams());
      }
   }
}
