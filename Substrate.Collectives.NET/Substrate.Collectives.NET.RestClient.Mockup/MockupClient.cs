...
namespace Substrate.Collectives.NET.RestClient.Mockup
{
   ...
   public sealed class MockupClient
   {
      ...
      public IAmbassadorCollectiveControllerMockupClient AmbassadorCollectiveControllerClient;
      public IAmbassadorCoreControllerMockupClient AmbassadorCoreControllerClient;
      public IAmbassadorReferendaControllerMockupClient AmbassadorReferendaControllerClient;
      public IAmbassadorSalaryControllerMockupClient AmbassadorSalaryControllerClient;
      public IAmbassadorTreasuryControllerMockupClient AmbassadorTreasuryControllerClient;
      ...
      public IFellowshipCoreControllerMockupClient FellowshipCoreControllerClient;
      public IFellowshipReferendaControllerMockupClient FellowshipReferendaControllerClient;
      public IFellowshipSalaryControllerMockupClient FellowshipSalaryControllerClient;
      public IFellowshipTreasuryControllerMockupClient FellowshipTreasuryControllerClient;
      ...
      public MockupClient(HttpClient httpClient)
      {
         ...
         AmbassadorCollectiveControllerClient = new AmbassadorCollectiveControllerMockupClient(_httpClient);
         AmbassadorCoreControllerClient = new AmbassadorCoreControllerMockupClient(_httpClient);
         AmbassadorReferendaControllerClient = new AmbassadorReferendaControllerMockupClient(_httpClient);
         AmbassadorSalaryControllerClient = new AmbassadorSalaryControllerMockupClient(_httpClient);
         AmbassadorTreasuryControllerClient = new AmbassadorTreasuryControllerMockupClient(_httpClient);
         ...
         FellowshipCoreControllerClient = new FellowshipCoreControllerMockupClient(_httpClient);
         FellowshipReferendaControllerClient = new FellowshipReferendaControllerMockupClient(_httpClient);
         FellowshipSalaryControllerClient = new FellowshipSalaryControllerMockupClient(_httpClient);
         FellowshipTreasuryControllerClient = new FellowshipTreasuryControllerMockupClient(_httpClient);
