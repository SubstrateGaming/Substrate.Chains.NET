...
namespace Substrate.Collectives.NET.RestService.Generated.Storage
{
    ...
    /// <summary>
    /// IFellowshipCoreStorage interface definition.
    /// </summary>
    public interface IFellowshipCoreStorage : IStorage
    {
    ...
    /// <summary>
    /// FellowshipCoreStorage class definition.
    /// </summary>
    public sealed class FellowshipCoreStorage : IFellowshipCoreStorage
    {
        ...
        /// <summary>
        /// FellowshipCoreStorage constructor.
        /// </summary>
        public FellowshipCoreStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            this.ParamsTypedStorage = new TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_core_fellowship.ParamsTypeT1>("FellowshipCore.Params", storageDataProvider, storageChangeDelegates);
            this.MemberTypedStorage = new TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_core_fellowship.MemberStatus>("FellowshipCore.Member", storageDataProvider, storageChangeDelegates);
            this.MemberEvidenceTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_core_fellowship.EnumWish, Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10>>("FellowshipCore.MemberEvidence", storageDataProvider, storageChangeDelegates);
        }
        ...
        {
            await ParamsTypedStorage.InitializeAsync("FellowshipCore", "Params");
            await MemberTypedStorage.InitializeAsync("FellowshipCore", "Member");
            await MemberEvidenceTypedStorage.InitializeAsync("FellowshipCore", "MemberEvidence");
        }
        
        /// <summary>
        /// Implements any storage change for FellowshipCore.Params
        /// </summary>
        [StorageChange("FellowshipCore", "Params")]
        ...
        /// <summary>
        /// Implements any storage change for FellowshipCore.Member
        /// </summary>
        [StorageChange("FellowshipCore", "Member")]
        ...
        /// <summary>
        /// Implements any storage change for FellowshipCore.MemberEvidence
        /// </summary>
        [StorageChange("FellowshipCore", "MemberEvidence")]
