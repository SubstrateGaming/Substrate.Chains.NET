...
namespace Substrate.Collectives.NET.RestService.Generated.Storage
{
    ...
    public interface IPolkadotXcmStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12 GetVersionDiscoveryQueue();
        ...
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 GetLockedFungibles(string key);
    ...
    public sealed class PolkadotXcmStorage : IPolkadotXcmStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12> _versionDiscoveryQueueTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14> _lockedFungiblesTypedStorage;
        ...
        public PolkadotXcmStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.VersionDiscoveryQueueTypedStorage = new TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12>("PolkadotXcm.VersionDiscoveryQueue", storageDataProvider, storageChangeDelegates);
            ...
            this.LockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14>("PolkadotXcm.LockedFungibles", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12> VersionDiscoveryQueueTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14> LockedFungiblesTypedStorage
        {
            get
            {
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT12 GetVersionDiscoveryQueue()
        {
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 GetLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT14 result))
            {
                return result;
            }
            else
