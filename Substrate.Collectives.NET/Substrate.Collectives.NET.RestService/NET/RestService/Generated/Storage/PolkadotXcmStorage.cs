...
namespace Substrate.Collectives.NET.RestService.Generated.Storage
{
    ...
    public interface IPolkadotXcmStorage : IStorage
    {
        ...
        ///  The ongoing queries.
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus GetQueries(string key);
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> GetVersionNotifyTargets(string key);
        ...
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetVersionDiscoveryQueue();
        
        /// <summary>
        /// >> CurrentMigration
        ///  The current migration's stage, if any.
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage GetCurrentMigration();
        
        /// <summary>
        /// >> RemoteLockedFungibles
        ///  Fungible assets which we know are locked on a remote chain.
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord GetRemoteLockedFungibles(string key);
        
        /// <summary>
        /// >> LockedFungibles
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetLockedFungibles(string key);
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm();
    }
    ...
    public sealed class PolkadotXcmStorage : IPolkadotXcmStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> _queriesTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>> _versionNotifyTargetsTypedStorage;
        
        /// <summary>
        /// _versionDiscoveryQueueTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> _versionDiscoveryQueueTypedStorage;
        
        /// <summary>
        /// _currentMigrationTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> _currentMigrationTypedStorage;
        
        /// <summary>
        /// _remoteLockedFungiblesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord> _remoteLockedFungiblesTypedStorage;
        
        /// <summary>
        /// _lockedFungiblesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23> _lockedFungiblesTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> _recordedXcmTypedStorage;
        ...
        public PolkadotXcmStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.QueriesTypedStorage = new TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus>("PolkadotXcm.Queries", storageDataProvider, storageChangeDelegates);
            ...
            this.VersionNotifyTargetsTypedStorage = new TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>>("PolkadotXcm.VersionNotifyTargets", storageDataProvider, storageChangeDelegates);
            this.VersionDiscoveryQueueTypedStorage = new TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21>("PolkadotXcm.VersionDiscoveryQueue", storageDataProvider, storageChangeDelegates);
            this.CurrentMigrationTypedStorage = new TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage>("PolkadotXcm.CurrentMigration", storageDataProvider, storageChangeDelegates);
            this.RemoteLockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord>("PolkadotXcm.RemoteLockedFungibles", storageDataProvider, storageChangeDelegates);
            this.LockedFungiblesTypedStorage = new TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23>("PolkadotXcm.LockedFungibles", storageDataProvider, storageChangeDelegates);
            ...
            this.RecordedXcmTypedStorage = new TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1>("PolkadotXcm.RecordedXcm", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> QueriesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32>> VersionNotifyTargetsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21> VersionDiscoveryQueueTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> CurrentMigrationTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord> RemoteLockedFungiblesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23> LockedFungiblesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1> RecordedXcmTypedStorage
        {
            get
            {
        ...
        ///  The ongoing queries.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus GetQueries(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (QueriesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus result))
            {
                return result;
            }
            else
        ...
        ///  of our versions we informed them of.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> GetVersionNotifyTargets(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VersionNotifyTargetsTypedStorage.Dictionary.TryGetValue(key, out Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U64, Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight, Substrate.NetApi.Model.Types.Primitive.U32> result))
            {
                return result;
            }
            else
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT21 GetVersionDiscoveryQueue()
        {
        ...
        ///  The current migration's stage, if any.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage GetCurrentMigration()
        {
        ...
        ///  Fungible assets which we know are locked on a remote chain.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord GetRemoteLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (RemoteLockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Collectives.NET.NetApiExt.Generated.Model.pallet_xcm.pallet.RemoteLockedFungibleRecord result))
            {
                return result;
            }
            else
        ...
        ///  Fungible assets which we know are locked on this chain.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 GetLockedFungibles(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LockedFungiblesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT23 result))
            {
                return result;
            }
            else
        ...
        ///  implementation in the XCM executor configuration.
        /// </summary>
        public Substrate.Collectives.NET.NetApiExt.Generated.Model.staging_xcm.v4.XcmT1 GetRecordedXcm()
        {
