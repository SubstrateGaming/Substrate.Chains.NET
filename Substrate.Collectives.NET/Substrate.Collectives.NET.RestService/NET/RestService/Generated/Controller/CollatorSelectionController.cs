...
namespace Substrate.Collectives.NET.RestService.Generated.Controller
{
    ...
    public sealed class CollatorSelectionController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Candidates")]
        [ProducesResponseType(typeof(Substrate.Collectives.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT10), 200)]
        [StorageKeyBuilder(typeof(Substrate.Collectives.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage), "CandidatesParams")]
