...
namespace Substrate.Collectives.NET.RestClient.Generated.Interfaces
{
   ...
   {
      Task<BoundedVecT9> GetInvulnerables();
      Task<bool> SubscribeInvulnerables();
      Task<BoundedVecT10> GetCandidates();
      Task<bool> SubscribeCandidates();
      Task<U32> GetLastAuthoredBlock(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
      Task<bool> SubscribeLastAuthoredBlock(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key);
