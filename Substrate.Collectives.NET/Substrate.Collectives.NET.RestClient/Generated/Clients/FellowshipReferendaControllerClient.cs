...
namespace Substrate.Collectives.NET.RestClient.Generated.Clients
{
   ...
   public sealed class FellowshipReferendaControllerClient : BaseClient, IFellowshipReferendaControllerClient
   {
      ...
      {
         return await SendRequestAsync<BoundedVecT23>(_httpClient, "fellowshipreferenda/trackqueue", Substrate.Collectives.NET.NetApiExt.Generated.Storage.FellowshipReferendaStorage.TrackQueueParams(key));
      }
