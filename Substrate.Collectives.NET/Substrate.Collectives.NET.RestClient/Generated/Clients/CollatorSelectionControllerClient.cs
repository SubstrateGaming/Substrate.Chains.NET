...
namespace Substrate.Collectives.NET.RestClient.Generated.Clients
{
   ...
   public sealed class CollatorSelectionControllerClient : BaseClient, ICollatorSelectionControllerClient
   {
      ...
      public async Task<BoundedVecT9> GetInvulnerables()
      {
         return await SendRequestAsync<BoundedVecT9>(_httpClient, "collatorselection/invulnerables");
      }
      ...
      public async Task<BoundedVecT10> GetCandidates()
      {
         return await SendRequestAsync<BoundedVecT10>(_httpClient, "collatorselection/candidates");
      }
      public async Task<bool> SubscribeCandidates()
      {
         return await _subscriptionClient.SubscribeAsync("CollatorSelection.Candidates");
      }
      public async Task<U32> GetLastAuthoredBlock(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<U32>(_httpClient, "collatorselection/lastauthoredblock", Substrate.Collectives.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
      public async Task<bool> SubscribeLastAuthoredBlock(Substrate.Collectives.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("CollatorSelection.LastAuthoredBlock", Substrate.Collectives.NET.NetApiExt.Generated.Storage.CollatorSelectionStorage.LastAuthoredBlockParams(key));
      }
