...
namespace Substrate.Collectives.NET.RestClient.Generated.Clients
{
   ...
   public sealed class XcmpQueueControllerClient : BaseClient, IXcmpQueueControllerClient
   {
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/inboundxcmpmessages", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      public async Task<bool> SubscribeInboundXcmpMessages(BaseTuple<Id, U32> key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.InboundXcmpMessages", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.InboundXcmpMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/outboundxcmpmessages", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OutboundXcmpMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "xcmpqueue/signalmessages", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.SignalMessagesParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseTuple<Id, U32, BaseVec<U8>>>(_httpClient, "xcmpqueue/overweight", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
      public async Task<bool> SubscribeOverweight(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("XcmpQueue.Overweight", Substrate.Collectives.NET.NetApiExt.Generated.Storage.XcmpQueueStorage.OverweightParams(key));
      }
