...
namespace Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    
    
    /// <summary>
    /// >> 330 - Composite[polkadot_primitives.v2.PersistedValidationData]
    /// </summary>
    ...
    public sealed class PersistedValidationData : BaseType
    {
        ...
        /// >> parent_head
        /// </summary>
        public Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData ParentHead { get; set; }
        /// <summary>
        /// >> relay_parent_number
        /// </summary>
        ...
        /// </summary>
        public Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.primitive_types.H256 RelayParentStorageRoot { get; set; }
        /// <summary>
        /// >> max_pov_size
        /// </summary>
        ...
        {
            var start = p;
            ParentHead = new Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
            ...
            RelayParentStorageRoot = new Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.primitive_types.H256();
