...
namespace Substrate.Zeitgeist.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class CouncilMembershipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CouncilMembership", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CouncilMembership", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public async Task<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20> Members(string blockhash, CancellationToken token)
        {
            string parameters = CouncilMembershipStorage.MembersParams();
            var result = await _client.GetStorageAsync<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT20>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class CouncilMembershipCalls
    {
        ...
        public static Method AddMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            ...
            return new Method(24, "CouncilMembership", 0, "add_member", byteArray.ToArray());
        }
        ...
        public static Method RemoveMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(24, "CouncilMembership", 1, "remove_member", byteArray.ToArray());
        }
        ...
        public static Method SwapMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress remove, Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress add)
        {
            ...
            return new Method(24, "CouncilMembership", 2, "swap_member", byteArray.ToArray());
        }
        ...
        public static Method ResetMembers(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> members)
        {
            ...
            return new Method(24, "CouncilMembership", 3, "reset_members", byteArray.ToArray());
        }
        ...
        public static Method ChangeKey(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress @new)
        {
            ...
            return new Method(24, "CouncilMembership", 4, "change_key", byteArray.ToArray());
        }
        ...
        public static Method SetPrime(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(24, "CouncilMembership", 5, "set_prime", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(24, "CouncilMembership", 6, "clear_prime", byteArray.ToArray());
        }
    }
