...
namespace Substrate.Zeitgeist.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class TechnicalCommitteeMembershipStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommitteeMembership", "Members"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommitteeMembership", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public async Task<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22> Members(string blockhash, CancellationToken token)
        {
            string parameters = TechnicalCommitteeMembershipStorage.MembersParams();
            var result = await _client.GetStorageAsync<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class TechnicalCommitteeMembershipCalls
    {
        ...
        public static Method AddMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            ...
            return new Method(26, "TechnicalCommitteeMembership", 0, "add_member", byteArray.ToArray());
        }
        ...
        public static Method RemoveMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(26, "TechnicalCommitteeMembership", 1, "remove_member", byteArray.ToArray());
        }
        ...
        public static Method SwapMember(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress remove, Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress add)
        {
            ...
            return new Method(26, "TechnicalCommitteeMembership", 2, "swap_member", byteArray.ToArray());
        }
        ...
        public static Method ResetMembers(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> members)
        {
            ...
            return new Method(26, "TechnicalCommitteeMembership", 3, "reset_members", byteArray.ToArray());
        }
        ...
        public static Method ChangeKey(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress @new)
        {
            ...
            return new Method(26, "TechnicalCommitteeMembership", 4, "change_key", byteArray.ToArray());
        }
        ...
        public static Method SetPrime(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
            return new Method(26, "TechnicalCommitteeMembership", 5, "set_prime", byteArray.ToArray());
        }
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(26, "TechnicalCommitteeMembership", 6, "clear_prime", byteArray.ToArray());
        }
    }
