...
namespace Substrate.Zeitgeist.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class TechnicalCommitteeStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommittee", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT21)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommittee", "Prime"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT21> Proposals(string blockhash, CancellationToken token)
        {
            string parameters = TechnicalCommitteeStorage.ProposalsParams();
            var result = await _client.GetStorageAsync<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT21>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class TechnicalCommitteeCalls
    {
        ...
        public static Method CloseOldWeight(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.primitive_types.H256 proposal_hash, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> index, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_weights.OldWeight> proposal_weight_bound, Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            ...
            byteArray.AddRange(length_bound.Encode());
            return new Method(25, "TechnicalCommittee", 4, "close_old_weight", byteArray.ToArray());
        }
