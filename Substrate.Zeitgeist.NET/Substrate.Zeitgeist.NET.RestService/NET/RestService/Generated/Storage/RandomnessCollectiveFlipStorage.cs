...
namespace Substrate.Zeitgeist.NET.RestService.Generated.Storage
{
    ...
    public interface IRandomnessCollectiveFlipStorage : IStorage
    {
        ...
        ///  the oldest hash.
        /// </summary>
        Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 GetRandomMaterial();
    }
    ...
    public sealed class RandomnessCollectiveFlipStorage : IRandomnessCollectiveFlipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> _randomMaterialTypedStorage;
        ...
        {
            this.RandomMaterialTypedStorage = new TypedStorage<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5>("RandomnessCollectiveFlip.RandomMaterial", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _randomMaterialTypedStorage property
        /// </summary>
        public TypedStorage<Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5> RandomMaterialTypedStorage
        {
            get
            {
        ...
        ///  the oldest hash.
        /// </summary>
        public Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT5 GetRandomMaterial()
        {
