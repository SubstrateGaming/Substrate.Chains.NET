...
namespace Substrate.Zeitgeist.NET.RestService.Generated.Controller
{
    ...
    public sealed class TechnicalCommitteeMembershipController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Members")]
        [ProducesResponseType(typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22), 200)]
        [StorageKeyBuilder(typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Storage.TechnicalCommitteeMembershipStorage), "MembersParams")]
        ...
        [StorageKeyBuilder(typeof(Substrate.Zeitgeist.NET.NetApiExt.Generated.Storage.TechnicalCommitteeMembershipStorage), "PrimeParams")]
