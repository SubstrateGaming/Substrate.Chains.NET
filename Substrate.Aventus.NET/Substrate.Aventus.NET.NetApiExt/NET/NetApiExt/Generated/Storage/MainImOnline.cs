...
namespace Substrate.Aventus.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class ImOnlineStorage
    {
        ...
        public ImOnlineStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "Keys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Aventus.NET.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT4)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "ReceivedHeartbeats"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>), typeof(Substrate.Aventus.NET.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque)));
        ...
        ///  The current set of keys that may issue a heartbeat.
        /// </summary>
        public async Task<Substrate.Aventus.NET.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT4> Keys(CancellationToken token)
        {
            string parameters = ImOnlineStorage.KeysParams();
            var result = await _client.GetStorageAsync<Substrate.Aventus.NET.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT4>(parameters, token);
            return result;
        }
        ...
        ///  `WrapperOpaque<BoundedOpaqueNetworkState>`.
        /// </summary>
        public async Task<Substrate.Aventus.NET.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque> ReceivedHeartbeats(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
            string parameters = ImOnlineStorage.ReceivedHeartbeatsParams(key);
            var result = await _client.GetStorageAsync<Substrate.Aventus.NET.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string AuthoredBlocksParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Aventus.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  number of blocks authored by the given authority.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AuthoredBlocks(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.Aventus.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
    ...
    public sealed class ImOnlineCalls
    {
        ...
        /// </summary>
        public static Method Heartbeat(Substrate.Aventus.NET.NetApiExt.Generated.Model.pallet_im_online.Heartbeat heartbeat, Substrate.Aventus.NET.NetApiExt.Generated.Model.pallet_im_online.sr25519.app_sr25519.Signature signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(heartbeat.Encode());
            byteArray.AddRange(signature.Encode());
            return new Method(73, "ImOnline", 0, "heartbeat", byteArray.ToArray());
        }
    }
