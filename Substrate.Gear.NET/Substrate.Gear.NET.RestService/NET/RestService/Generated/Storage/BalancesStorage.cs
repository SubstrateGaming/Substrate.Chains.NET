...
namespace Substrate.Gear.NET.RestService.Generated.Storage
{
    ...
    public interface IBalancesStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key);
        ...
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3 GetLocks(string key);
        
        /// <summary>
        /// >> Reserves
        ///  Named reserves on some account balances.
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3 GetReserves(string key);
    }
    ...
    public sealed class BalancesStorage : IBalancesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData> _accountTypedStorage;
        
        /// <summary>
        /// _locksTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3> _locksTypedStorage;
        
        /// <summary>
        /// _reservesTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3> _reservesTypedStorage;
        ...
        public BalancesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AccountTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData>("Balances.Account", storageDataProvider, storageChangeDelegates);
            this.LocksTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3>("Balances.Locks", storageDataProvider, storageChangeDelegates);
            this.ReservesTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3>("Balances.Reserves", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData> AccountTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3> LocksTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3> ReservesTypedStorage
        {
            get
            {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData GetAccount(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AccountTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_balances.AccountData result))
            {
                return result;
            }
            else
        ...
        ///  NOTE: Should only be accessed when setting, changing and freeing a lock.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3 GetLocks(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (LocksTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT3 result))
            {
                return result;
            }
            else
        ...
        ///  Named reserves on some account balances.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3 GetReserves(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReservesTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT3 result))
            {
                return result;
            }
            else
