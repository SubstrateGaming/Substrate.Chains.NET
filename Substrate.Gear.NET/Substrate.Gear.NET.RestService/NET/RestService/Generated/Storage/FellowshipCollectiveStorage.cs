...
namespace Substrate.Gear.NET.RestService.Generated.Storage
{
    ...
    public interface IFellowshipCollectiveStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord GetMembers(string key);
        ...
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetIndexToId(string key);
        
        /// <summary>
        /// >> Voting
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord GetVoting(string key);
        
        /// <summary>
        /// >> VotingCleanup
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 GetVotingCleanup(string key);
    }
    ...
    public sealed class FellowshipCollectiveStorage : IFellowshipCollectiveStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord> _membersTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _indexToIdTypedStorage;
        
        /// <summary>
        /// _votingTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord> _votingTypedStorage;
        
        /// <summary>
        /// _votingCleanupTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16> _votingCleanupTypedStorage;
        ...
        public FellowshipCollectiveStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.MembersTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord>("FellowshipCollective.Members", storageDataProvider, storageChangeDelegates);
            ...
            this.IndexToIdTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("FellowshipCollective.IndexToId", storageDataProvider, storageChangeDelegates);
            this.VotingTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord>("FellowshipCollective.Voting", storageDataProvider, storageChangeDelegates);
            this.VotingCleanupTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16>("FellowshipCollective.VotingCleanup", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord> MembersTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> IndexToIdTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord> VotingTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16> VotingCleanupTypedStorage
        {
            get
            {
        ...
        ///  The current members of the collective.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord GetMembers(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (MembersTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.MemberRecord result))
            {
                return result;
            }
            else
        ...
        ///  return `Some`, however a member's index is not guaranteed to remain unchanged over time.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetIndexToId(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (IndexToIdTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord GetVoting(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_ranked_collective.EnumVoteRecord result))
            {
                return result;
            }
            else
        ...
        /// >> VotingCleanup
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 GetVotingCleanup(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (VotingCleanupTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT16 result))
            {
                return result;
            }
            else
