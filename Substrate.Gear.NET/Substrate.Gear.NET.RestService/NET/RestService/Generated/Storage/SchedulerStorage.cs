...
namespace Substrate.Gear.NET.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18 GetAgenda(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18> _agendaTypedStorage;
        ...
        public SchedulerStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.AgendaTypedStorage = new TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18>("Scheduler.Agenda", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18> AgendaTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18 GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out Substrate.Gear.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT18 result))
            {
                return result;
            }
            else
