...
namespace Substrate.Gear.NET.RestService.Generated.Controller
{
    ...
    public sealed class MultisigController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Multisigs")]
        [ProducesResponseType(typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.pallet_multisig.Multisig), 200)]
        [StorageKeyBuilder(typeof(Substrate.Gear.NET.NetApiExt.Generated.Storage.MultisigStorage), "MultisigsParams", typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Gear.NET.NetApiExt.Generated.Types.Base.Arr32U8>))]
