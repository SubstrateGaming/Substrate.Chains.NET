    ...
    public sealed class GearMessengerStorage
    {
        ...
        public GearMessengerStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "Dispatches"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId), typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.complicated.dequeue.LinkedNode)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "Head"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "Mailbox"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredMessage, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "Tail"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "Waitlist"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity,
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.ProgramId, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearMessenger", "DispatchStash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>)));
        }
        ...
        /// >> Dequeued
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> Dequeued(CancellationToken token)
        {
        ...
        /// >> DispatchesParams
        /// </summary>
        public static string DispatchesParams(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key)
        {
        ...
        /// >> Dispatches
        /// </summary>
        public async Task<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.complicated.dequeue.LinkedNode> Dispatches(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key, CancellationToken token)
        {
            string parameters = GearMessengerStorage.DispatchesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.complicated.dequeue.LinkedNode>(parameters, token);
            return result;
        }
        ...
        /// Counter for the related counted storage map
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> CounterForDispatches(CancellationToken token)
        {
        ...
        /// >> Head
        /// </summary>
        public async Task<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> Head(CancellationToken token)
        {
            string parameters = GearMessengerStorage.HeadParams();
            var result = await _client.GetStorageAsync<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId>(parameters, token);
            return result;
        }
        ...
        /// >> MailboxParams
        /// </summary>
        public static string MailboxParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key)
        {
        ...
        /// >> Mailbox
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredMessage, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> Mailbox(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key, CancellationToken token)
        {
            string parameters = GearMessengerStorage.MailboxParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredMessage, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>>(parameters, token);
            return result;
        }
        ...
        /// >> QueueProcessing
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> QueueProcessing(CancellationToken token)
        {
        ...
        /// >> Sent
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> Sent(CancellationToken token)
        {
        ...
        /// >> Tail
        /// </summary>
        public async Task<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> Tail(CancellationToken token)
        {
        ...
        /// >> WaitlistParams
        /// </summary>
        public static string WaitlistParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.ProgramId, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key)
        {
        ...
        /// >> Waitlist
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> Waitlist(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.ProgramId, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId> key, CancellationToken token)
        {
            string parameters = GearMessengerStorage.WaitlistParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>>(parameters, token);
            return result;
        }
        ...
        /// >> DispatchStashParams
        /// </summary>
        public static string DispatchStashParams(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key)
        {
        ...
        /// >> DispatchStash
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.message.stored.StoredDispatch, Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.storage.primitives.Interval>> DispatchStash(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_core.ids.MessageId key, CancellationToken token)
        {
