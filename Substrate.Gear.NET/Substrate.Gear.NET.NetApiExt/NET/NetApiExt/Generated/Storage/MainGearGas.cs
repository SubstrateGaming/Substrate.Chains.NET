...
namespace Substrate.Gear.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GearGasStorage
    {
        ...
        public GearGasStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearGas", "GasNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId), typeof(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode)));
        ...
        /// >> TotalIssuance
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> TotalIssuance(CancellationToken token)
        {
        ...
        /// >> GasNodesParams
        /// </summary>
        public static string GasNodesParams(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key)
        {
        ...
        /// >> GasNodes
        /// </summary>
        public async Task<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode> GasNodes(Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key, CancellationToken token)
        {
            string parameters = GearGasStorage.GasNodesParams(key);
            var result = await _client.GetStorageAsync<Substrate.Gear.NET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode>(parameters, token);
            return result;
        }
        ...
        {
            return "0x004429353A000000";
        }
        
        /// <summary>
        /// >> Allowance
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> Allowance(CancellationToken token)
        {
    ...
    public sealed class GearGasConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Primitive.U64 BlockGasLimit()
        {
            ...
            result.Create("0x004429353A000000");
            return result;
        }
    }
